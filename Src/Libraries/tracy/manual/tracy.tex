...
A GPU context can be created with the \texttt{\_\_\_tracy\_emit\_gpu\_new\m_Context} function (or the serialized variant). You'll need to specify:
...
GPU contexts can be named using the \texttt{\_\_\_tracy\_emit\_gpu\m_Context\_name} function.
