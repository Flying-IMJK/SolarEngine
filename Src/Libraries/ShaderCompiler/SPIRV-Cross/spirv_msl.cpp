...
void CompilerMSL::emit_custom_functions()
{
	...
	for (const auto &spv_func : spv_function_implementations)
	{
		...
		case SPVFuncImplConvertYCbCrBT709:
			statement("// cf. Khronos Data CharsFormat Specification, section 15.1.1");
		...
		case SPVFuncImplConvertYCbCrBT601:
			statement("// cf. Khronos Data CharsFormat Specification, section 15.1.2");
		...
		case SPVFuncImplConvertYCbCrBT2020:
			statement("// cf. Khronos Data CharsFormat Specification, section 15.1.3");
