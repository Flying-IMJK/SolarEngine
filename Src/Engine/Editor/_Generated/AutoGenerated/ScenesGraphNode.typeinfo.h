...
namespace SE
{
    ...
    {
       static ::SE::Editor::ScenesGraphNode const* s_pDefaultInstance_11837754734423798111;
    ...
    public:
        static void RegisterType()
        {
            ...
            ::SE::Editor::ScenesGraphNode::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ScenesGraphNode>>(s_pDefaultInstance_11837754734423798111);
    ...
    public:
        ...
        {
            return s_pDefaultInstance_11837754734423798111;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ScenesGraphNode>::s_pDefaultInstance_11837754734423798111);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ScenesGraphNode>::s_pDefaultInstance_11837754734423798111, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ScenesGraphNode const* TTypeCompositeInfo<::SE::Editor::ScenesGraphNode>::s_pDefaultInstance_11837754734423798111 = nullptr;
}
