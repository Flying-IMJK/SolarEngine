...
namespace SE
{
    ...
    {
       static ::SE::Editor::FloatWindowDockPanel const* s_pDefaultInstance_1396651947;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_1396651947 = New<::SE::Editor::FloatWindowDockPanel>(nullptr);

            ::SE::Editor::FloatWindowDockPanel::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::FloatWindowDockPanel>>(s_pDefaultInstance_1396651947);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::FloatWindowDockPanel*>(s_pDefaultInstance_1396651947));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_1396651947;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::FloatWindowDockPanel>::s_pDefaultInstance_1396651947);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::FloatWindowDockPanel>::s_pDefaultInstance_1396651947, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::FloatWindowDockPanel const* TTypeCompositeInfo<::SE::Editor::FloatWindowDockPanel>::s_pDefaultInstance_1396651947 = nullptr;
}
