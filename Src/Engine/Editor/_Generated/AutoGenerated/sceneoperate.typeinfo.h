...
namespace SE
{
    ...
    {
       static ::SE::Editor::SceneOperate const* s_pDefaultInstance_2436995658;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_2436995658 = New<::SE::Editor::SceneOperate>(nullptr);

            ::SE::Editor::SceneOperate::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::SceneOperate>>(s_pDefaultInstance_2436995658);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::SceneOperate*>(s_pDefaultInstance_2436995658));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_2436995658;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::SceneOperate>::s_pDefaultInstance_2436995658);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::SceneOperate>::s_pDefaultInstance_2436995658, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::SceneOperate const* TTypeCompositeInfo<::SE::Editor::SceneOperate>::s_pDefaultInstance_2436995658 = nullptr;
}
