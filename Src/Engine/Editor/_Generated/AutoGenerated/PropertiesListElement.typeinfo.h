...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor PropertiesListElement
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::PropertiesListElement> final : public TypeCompositeInfo
    {
       static ::SE::Editor::PropertiesListElement const* s_pDefaultInstance_8032406165544101447;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_8032406165544101447 = New<::SE::Editor::PropertiesListElement>(nullptr);

            ::SE::Editor::PropertiesListElement::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::PropertiesListElement>>(s_pDefaultInstance_8032406165544101447);
            Types::RegisterType(::SE::Editor::PropertiesListElement::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::PropertiesListElement::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::PropertiesListElement*>(s_pDefaultInstance_8032406165544101447));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::PropertiesListElement::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::PropertiesListElement"));
            size = sizeof(::SE::Editor::PropertiesListElement);
            alignment = alignof(::SE::Editor::PropertiesListElement);
            name = SE_TEXT("PropertiesListElement");
            fullName = SE_TEXT("SE::Editor::PropertiesListElement");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::PropertiesListElement), alignof(::SE::Editor::PropertiesListElement));
            return new (pMemory) ::SE::Editor::PropertiesListElement(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::PropertiesListElement(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_8032406165544101447;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::PropertiesListElement>::s_pDefaultInstance_8032406165544101447);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::PropertiesListElement>::s_pDefaultInstance_8032406165544101447, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::PropertiesListElement const* TTypeCompositeInfo<::SE::Editor::PropertiesListElement>::s_pDefaultInstance_8032406165544101447 = nullptr;
}
