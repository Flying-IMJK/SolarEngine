...
namespace SE
{
    ...
    {
       static ::SE::Editor::JsonAssetItem const* s_pDefaultInstance_4072293045;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_4072293045 = New<::SE::Editor::JsonAssetItem>(nullptr);

            ::SE::Editor::JsonAssetItem::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::JsonAssetItem>>(s_pDefaultInstance_4072293045);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::JsonAssetItem*>(s_pDefaultInstance_4072293045));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_4072293045;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::JsonAssetItem>::s_pDefaultInstance_4072293045);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::JsonAssetItem>::s_pDefaultInstance_4072293045, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::JsonAssetItem const* TTypeCompositeInfo<::SE::Editor::JsonAssetItem>::s_pDefaultInstance_4072293045 = nullptr;
}
