...
namespace SE
{
    ...
    {
       static ::SE::Editor::AssetItem const* s_pDefaultInstance_13415732108369126659;
    ...
    public:
        ...
        {
            return s_pDefaultInstance_13415732108369126659;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::AssetItem>::s_pDefaultInstance_13415732108369126659);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::AssetItem>::s_pDefaultInstance_13415732108369126659, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::AssetItem const* TTypeCompositeInfo<::SE::Editor::AssetItem>::s_pDefaultInstance_13415732108369126659 = nullptr;
}
