...
namespace SE
{
    ...
    {
       static ::SE::Editor::MasterDockPanel const* s_pDefaultInstance_1348922795405090709;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_1348922795405090709 = New<::SE::Editor::MasterDockPanel>(nullptr);

            ::SE::Editor::MasterDockPanel::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::MasterDockPanel>>(s_pDefaultInstance_1348922795405090709);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::MasterDockPanel*>(s_pDefaultInstance_1348922795405090709));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_1348922795405090709;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::MasterDockPanel>::s_pDefaultInstance_1348922795405090709);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::MasterDockPanel>::s_pDefaultInstance_1348922795405090709, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::MasterDockPanel const* TTypeCompositeInfo<::SE::Editor::MasterDockPanel>::s_pDefaultInstance_1348922795405090709 = nullptr;
}
