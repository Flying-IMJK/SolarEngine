...
namespace SE
{
    ...
    {
       static ::SE::Editor::GenericEditor const* s_pDefaultInstance_2742595856;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_2742595856 = New<::SE::Editor::GenericEditor>(nullptr);

            ::SE::Editor::GenericEditor::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::GenericEditor>>(s_pDefaultInstance_2742595856);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::GenericEditor*>(s_pDefaultInstance_2742595856));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_2742595856;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::GenericEditor>::s_pDefaultInstance_2742595856);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::GenericEditor>::s_pDefaultInstance_2742595856, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::GenericEditor const* TTypeCompositeInfo<::SE::Editor::GenericEditor>::s_pDefaultInstance_2742595856 = nullptr;
}
