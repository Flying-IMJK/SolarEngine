...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor ProjectTreeNode
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::ProjectTreeNode> final : public TypeCompositeInfo
    {
       static ::SE::Editor::ProjectTreeNode const* s_pDefaultInstance_13916157367737448969;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_13916157367737448969 = New<::SE::Editor::ProjectTreeNode>(nullptr);

            ::SE::Editor::ProjectTreeNode::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ProjectTreeNode>>(s_pDefaultInstance_13916157367737448969);
            Types::RegisterType(::SE::Editor::ProjectTreeNode::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::ProjectTreeNode::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::ProjectTreeNode*>(s_pDefaultInstance_13916157367737448969));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::ProjectTreeNode::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::ProjectTreeNode"));
            size = sizeof(::SE::Editor::ProjectTreeNode);
            alignment = alignof(::SE::Editor::ProjectTreeNode);
            name = SE_TEXT("ProjectTreeNode");
            fullName = SE_TEXT("SE::Editor::ProjectTreeNode");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::ProjectTreeNode), alignof(::SE::Editor::ProjectTreeNode));
            return new (pMemory) ::SE::Editor::ProjectTreeNode(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::ProjectTreeNode(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_13916157367737448969;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ProjectTreeNode>::s_pDefaultInstance_13916157367737448969);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ProjectTreeNode>::s_pDefaultInstance_13916157367737448969, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ProjectTreeNode const* TTypeCompositeInfo<::SE::Editor::ProjectTreeNode>::s_pDefaultInstance_13916157367737448969 = nullptr;
}
