...
namespace SE
{
    ...
    {
       static ::SE::Editor::StaticModelGraphNode const* s_pDefaultInstance_1106486397;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_1106486397 = New<::SE::Editor::StaticModelGraphNode>(nullptr);

            ::SE::Editor::StaticModelGraphNode::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::StaticModelGraphNode>>(s_pDefaultInstance_1106486397);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::StaticModelGraphNode*>(s_pDefaultInstance_1106486397));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_1106486397;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::StaticModelGraphNode>::s_pDefaultInstance_1106486397);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::StaticModelGraphNode>::s_pDefaultInstance_1106486397, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::StaticModelGraphNode const* TTypeCompositeInfo<::SE::Editor::StaticModelGraphNode>::s_pDefaultInstance_1106486397 = nullptr;
}
