...
namespace SE
{
    ...
    {
       static ::SE::Editor::TextureOperate const* s_pDefaultInstance_3913280621;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_3913280621 = New<::SE::Editor::TextureOperate>(nullptr);

            ::SE::Editor::TextureOperate::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::TextureOperate>>(s_pDefaultInstance_3913280621);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::TextureOperate*>(s_pDefaultInstance_3913280621));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_3913280621;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::TextureOperate>::s_pDefaultInstance_3913280621);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::TextureOperate>::s_pDefaultInstance_3913280621, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::TextureOperate const* TTypeCompositeInfo<::SE::Editor::TextureOperate>::s_pDefaultInstance_3913280621 = nullptr;
}
