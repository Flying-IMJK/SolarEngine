...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor MainMenuButton
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::MainMenuButton> final : public TypeCompositeInfo
    {
       static ::SE::Editor::MainMenuButton const* s_pDefaultInstance_1175281155436856246;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_1175281155436856246 = New<::SE::Editor::MainMenuButton>(nullptr);

            ::SE::Editor::MainMenuButton::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::MainMenuButton>>(s_pDefaultInstance_1175281155436856246);
            Types::RegisterType(::SE::Editor::MainMenuButton::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::MainMenuButton::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::MainMenuButton*>(s_pDefaultInstance_1175281155436856246));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::MainMenuButton::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::MainMenuButton"));
            size = sizeof(::SE::Editor::MainMenuButton);
            alignment = alignof(::SE::Editor::MainMenuButton);
            name = SE_TEXT("MainMenuButton");
            fullName = SE_TEXT("SE::Editor::MainMenuButton");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::MainMenuButton), alignof(::SE::Editor::MainMenuButton));
            return new (pMemory) ::SE::Editor::MainMenuButton(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::MainMenuButton(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_1175281155436856246;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::MainMenuButton>::s_pDefaultInstance_1175281155436856246);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::MainMenuButton>::s_pDefaultInstance_1175281155436856246, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::MainMenuButton const* TTypeCompositeInfo<::SE::Editor::MainMenuButton>::s_pDefaultInstance_1175281155436856246 = nullptr;
}
