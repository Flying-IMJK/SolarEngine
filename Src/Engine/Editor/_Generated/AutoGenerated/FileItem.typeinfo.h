...
namespace SE
{
    ...
    {
       static ::SE::Editor::FileItem const* s_pDefaultInstance_13405855910379257449;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_13405855910379257449 = New<::SE::Editor::FileItem>(nullptr);

            ::SE::Editor::FileItem::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::FileItem>>(s_pDefaultInstance_13405855910379257449);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::FileItem*>(s_pDefaultInstance_13405855910379257449));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_13405855910379257449;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::FileItem>::s_pDefaultInstance_13405855910379257449);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::FileItem>::s_pDefaultInstance_13405855910379257449, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::FileItem const* TTypeCompositeInfo<::SE::Editor::FileItem>::s_pDefaultInstance_13405855910379257449 = nullptr;
}
