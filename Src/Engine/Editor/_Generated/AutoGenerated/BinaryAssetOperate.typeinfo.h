...
namespace SE
{
    ...
    {
       static ::SE::Editor::BinaryAssetOperate const* s_pDefaultInstance_1191932827461373973;
    ...
    public:
        ...
        {
            return s_pDefaultInstance_1191932827461373973;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::BinaryAssetOperate>::s_pDefaultInstance_1191932827461373973);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::BinaryAssetOperate>::s_pDefaultInstance_1191932827461373973, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::BinaryAssetOperate const* TTypeCompositeInfo<::SE::Editor::BinaryAssetOperate>::s_pDefaultInstance_1191932827461373973 = nullptr;
}
