...
namespace SE
{
    ...
    {
       static ::SE::Editor::PropertiesListElement const* s_pDefaultInstance_3312162111;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_3312162111 = New<::SE::Editor::PropertiesListElement>(nullptr);

            ::SE::Editor::PropertiesListElement::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::PropertiesListElement>>(s_pDefaultInstance_3312162111);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::PropertiesListElement*>(s_pDefaultInstance_3312162111));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_3312162111;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::PropertiesListElement>::s_pDefaultInstance_3312162111);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::PropertiesListElement>::s_pDefaultInstance_3312162111, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::PropertiesListElement const* TTypeCompositeInfo<::SE::Editor::PropertiesListElement>::s_pDefaultInstance_3312162111 = nullptr;
}
