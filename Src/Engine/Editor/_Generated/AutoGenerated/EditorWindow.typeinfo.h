...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor EditorWindow
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::EditorWindow> final : public TypeCompositeInfo
    {
       static ::SE::Editor::EditorWindow const* s_pDefaultInstance_18366145569621412421;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_18366145569621412421 = New<::SE::Editor::EditorWindow>(nullptr);

            ::SE::Editor::EditorWindow::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::EditorWindow>>(s_pDefaultInstance_18366145569621412421);
            Types::RegisterType(::SE::Editor::EditorWindow::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::EditorWindow::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::EditorWindow*>(s_pDefaultInstance_18366145569621412421));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::EditorWindow::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::EditorWindow"));
            size = sizeof(::SE::Editor::EditorWindow);
            alignment = alignof(::SE::Editor::EditorWindow);
            name = SE_TEXT("EditorWindow");
            fullName = SE_TEXT("SE::Editor::EditorWindow");
            ...
            // Add parent info
            // Parent types
            pParentTypeInfo = ::SE::Editor::DockWindow::s_pTypeInfo;
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::EditorWindow), alignof(::SE::Editor::EditorWindow));
            return new (pMemory) ::SE::Editor::EditorWindow(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::EditorWindow(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_18366145569621412421;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::EditorWindow>::s_pDefaultInstance_18366145569621412421);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::EditorWindow>::s_pDefaultInstance_18366145569621412421, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::EditorWindow const* TTypeCompositeInfo<::SE::Editor::EditorWindow>::s_pDefaultInstance_18366145569621412421 = nullptr;
}
