...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor StaticModelGraphNode
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::StaticModelGraphNode> final : public TypeCompositeInfo
    {
       static ::SE::Editor::StaticModelGraphNode const* s_pDefaultInstance_14299522675642605197;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_14299522675642605197 = New<::SE::Editor::StaticModelGraphNode>(nullptr);

            ::SE::Editor::StaticModelGraphNode::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::StaticModelGraphNode>>(s_pDefaultInstance_14299522675642605197);
            Types::RegisterType(::SE::Editor::StaticModelGraphNode::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::StaticModelGraphNode::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::StaticModelGraphNode*>(s_pDefaultInstance_14299522675642605197));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::StaticModelGraphNode::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::StaticModelGraphNode"));
            size = sizeof(::SE::Editor::StaticModelGraphNode);
            alignment = alignof(::SE::Editor::StaticModelGraphNode);
            name = SE_TEXT("StaticModelGraphNode");
            fullName = SE_TEXT("SE::Editor::StaticModelGraphNode");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::StaticModelGraphNode), alignof(::SE::Editor::StaticModelGraphNode));
            return new (pMemory) ::SE::Editor::StaticModelGraphNode(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::StaticModelGraphNode(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_14299522675642605197;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::StaticModelGraphNode>::s_pDefaultInstance_14299522675642605197);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::StaticModelGraphNode>::s_pDefaultInstance_14299522675642605197, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::StaticModelGraphNode const* TTypeCompositeInfo<::SE::Editor::StaticModelGraphNode>::s_pDefaultInstance_14299522675642605197 = nullptr;
}
