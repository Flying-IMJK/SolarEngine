...
namespace SE
{
    ...
    {
       static ::SE::Editor::ContextMenuItem const* s_pDefaultInstance_4092398517;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_4092398517 = New<::SE::Editor::ContextMenuItem>(nullptr);

            ::SE::Editor::ContextMenuItem::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ContextMenuItem>>(s_pDefaultInstance_4092398517);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::ContextMenuItem*>(s_pDefaultInstance_4092398517));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_4092398517;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContextMenuItem>::s_pDefaultInstance_4092398517);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContextMenuItem>::s_pDefaultInstance_4092398517, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ContextMenuItem const* TTypeCompositeInfo<::SE::Editor::ContextMenuItem>::s_pDefaultInstance_4092398517 = nullptr;
}
