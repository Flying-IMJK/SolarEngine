...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor GenericEditor
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::GenericEditor> final : public TypeCompositeInfo
    {
       static ::SE::Editor::GenericEditor const* s_pDefaultInstance_6460058296981526108;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_6460058296981526108 = New<::SE::Editor::GenericEditor>(nullptr);

            ::SE::Editor::GenericEditor::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::GenericEditor>>(s_pDefaultInstance_6460058296981526108);
            Types::RegisterType(::SE::Editor::GenericEditor::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::GenericEditor::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::GenericEditor*>(s_pDefaultInstance_6460058296981526108));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::GenericEditor::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::GenericEditor"));
            size = sizeof(::SE::Editor::GenericEditor);
            alignment = alignof(::SE::Editor::GenericEditor);
            name = SE_TEXT("GenericEditor");
            fullName = SE_TEXT("SE::Editor::GenericEditor");
            ...
            // Add parent info
            // Parent types
            pParentTypeInfo = ::SE::Editor::CustomEditor::s_pTypeInfo;
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::GenericEditor), alignof(::SE::Editor::GenericEditor));
            return new (pMemory) ::SE::Editor::GenericEditor(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::GenericEditor(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_6460058296981526108;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::GenericEditor>::s_pDefaultInstance_6460058296981526108);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::GenericEditor>::s_pDefaultInstance_6460058296981526108, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::GenericEditor const* TTypeCompositeInfo<::SE::Editor::GenericEditor>::s_pDefaultInstance_6460058296981526108 = nullptr;
}
