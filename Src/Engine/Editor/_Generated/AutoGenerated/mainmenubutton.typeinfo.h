...
namespace SE
{
    ...
    {
       static ::SE::Editor::MainMenuButton const* s_pDefaultInstance_3555079490;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_3555079490 = New<::SE::Editor::MainMenuButton>(nullptr);

            ::SE::Editor::MainMenuButton::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::MainMenuButton>>(s_pDefaultInstance_3555079490);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::MainMenuButton*>(s_pDefaultInstance_3555079490));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_3555079490;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::MainMenuButton>::s_pDefaultInstance_3555079490);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::MainMenuButton>::s_pDefaultInstance_3555079490, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::MainMenuButton const* TTypeCompositeInfo<::SE::Editor::MainMenuButton>::s_pDefaultInstance_3555079490 = nullptr;
}
