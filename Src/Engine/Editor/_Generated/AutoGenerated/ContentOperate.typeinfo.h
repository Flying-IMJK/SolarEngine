...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor ContentOperate
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::ContentOperate> final : public TypeCompositeInfo
    {
       static ::SE::Editor::ContentOperate const* s_pDefaultInstance_13478521471083491731;
    ...
    public:
        static void RegisterType()
        {
            ...
            ::SE::Editor::ContentOperate::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ContentOperate>>(s_pDefaultInstance_13478521471083491731);
            Types::RegisterType(::SE::Editor::ContentOperate::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::ContentOperate::s_pTypeInfo);
            
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::ContentOperate::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::ContentOperate"));
            size = sizeof(::SE::Editor::ContentOperate);
            alignment = alignof(::SE::Editor::ContentOperate);
            name = SE_TEXT("ContentOperate");
            fullName = SE_TEXT("SE::Editor::ContentOperate");
        ...
        {
            return s_pDefaultInstance_13478521471083491731;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContentOperate>::s_pDefaultInstance_13478521471083491731);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContentOperate>::s_pDefaultInstance_13478521471083491731, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ContentOperate const* TTypeCompositeInfo<::SE::Editor::ContentOperate>::s_pDefaultInstance_13478521471083491731 = nullptr;
}
