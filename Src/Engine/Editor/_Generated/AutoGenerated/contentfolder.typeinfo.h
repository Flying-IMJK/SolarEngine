...
namespace SE
{
    ...
    {
       static ::SE::Editor::ContentFolder const* s_pDefaultInstance_1590672355;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_1590672355 = New<::SE::Editor::ContentFolder>(nullptr);

            ::SE::Editor::ContentFolder::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ContentFolder>>(s_pDefaultInstance_1590672355);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::ContentFolder*>(s_pDefaultInstance_1590672355));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_1590672355;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContentFolder>::s_pDefaultInstance_1590672355);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContentFolder>::s_pDefaultInstance_1590672355, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ContentFolder const* TTypeCompositeInfo<::SE::Editor::ContentFolder>::s_pDefaultInstance_1590672355 = nullptr;
}
