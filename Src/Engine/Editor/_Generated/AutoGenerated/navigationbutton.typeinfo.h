...
namespace SE
{
    ...
    {
       static ::SE::Editor::NavigationButton const* s_pDefaultInstance_1707213912;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_1707213912 = New<::SE::Editor::NavigationButton>(nullptr);

            ::SE::Editor::NavigationButton::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::NavigationButton>>(s_pDefaultInstance_1707213912);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::NavigationButton*>(s_pDefaultInstance_1707213912));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_1707213912;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::NavigationButton>::s_pDefaultInstance_1707213912);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::NavigationButton>::s_pDefaultInstance_1707213912, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::NavigationButton const* TTypeCompositeInfo<::SE::Editor::NavigationButton>::s_pDefaultInstance_1707213912 = nullptr;
}
