...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor ContextMenu
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::ContextMenu> final : public TypeCompositeInfo
    {
       static ::SE::Editor::ContextMenu const* s_pDefaultInstance_365232766598708216;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_365232766598708216 = New<::SE::Editor::ContextMenu>(nullptr);

            ::SE::Editor::ContextMenu::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ContextMenu>>(s_pDefaultInstance_365232766598708216);
            Types::RegisterType(::SE::Editor::ContextMenu::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::ContextMenu::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::ContextMenu*>(s_pDefaultInstance_365232766598708216));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::ContextMenu::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::ContextMenu"));
            size = sizeof(::SE::Editor::ContextMenu);
            alignment = alignof(::SE::Editor::ContextMenu);
            name = SE_TEXT("ContextMenu");
            fullName = SE_TEXT("SE::Editor::ContextMenu");
            ...
            // Add parent info
            // Parent types
            pParentTypeInfo = ::SE::Editor::ContextMenuBase::s_pTypeInfo;
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::ContextMenu), alignof(::SE::Editor::ContextMenu));
            return new (pMemory) ::SE::Editor::ContextMenu(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::ContextMenu(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_365232766598708216;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContextMenu>::s_pDefaultInstance_365232766598708216);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContextMenu>::s_pDefaultInstance_365232766598708216, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ContextMenu const* TTypeCompositeInfo<::SE::Editor::ContextMenu>::s_pDefaultInstance_365232766598708216 = nullptr;
}
