...
namespace SE
{
    ...
    {
       static ::SE::Editor::DragEventArgs const* s_pDefaultInstance_4096965977;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_4096965977 = New<::SE::Editor::DragEventArgs>(nullptr);

            ::SE::Editor::DragEventArgs::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::DragEventArgs>>(s_pDefaultInstance_4096965977);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::DragEventArgs*>(s_pDefaultInstance_4096965977));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_4096965977;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::DragEventArgs>::s_pDefaultInstance_4096965977);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::DragEventArgs>::s_pDefaultInstance_4096965977, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::DragEventArgs const* TTypeCompositeInfo<::SE::Editor::DragEventArgs>::s_pDefaultInstance_4096965977 = nullptr;
}
