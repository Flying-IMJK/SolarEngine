...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor DockPanel
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::DockPanel> final : public TypeCompositeInfo
    {
       static ::SE::Editor::DockPanel const* s_pDefaultInstance_3819061950380531275;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_3819061950380531275 = New<::SE::Editor::DockPanel>(nullptr);

            ::SE::Editor::DockPanel::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::DockPanel>>(s_pDefaultInstance_3819061950380531275);
            Types::RegisterType(::SE::Editor::DockPanel::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::DockPanel::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::DockPanel*>(s_pDefaultInstance_3819061950380531275));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::DockPanel::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::DockPanel"));
            size = sizeof(::SE::Editor::DockPanel);
            alignment = alignof(::SE::Editor::DockPanel);
            name = SE_TEXT("DockPanel");
            fullName = SE_TEXT("SE::Editor::DockPanel");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::DockPanel), alignof(::SE::Editor::DockPanel));
            return new (pMemory) ::SE::Editor::DockPanel(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::DockPanel(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_3819061950380531275;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::DockPanel>::s_pDefaultInstance_3819061950380531275);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::DockPanel>::s_pDefaultInstance_3819061950380531275, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::DockPanel const* TTypeCompositeInfo<::SE::Editor::DockPanel>::s_pDefaultInstance_3819061950380531275 = nullptr;
}
