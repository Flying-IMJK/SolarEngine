...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor CameraGraphNode
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::CameraGraphNode> final : public TypeCompositeInfo
    {
       static ::SE::Editor::CameraGraphNode const* s_pDefaultInstance_18315636535787962073;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_18315636535787962073 = New<::SE::Editor::CameraGraphNode>(nullptr);

            ::SE::Editor::CameraGraphNode::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::CameraGraphNode>>(s_pDefaultInstance_18315636535787962073);
            Types::RegisterType(::SE::Editor::CameraGraphNode::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::CameraGraphNode::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::CameraGraphNode*>(s_pDefaultInstance_18315636535787962073));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::CameraGraphNode::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::CameraGraphNode"));
            size = sizeof(::SE::Editor::CameraGraphNode);
            alignment = alignof(::SE::Editor::CameraGraphNode);
            name = SE_TEXT("CameraGraphNode");
            fullName = SE_TEXT("SE::Editor::CameraGraphNode");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::CameraGraphNode), alignof(::SE::Editor::CameraGraphNode));
            return new (pMemory) ::SE::Editor::CameraGraphNode(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::CameraGraphNode(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_18315636535787962073;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::CameraGraphNode>::s_pDefaultInstance_18315636535787962073);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::CameraGraphNode>::s_pDefaultInstance_18315636535787962073, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::CameraGraphNode const* TTypeCompositeInfo<::SE::Editor::CameraGraphNode>::s_pDefaultInstance_18315636535787962073 = nullptr;
}
