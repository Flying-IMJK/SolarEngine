...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor LayoutElement
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::LayoutElement> final : public TypeCompositeInfo
    {
       static ::SE::Editor::LayoutElement const* s_pDefaultInstance_4782276018455720258;
    ...
    public:
        static void RegisterType()
        {
            ...
            ::SE::Editor::LayoutElement::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::LayoutElement>>(s_pDefaultInstance_4782276018455720258);
            Types::RegisterType(::SE::Editor::LayoutElement::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::LayoutElement::s_pTypeInfo);
            
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::LayoutElement::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::LayoutElement"));
            size = sizeof(::SE::Editor::LayoutElement);
            alignment = alignof(::SE::Editor::LayoutElement);
            name = SE_TEXT("LayoutElement");
            fullName = SE_TEXT("SE::Editor::LayoutElement");
        ...
        {
            return s_pDefaultInstance_4782276018455720258;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::LayoutElement>::s_pDefaultInstance_4782276018455720258);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::LayoutElement>::s_pDefaultInstance_4782276018455720258, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::LayoutElement const* TTypeCompositeInfo<::SE::Editor::LayoutElement>::s_pDefaultInstance_4782276018455720258 = nullptr;
}
