...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor SkyGraphNode
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::SkyGraphNode> final : public TypeCompositeInfo
    {
       static ::SE::Editor::SkyGraphNode const* s_pDefaultInstance_17804265899767709483;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_17804265899767709483 = New<::SE::Editor::SkyGraphNode>(nullptr);

            ::SE::Editor::SkyGraphNode::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::SkyGraphNode>>(s_pDefaultInstance_17804265899767709483);
            Types::RegisterType(::SE::Editor::SkyGraphNode::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::SkyGraphNode::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::SkyGraphNode*>(s_pDefaultInstance_17804265899767709483));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::SkyGraphNode::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::SkyGraphNode"));
            size = sizeof(::SE::Editor::SkyGraphNode);
            alignment = alignof(::SE::Editor::SkyGraphNode);
            name = SE_TEXT("SkyGraphNode");
            fullName = SE_TEXT("SE::Editor::SkyGraphNode");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::SkyGraphNode), alignof(::SE::Editor::SkyGraphNode));
            return new (pMemory) ::SE::Editor::SkyGraphNode(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::SkyGraphNode(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_17804265899767709483;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::SkyGraphNode>::s_pDefaultInstance_17804265899767709483);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::SkyGraphNode>::s_pDefaultInstance_17804265899767709483, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::SkyGraphNode const* TTypeCompositeInfo<::SE::Editor::SkyGraphNode>::s_pDefaultInstance_17804265899767709483 = nullptr;
}
