...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor TreeNode
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::TreeNode> final : public TypeCompositeInfo
    {
       static ::SE::Editor::TreeNode const* s_pDefaultInstance_12220208457999251952;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_12220208457999251952 = New<::SE::Editor::TreeNode>(nullptr);

            ::SE::Editor::TreeNode::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::TreeNode>>(s_pDefaultInstance_12220208457999251952);
            Types::RegisterType(::SE::Editor::TreeNode::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::TreeNode::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::TreeNode*>(s_pDefaultInstance_12220208457999251952));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::TreeNode::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::TreeNode"));
            size = sizeof(::SE::Editor::TreeNode);
            alignment = alignof(::SE::Editor::TreeNode);
            name = SE_TEXT("TreeNode");
            fullName = SE_TEXT("SE::Editor::TreeNode");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::TreeNode), alignof(::SE::Editor::TreeNode));
            return new (pMemory) ::SE::Editor::TreeNode(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::TreeNode(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_12220208457999251952;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::TreeNode>::s_pDefaultInstance_12220208457999251952);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::TreeNode>::s_pDefaultInstance_12220208457999251952, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::TreeNode const* TTypeCompositeInfo<::SE::Editor::TreeNode>::s_pDefaultInstance_12220208457999251952 = nullptr;
}
