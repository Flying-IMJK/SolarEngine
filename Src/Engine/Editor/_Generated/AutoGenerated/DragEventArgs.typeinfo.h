...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor DragEventArgs
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::DragEventArgs> final : public TypeCompositeInfo
    {
       static ::SE::Editor::DragEventArgs const* s_pDefaultInstance_1317285435238509635;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_1317285435238509635 = New<::SE::Editor::DragEventArgs>(nullptr);

            ::SE::Editor::DragEventArgs::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::DragEventArgs>>(s_pDefaultInstance_1317285435238509635);
            Types::RegisterType(::SE::Editor::DragEventArgs::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::DragEventArgs::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::DragEventArgs*>(s_pDefaultInstance_1317285435238509635));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::DragEventArgs::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::DragEventArgs"));
            size = sizeof(::SE::Editor::DragEventArgs);
            alignment = alignof(::SE::Editor::DragEventArgs);
            name = SE_TEXT("DragEventArgs");
            fullName = SE_TEXT("SE::Editor::DragEventArgs");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::DragEventArgs), alignof(::SE::Editor::DragEventArgs));
            return new (pMemory) ::SE::Editor::DragEventArgs(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::DragEventArgs(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_1317285435238509635;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::DragEventArgs>::s_pDefaultInstance_1317285435238509635);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::DragEventArgs>::s_pDefaultInstance_1317285435238509635, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::DragEventArgs const* TTypeCompositeInfo<::SE::Editor::DragEventArgs>::s_pDefaultInstance_1317285435238509635 = nullptr;
}
