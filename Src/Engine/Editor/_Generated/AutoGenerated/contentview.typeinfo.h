...
namespace SE
{
    ...
    {
       static ::SE::Editor::ContentView const* s_pDefaultInstance_2080493346;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_2080493346 = New<::SE::Editor::ContentView>(nullptr);

            ::SE::Editor::ContentView::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ContentView>>(s_pDefaultInstance_2080493346);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::ContentView*>(s_pDefaultInstance_2080493346));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_2080493346;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContentView>::s_pDefaultInstance_2080493346);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContentView>::s_pDefaultInstance_2080493346, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ContentView const* TTypeCompositeInfo<::SE::Editor::ContentView>::s_pDefaultInstance_2080493346 = nullptr;
}
