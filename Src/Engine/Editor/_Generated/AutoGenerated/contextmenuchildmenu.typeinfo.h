...
namespace SE
{
    ...
    {
       static ::SE::Editor::ContextMenuChildMenu const* s_pDefaultInstance_701650559;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_701650559 = New<::SE::Editor::ContextMenuChildMenu>(nullptr);

            ::SE::Editor::ContextMenuChildMenu::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ContextMenuChildMenu>>(s_pDefaultInstance_701650559);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::ContextMenuChildMenu*>(s_pDefaultInstance_701650559));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_701650559;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContextMenuChildMenu>::s_pDefaultInstance_701650559);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContextMenuChildMenu>::s_pDefaultInstance_701650559, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ContextMenuChildMenu const* TTypeCompositeInfo<::SE::Editor::ContextMenuChildMenu>::s_pDefaultInstance_701650559 = nullptr;
}
