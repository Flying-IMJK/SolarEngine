...
namespace SE
{
    ...
    {
       static ::SE::Editor::MainMenu const* s_pDefaultInstance_826600486;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_826600486 = New<::SE::Editor::MainMenu>(nullptr);

            ::SE::Editor::MainMenu::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::MainMenu>>(s_pDefaultInstance_826600486);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::MainMenu*>(s_pDefaultInstance_826600486));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_826600486;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::MainMenu>::s_pDefaultInstance_826600486);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::MainMenu>::s_pDefaultInstance_826600486, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::MainMenu const* TTypeCompositeInfo<::SE::Editor::MainMenu>::s_pDefaultInstance_826600486 = nullptr;
}
