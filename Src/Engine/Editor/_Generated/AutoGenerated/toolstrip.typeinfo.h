...
namespace SE
{
    ...
    {
       static ::SE::Editor::ToolStrip const* s_pDefaultInstance_1049306140;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_1049306140 = New<::SE::Editor::ToolStrip>(nullptr);

            ::SE::Editor::ToolStrip::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ToolStrip>>(s_pDefaultInstance_1049306140);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::ToolStrip*>(s_pDefaultInstance_1049306140));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_1049306140;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ToolStrip>::s_pDefaultInstance_1049306140);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ToolStrip>::s_pDefaultInstance_1049306140, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ToolStrip const* TTypeCompositeInfo<::SE::Editor::ToolStrip>::s_pDefaultInstance_1049306140 = nullptr;
}
