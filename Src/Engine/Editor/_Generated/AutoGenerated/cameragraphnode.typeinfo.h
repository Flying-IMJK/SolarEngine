...
namespace SE
{
    ...
    {
       static ::SE::Editor::CameraGraphNode const* s_pDefaultInstance_1829190797;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_1829190797 = New<::SE::Editor::CameraGraphNode>(nullptr);

            ::SE::Editor::CameraGraphNode::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::CameraGraphNode>>(s_pDefaultInstance_1829190797);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::CameraGraphNode*>(s_pDefaultInstance_1829190797));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_1829190797;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::CameraGraphNode>::s_pDefaultInstance_1829190797);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::CameraGraphNode>::s_pDefaultInstance_1829190797, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::CameraGraphNode const* TTypeCompositeInfo<::SE::Editor::CameraGraphNode>::s_pDefaultInstance_1829190797 = nullptr;
}
