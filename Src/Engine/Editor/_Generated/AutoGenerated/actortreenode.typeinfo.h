...
namespace SE
{
    ...
    {
       static ::SE::Editor::ActorTreeNode const* s_pDefaultInstance_433653915;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_433653915 = New<::SE::Editor::ActorTreeNode>(nullptr);

            ::SE::Editor::ActorTreeNode::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ActorTreeNode>>(s_pDefaultInstance_433653915);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::ActorTreeNode*>(s_pDefaultInstance_433653915));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_433653915;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ActorTreeNode>::s_pDefaultInstance_433653915);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ActorTreeNode>::s_pDefaultInstance_433653915, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ActorTreeNode const* TTypeCompositeInfo<::SE::Editor::ActorTreeNode>::s_pDefaultInstance_433653915 = nullptr;
}
