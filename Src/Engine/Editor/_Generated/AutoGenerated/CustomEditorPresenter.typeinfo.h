...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor CustomEditorPresenter
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::CustomEditorPresenter> final : public TypeCompositeInfo
    {
       static ::SE::Editor::CustomEditorPresenter const* s_pDefaultInstance_11459102307150823262;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_11459102307150823262 = New<::SE::Editor::CustomEditorPresenter>(nullptr);

            ::SE::Editor::CustomEditorPresenter::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::CustomEditorPresenter>>(s_pDefaultInstance_11459102307150823262);
            Types::RegisterType(::SE::Editor::CustomEditorPresenter::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::CustomEditorPresenter::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::CustomEditorPresenter*>(s_pDefaultInstance_11459102307150823262));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::CustomEditorPresenter::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::CustomEditorPresenter"));
            size = sizeof(::SE::Editor::CustomEditorPresenter);
            alignment = alignof(::SE::Editor::CustomEditorPresenter);
            name = SE_TEXT("CustomEditorPresenter");
            fullName = SE_TEXT("SE::Editor::CustomEditorPresenter");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::CustomEditorPresenter), alignof(::SE::Editor::CustomEditorPresenter));
            return new (pMemory) ::SE::Editor::CustomEditorPresenter(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::CustomEditorPresenter(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_11459102307150823262;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::CustomEditorPresenter>::s_pDefaultInstance_11459102307150823262);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::CustomEditorPresenter>::s_pDefaultInstance_11459102307150823262, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::CustomEditorPresenter const* TTypeCompositeInfo<::SE::Editor::CustomEditorPresenter>::s_pDefaultInstance_11459102307150823262 = nullptr;
}
