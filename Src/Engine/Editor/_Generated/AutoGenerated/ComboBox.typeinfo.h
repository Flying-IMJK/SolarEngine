...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor ComboBox
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::ComboBox> final : public TypeCompositeInfo
    {
       static ::SE::Editor::ComboBox const* s_pDefaultInstance_16510730335156977831;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_16510730335156977831 = New<::SE::Editor::ComboBox>(nullptr);

            ::SE::Editor::ComboBox::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ComboBox>>(s_pDefaultInstance_16510730335156977831);
            Types::RegisterType(::SE::Editor::ComboBox::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::ComboBox::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::ComboBox*>(s_pDefaultInstance_16510730335156977831));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::ComboBox::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::ComboBox"));
            size = sizeof(::SE::Editor::ComboBox);
            alignment = alignof(::SE::Editor::ComboBox);
            name = SE_TEXT("ComboBox");
            fullName = SE_TEXT("SE::Editor::ComboBox");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::ComboBox), alignof(::SE::Editor::ComboBox));
            return new (pMemory) ::SE::Editor::ComboBox(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::ComboBox(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_16510730335156977831;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ComboBox>::s_pDefaultInstance_16510730335156977831);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ComboBox>::s_pDefaultInstance_16510730335156977831, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ComboBox const* TTypeCompositeInfo<::SE::Editor::ComboBox>::s_pDefaultInstance_16510730335156977831 = nullptr;
}
