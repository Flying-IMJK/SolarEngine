...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor FloatValueElement
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::FloatValueElement> final : public TypeCompositeInfo
    {
       static ::SE::Editor::FloatValueElement const* s_pDefaultInstance_2322319598584718137;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_2322319598584718137 = New<::SE::Editor::FloatValueElement>(nullptr);

            ::SE::Editor::FloatValueElement::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::FloatValueElement>>(s_pDefaultInstance_2322319598584718137);
            Types::RegisterType(::SE::Editor::FloatValueElement::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::FloatValueElement::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::FloatValueElement*>(s_pDefaultInstance_2322319598584718137));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::FloatValueElement::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::FloatValueElement"));
            size = sizeof(::SE::Editor::FloatValueElement);
            alignment = alignof(::SE::Editor::FloatValueElement);
            name = SE_TEXT("FloatValueElement");
            fullName = SE_TEXT("SE::Editor::FloatValueElement");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::FloatValueElement), alignof(::SE::Editor::FloatValueElement));
            return new (pMemory) ::SE::Editor::FloatValueElement(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::FloatValueElement(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_2322319598584718137;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::FloatValueElement>::s_pDefaultInstance_2322319598584718137);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::FloatValueElement>::s_pDefaultInstance_2322319598584718137, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::FloatValueElement const* TTypeCompositeInfo<::SE::Editor::FloatValueElement>::s_pDefaultInstance_2322319598584718137 = nullptr;
}
