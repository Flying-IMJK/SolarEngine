...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor AssetOperate
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::AssetOperate> final : public TypeCompositeInfo
    {
       static ::SE::Editor::AssetOperate const* s_pDefaultInstance_10587483785054922968;
    ...
    public:
        static void RegisterType()
        {
            ...
            ::SE::Editor::AssetOperate::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::AssetOperate>>(s_pDefaultInstance_10587483785054922968);
            Types::RegisterType(::SE::Editor::AssetOperate::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::AssetOperate::s_pTypeInfo);
            
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::AssetOperate::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::AssetOperate"));
            size = sizeof(::SE::Editor::AssetOperate);
            alignment = alignof(::SE::Editor::AssetOperate);
            name = SE_TEXT("AssetOperate");
            fullName = SE_TEXT("SE::Editor::AssetOperate");
            ...
            // Add parent info
            // Parent types
            pParentTypeInfo = ::SE::Editor::ContentOperate::s_pTypeInfo;
        ...
        {
            return s_pDefaultInstance_10587483785054922968;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::AssetOperate>::s_pDefaultInstance_10587483785054922968);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::AssetOperate>::s_pDefaultInstance_10587483785054922968, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::AssetOperate const* TTypeCompositeInfo<::SE::Editor::AssetOperate>::s_pDefaultInstance_10587483785054922968 = nullptr;
}
