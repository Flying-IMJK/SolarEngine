...
namespace SE
{
    ...
    {
       static ::SE::Editor::CustomEditor const* s_pDefaultInstance_2979003726;
    ...
    public:
        static void RegisterType()
        {
            ...
            ::SE::Editor::CustomEditor::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::CustomEditor>>(s_pDefaultInstance_2979003726);
    ...
    public:
        ...
        {
            return s_pDefaultInstance_2979003726;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::CustomEditor>::s_pDefaultInstance_2979003726);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::CustomEditor>::s_pDefaultInstance_2979003726, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::CustomEditor const* TTypeCompositeInfo<::SE::Editor::CustomEditor>::s_pDefaultInstance_2979003726 = nullptr;
}
