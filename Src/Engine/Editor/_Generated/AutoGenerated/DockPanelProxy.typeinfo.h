...
namespace SE
{
    ...
    {
       static ::SE::Editor::DockPanelProxy const* s_pDefaultInstance_18213268704018554629;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_18213268704018554629 = New<::SE::Editor::DockPanelProxy>(nullptr);

            ::SE::Editor::DockPanelProxy::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::DockPanelProxy>>(s_pDefaultInstance_18213268704018554629);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::DockPanelProxy*>(s_pDefaultInstance_18213268704018554629));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_18213268704018554629;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::DockPanelProxy>::s_pDefaultInstance_18213268704018554629);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::DockPanelProxy>::s_pDefaultInstance_18213268704018554629, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::DockPanelProxy const* TTypeCompositeInfo<::SE::Editor::DockPanelProxy>::s_pDefaultInstance_18213268704018554629 = nullptr;
}
