...
namespace SE
{
    ...
    {
       static ::SE::Editor::NewItem const* s_pDefaultInstance_2529577925;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_2529577925 = New<::SE::Editor::NewItem>(nullptr);

            ::SE::Editor::NewItem::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::NewItem>>(s_pDefaultInstance_2529577925);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::NewItem*>(s_pDefaultInstance_2529577925));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_2529577925;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::NewItem>::s_pDefaultInstance_2529577925);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::NewItem>::s_pDefaultInstance_2529577925, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::NewItem const* TTypeCompositeInfo<::SE::Editor::NewItem>::s_pDefaultInstance_2529577925 = nullptr;
}
