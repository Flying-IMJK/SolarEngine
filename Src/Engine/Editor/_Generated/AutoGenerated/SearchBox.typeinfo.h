...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor SearchBox
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::SearchBox> final : public TypeCompositeInfo
    {
       static ::SE::Editor::SearchBox const* s_pDefaultInstance_11673971572054539697;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_11673971572054539697 = New<::SE::Editor::SearchBox>(nullptr);

            ::SE::Editor::SearchBox::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::SearchBox>>(s_pDefaultInstance_11673971572054539697);
            Types::RegisterType(::SE::Editor::SearchBox::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::SearchBox::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::SearchBox*>(s_pDefaultInstance_11673971572054539697));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::SearchBox::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::SearchBox"));
            size = sizeof(::SE::Editor::SearchBox);
            alignment = alignof(::SE::Editor::SearchBox);
            name = SE_TEXT("SearchBox");
            fullName = SE_TEXT("SE::Editor::SearchBox");
            ...
            // Add parent info
            // Parent types
            pParentTypeInfo = ::SE::TextBox::s_pTypeInfo;
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::SearchBox), alignof(::SE::Editor::SearchBox));
            return new (pMemory) ::SE::Editor::SearchBox(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::SearchBox(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_11673971572054539697;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::SearchBox>::s_pDefaultInstance_11673971572054539697);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::SearchBox>::s_pDefaultInstance_11673971572054539697, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::SearchBox const* TTypeCompositeInfo<::SE::Editor::SearchBox>::s_pDefaultInstance_11673971572054539697 = nullptr;
}
