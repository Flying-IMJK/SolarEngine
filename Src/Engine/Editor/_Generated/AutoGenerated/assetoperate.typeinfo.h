...
namespace SE
{
    ...
    {
       static ::SE::Editor::AssetOperate const* s_pDefaultInstance_1845480828;
    ...
    public:
        static void RegisterType()
        {
            ...
            ::SE::Editor::AssetOperate::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::AssetOperate>>(s_pDefaultInstance_1845480828);
    ...
    public:
        ...
        {
            return s_pDefaultInstance_1845480828;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::AssetOperate>::s_pDefaultInstance_1845480828);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::AssetOperate>::s_pDefaultInstance_1845480828, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::AssetOperate const* TTypeCompositeInfo<::SE::Editor::AssetOperate>::s_pDefaultInstance_1845480828 = nullptr;
}
