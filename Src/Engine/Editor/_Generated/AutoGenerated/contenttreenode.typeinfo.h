...
namespace SE
{
    ...
    {
       static ::SE::Editor::ContentTreeNode const* s_pDefaultInstance_333970205;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_333970205 = New<::SE::Editor::ContentTreeNode>(nullptr);

            ::SE::Editor::ContentTreeNode::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ContentTreeNode>>(s_pDefaultInstance_333970205);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::ContentTreeNode*>(s_pDefaultInstance_333970205));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_333970205;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContentTreeNode>::s_pDefaultInstance_333970205);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContentTreeNode>::s_pDefaultInstance_333970205, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ContentTreeNode const* TTypeCompositeInfo<::SE::Editor::ContentTreeNode>::s_pDefaultInstance_333970205 = nullptr;
}
...
namespace SE
{
    ...
    {
       static ::SE::Editor::RootContentTreeNode const* s_pDefaultInstance_3523561121;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_3523561121 = New<::SE::Editor::RootContentTreeNode>(nullptr);

            ::SE::Editor::RootContentTreeNode::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::RootContentTreeNode>>(s_pDefaultInstance_3523561121);
        ...
        static void UnregisterType()
        {
            ...
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::RootContentTreeNode*>(s_pDefaultInstance_3523561121));
    ...
    public:
        ...
        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_3523561121;
        }
        ...
        virtual bool AreAllPropertiesSetToDefault(IType const *pTypeInstance) const override
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::RootContentTreeNode>::s_pDefaultInstance_3523561121);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::RootContentTreeNode>::s_pDefaultInstance_3523561121, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::RootContentTreeNode const* TTypeCompositeInfo<::SE::Editor::RootContentTreeNode>::s_pDefaultInstance_3523561121 = nullptr;
}
