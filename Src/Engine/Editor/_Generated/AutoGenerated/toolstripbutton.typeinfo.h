...
namespace SE
{
    ...
    {
       static ::SE::Editor::ToolStripButton const* s_pDefaultInstance_4180676024;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_4180676024 = New<::SE::Editor::ToolStripButton>(nullptr);

            ::SE::Editor::ToolStripButton::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ToolStripButton>>(s_pDefaultInstance_4180676024);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::ToolStripButton*>(s_pDefaultInstance_4180676024));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_4180676024;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ToolStripButton>::s_pDefaultInstance_4180676024);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ToolStripButton>::s_pDefaultInstance_4180676024, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ToolStripButton const* TTypeCompositeInfo<::SE::Editor::ToolStripButton>::s_pDefaultInstance_4180676024 = nullptr;
}
