...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor CustomEditor
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::CustomEditor> final : public TypeCompositeInfo
    {
       static ::SE::Editor::CustomEditor const* s_pDefaultInstance_4800068693987069746;
    ...
    public:
        static void RegisterType()
        {
            ...
            ::SE::Editor::CustomEditor::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::CustomEditor>>(s_pDefaultInstance_4800068693987069746);
            Types::RegisterType(::SE::Editor::CustomEditor::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::CustomEditor::s_pTypeInfo);
            
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::CustomEditor::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::CustomEditor"));
            size = sizeof(::SE::Editor::CustomEditor);
            alignment = alignof(::SE::Editor::CustomEditor);
            name = SE_TEXT("CustomEditor");
            fullName = SE_TEXT("SE::Editor::CustomEditor");
        ...
        {
            return s_pDefaultInstance_4800068693987069746;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::CustomEditor>::s_pDefaultInstance_4800068693987069746);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::CustomEditor>::s_pDefaultInstance_4800068693987069746, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::CustomEditor const* TTypeCompositeInfo<::SE::Editor::CustomEditor>::s_pDefaultInstance_4800068693987069746 = nullptr;
}
