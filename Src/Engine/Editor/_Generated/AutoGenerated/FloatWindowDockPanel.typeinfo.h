...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor FloatWindowDockPanel
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::FloatWindowDockPanel> final : public TypeCompositeInfo
    {
       static ::SE::Editor::FloatWindowDockPanel const* s_pDefaultInstance_17344623861489144445;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_17344623861489144445 = New<::SE::Editor::FloatWindowDockPanel>(nullptr);

            ::SE::Editor::FloatWindowDockPanel::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::FloatWindowDockPanel>>(s_pDefaultInstance_17344623861489144445);
            Types::RegisterType(::SE::Editor::FloatWindowDockPanel::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::FloatWindowDockPanel::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::FloatWindowDockPanel*>(s_pDefaultInstance_17344623861489144445));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::FloatWindowDockPanel::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::FloatWindowDockPanel"));
            size = sizeof(::SE::Editor::FloatWindowDockPanel);
            alignment = alignof(::SE::Editor::FloatWindowDockPanel);
            name = SE_TEXT("FloatWindowDockPanel");
            fullName = SE_TEXT("SE::Editor::FloatWindowDockPanel");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::FloatWindowDockPanel), alignof(::SE::Editor::FloatWindowDockPanel));
            return new (pMemory) ::SE::Editor::FloatWindowDockPanel(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::FloatWindowDockPanel(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_17344623861489144445;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::FloatWindowDockPanel>::s_pDefaultInstance_17344623861489144445);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::FloatWindowDockPanel>::s_pDefaultInstance_17344623861489144445, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::FloatWindowDockPanel const* TTypeCompositeInfo<::SE::Editor::FloatWindowDockPanel>::s_pDefaultInstance_17344623861489144445 = nullptr;
}
