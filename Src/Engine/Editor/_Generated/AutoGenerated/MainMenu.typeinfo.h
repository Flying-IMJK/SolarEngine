...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor MainMenu
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::MainMenu> final : public TypeCompositeInfo
    {
       static ::SE::Editor::MainMenu const* s_pDefaultInstance_10822420179526800726;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_10822420179526800726 = New<::SE::Editor::MainMenu>(nullptr);

            ::SE::Editor::MainMenu::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::MainMenu>>(s_pDefaultInstance_10822420179526800726);
            Types::RegisterType(::SE::Editor::MainMenu::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::MainMenu::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::MainMenu*>(s_pDefaultInstance_10822420179526800726));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::MainMenu::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::MainMenu"));
            size = sizeof(::SE::Editor::MainMenu);
            alignment = alignof(::SE::Editor::MainMenu);
            name = SE_TEXT("MainMenu");
            fullName = SE_TEXT("SE::Editor::MainMenu");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::MainMenu), alignof(::SE::Editor::MainMenu));
            return new (pMemory) ::SE::Editor::MainMenu(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::MainMenu(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_10822420179526800726;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::MainMenu>::s_pDefaultInstance_10822420179526800726);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::MainMenu>::s_pDefaultInstance_10822420179526800726, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::MainMenu const* TTypeCompositeInfo<::SE::Editor::MainMenu>::s_pDefaultInstance_10822420179526800726 = nullptr;
}
