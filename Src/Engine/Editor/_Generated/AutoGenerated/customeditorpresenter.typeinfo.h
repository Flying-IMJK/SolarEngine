...
namespace SE
{
    ...
    {
       static ::SE::Editor::CustomEditorPresenter const* s_pDefaultInstance_2644910470;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_2644910470 = New<::SE::Editor::CustomEditorPresenter>(nullptr);

            ::SE::Editor::CustomEditorPresenter::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::CustomEditorPresenter>>(s_pDefaultInstance_2644910470);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::CustomEditorPresenter*>(s_pDefaultInstance_2644910470));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_2644910470;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::CustomEditorPresenter>::s_pDefaultInstance_2644910470);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::CustomEditorPresenter>::s_pDefaultInstance_2644910470, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::CustomEditorPresenter const* TTypeCompositeInfo<::SE::Editor::CustomEditorPresenter>::s_pDefaultInstance_2644910470 = nullptr;
}
