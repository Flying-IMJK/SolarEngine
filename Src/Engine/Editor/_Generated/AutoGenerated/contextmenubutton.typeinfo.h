...
namespace SE
{
    ...
    {
       static ::SE::Editor::ContextMenuButton const* s_pDefaultInstance_2468687682;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_2468687682 = New<::SE::Editor::ContextMenuButton>(nullptr);

            ::SE::Editor::ContextMenuButton::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ContextMenuButton>>(s_pDefaultInstance_2468687682);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::ContextMenuButton*>(s_pDefaultInstance_2468687682));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_2468687682;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContextMenuButton>::s_pDefaultInstance_2468687682);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContextMenuButton>::s_pDefaultInstance_2468687682, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ContextMenuButton const* TTypeCompositeInfo<::SE::Editor::ContextMenuButton>::s_pDefaultInstance_2468687682 = nullptr;
}
