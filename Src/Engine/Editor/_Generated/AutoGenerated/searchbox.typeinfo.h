...
namespace SE
{
    ...
    {
       static ::SE::Editor::SearchBox const* s_pDefaultInstance_1759914923;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_1759914923 = New<::SE::Editor::SearchBox>(nullptr);

            ::SE::Editor::SearchBox::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::SearchBox>>(s_pDefaultInstance_1759914923);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::SearchBox*>(s_pDefaultInstance_1759914923));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_1759914923;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::SearchBox>::s_pDefaultInstance_1759914923);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::SearchBox>::s_pDefaultInstance_1759914923, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::SearchBox const* TTypeCompositeInfo<::SE::Editor::SearchBox>::s_pDefaultInstance_1759914923 = nullptr;
}
