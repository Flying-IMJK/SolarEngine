...
//-------------------------------------------------------------------------
// Enum Info: SE::Editor ContentItemSearchFilter
//-------------------------------------------------------------------------
...
{
    template<>
    class TTypeEnumInfo<::SE::Editor::ContentItemSearchFilter> final : public TypeEnumInfo
    {
    public:
        static TTypeEnumInfo<::SE::Editor::ContentItemSearchFilter> * s_pTypeInfo;
        ...
        static void RegisterType()
        {
            ...
            s_pTypeInfo = New<TTypeEnumInfo<::SE::Editor::ContentItemSearchFilter>>();
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::ContentItemSearchFilter"));
            size = sizeof(::SE::Editor::ContentItemSearchFilter);
            alignment = alignof(::SE::Editor::ContentItemSearchFilter);
            name = SE_TEXT("ContentItemSearchFilter");
            fullName = SE_TEXT("SE::Editor::ContentItemSearchFilter");
            underlyingType = TypeIDCore::Int32;

            TypeEnumInfo::ConstantInfo constantInfo;
            constantInfo.id = StringID(SE_TEXT("Model"));
            constantInfo.value = 0;
            constantInfo.alphabeticalOrder = 4;
            SE_DEVELOPMENT_ONLY( constantInfo.description = "&lt;summary&gt; The model. &lt;/summary&gt;");
            constants.Add(constantInfo);
            constantInfo.id = StringID(SE_TEXT("SkinnedModel"));
            constantInfo.value = 1;
            constantInfo.alphabeticalOrder = 11;
            SE_DEVELOPMENT_ONLY( constantInfo.description = "&lt;summary&gt; The skinned model. &lt;/summary&gt;");
            constants.Add(constantInfo);
            constantInfo.id = StringID(SE_TEXT("Material"));
            constantInfo.value = 2;
            constantInfo.alphabeticalOrder = 3;
            SE_DEVELOPMENT_ONLY( constantInfo.description = "&lt;summary&gt; The material. &lt;/summary&gt;");
            constants.Add(constantInfo);
            constantInfo.id = StringID(SE_TEXT("Texture"));
            constantInfo.value = 3;
            constantInfo.alphabeticalOrder = 12;
            SE_DEVELOPMENT_ONLY( constantInfo.description = "&lt;summary&gt; The texture. &lt;/summary&gt;");
            constants.Add(constantInfo);
            constantInfo.id = StringID(SE_TEXT("Scene"));
            constantInfo.value = 4;
            constantInfo.alphabeticalOrder = 8;
            SE_DEVELOPMENT_ONLY( constantInfo.description = "&lt;summary&gt; The scene. &lt;/summary&gt;");
            constants.Add(constantInfo);
            constantInfo.id = StringID(SE_TEXT("Prefab"));
            constantInfo.value = 5;
            constantInfo.alphabeticalOrder = 7;
            SE_DEVELOPMENT_ONLY( constantInfo.description = "&lt;summary&gt; The prefab. &lt;/summary&gt;");
            constants.Add(constantInfo);
            constantInfo.id = StringID(SE_TEXT("Script"));
            constantInfo.value = 6;
            constantInfo.alphabeticalOrder = 9;
            SE_DEVELOPMENT_ONLY( constantInfo.description = "&lt;summary&gt; The script. &lt;/summary&gt;");
            constants.Add(constantInfo);
            constantInfo.id = StringID(SE_TEXT("Audio"));
            constantInfo.value = 7;
            constantInfo.alphabeticalOrder = 1;
            SE_DEVELOPMENT_ONLY( constantInfo.description = "&lt;summary&gt; The audio. &lt;/summary&gt;");
            constants.Add(constantInfo);
            constantInfo.id = StringID(SE_TEXT("Animation"));
            constantInfo.value = 8;
            constantInfo.alphabeticalOrder = 0;
            SE_DEVELOPMENT_ONLY( constantInfo.description = "&lt;summary&gt; The animation. &lt;/summary&gt;");
            constants.Add(constantInfo);
            constantInfo.id = StringID(SE_TEXT("Json"));
            constantInfo.value = 9;
            constantInfo.alphabeticalOrder = 2;
            SE_DEVELOPMENT_ONLY( constantInfo.description = "&lt;summary&gt; The json. &lt;/summary&gt;");
            constants.Add(constantInfo);
            constantInfo.id = StringID(SE_TEXT("Particles"));
            constantInfo.value = 10;
            constantInfo.alphabeticalOrder = 6;
            SE_DEVELOPMENT_ONLY( constantInfo.description = "&lt;summary&gt; The particles. &lt;/summary&gt;");
            constants.Add(constantInfo);
            constantInfo.id = StringID(SE_TEXT("Shader"));
            constantInfo.value = 11;
            constantInfo.alphabeticalOrder = 10;
            SE_DEVELOPMENT_ONLY( constantInfo.description = "&lt;summary&gt; The shader source files. &lt;/summary&gt;");
            constants.Add(constantInfo);
            constantInfo.id = StringID(SE_TEXT("Other"));
            constantInfo.value = 12;
            constantInfo.alphabeticalOrder = 5;
            SE_DEVELOPMENT_ONLY( constantInfo.description = "&lt;summary&gt; The other. &lt;/summary&gt;");
            constants.Add(constantInfo);
        };
    };

    TTypeEnumInfo<::SE::Editor::ContentItemSearchFilter> * TTypeEnumInfo<::SE::Editor::ContentItemSearchFilter>::s_pTypeInfo = nullptr;
}


//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor ContentItem
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::ContentItem> final : public TypeCompositeInfo
    {
       static ::SE::Editor::ContentItem const* s_pDefaultInstance_4545720110613302186;
    ...
    public:
        static void RegisterType()
        {
            ...
            ::SE::Editor::ContentItem::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ContentItem>>(s_pDefaultInstance_4545720110613302186);
            Types::RegisterType(::SE::Editor::ContentItem::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::ContentItem::s_pTypeInfo);
            
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::ContentItem::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::ContentItem"));
            size = sizeof(::SE::Editor::ContentItem);
            alignment = alignof(::SE::Editor::ContentItem);
            name = SE_TEXT("ContentItem");
            fullName = SE_TEXT("SE::Editor::ContentItem");
        ...
        {
            return s_pDefaultInstance_4545720110613302186;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContentItem>::s_pDefaultInstance_4545720110613302186);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContentItem>::s_pDefaultInstance_4545720110613302186, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ContentItem const* TTypeCompositeInfo<::SE::Editor::ContentItem>::s_pDefaultInstance_4545720110613302186 = nullptr;
}
