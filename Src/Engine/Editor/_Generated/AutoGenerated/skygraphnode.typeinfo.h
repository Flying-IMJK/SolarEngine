...
namespace SE
{
    ...
    {
       static ::SE::Editor::SkyGraphNode const* s_pDefaultInstance_3071819291;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_3071819291 = New<::SE::Editor::SkyGraphNode>(nullptr);

            ::SE::Editor::SkyGraphNode::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::SkyGraphNode>>(s_pDefaultInstance_3071819291);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::SkyGraphNode*>(s_pDefaultInstance_3071819291));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_3071819291;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::SkyGraphNode>::s_pDefaultInstance_3071819291);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::SkyGraphNode>::s_pDefaultInstance_3071819291, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::SkyGraphNode const* TTypeCompositeInfo<::SE::Editor::SkyGraphNode>::s_pDefaultInstance_3071819291 = nullptr;
}
