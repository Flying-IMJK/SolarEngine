...
namespace SE
{
    ...
    {
       static ::SE::Editor::ToolStripSeparator const* s_pDefaultInstance_1255289741;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_1255289741 = New<::SE::Editor::ToolStripSeparator>(nullptr);

            ::SE::Editor::ToolStripSeparator::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ToolStripSeparator>>(s_pDefaultInstance_1255289741);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::ToolStripSeparator*>(s_pDefaultInstance_1255289741));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_1255289741;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ToolStripSeparator>::s_pDefaultInstance_1255289741);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ToolStripSeparator>::s_pDefaultInstance_1255289741, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ToolStripSeparator const* TTypeCompositeInfo<::SE::Editor::ToolStripSeparator>::s_pDefaultInstance_1255289741 = nullptr;
}
