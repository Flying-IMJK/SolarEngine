...
namespace SE
{
    ...
    {
       static ::SE::Editor::ActorGraphNode const* s_pDefaultInstance_1378664061;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_1378664061 = New<::SE::Editor::ActorGraphNode>(nullptr);

            ::SE::Editor::ActorGraphNode::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ActorGraphNode>>(s_pDefaultInstance_1378664061);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::ActorGraphNode*>(s_pDefaultInstance_1378664061));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_1378664061;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ActorGraphNode>::s_pDefaultInstance_1378664061);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ActorGraphNode>::s_pDefaultInstance_1378664061, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ActorGraphNode const* TTypeCompositeInfo<::SE::Editor::ActorGraphNode>::s_pDefaultInstance_1378664061 = nullptr;
}
