...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor NewItem
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::NewItem> final : public TypeCompositeInfo
    {
       static ::SE::Editor::NewItem const* s_pDefaultInstance_17419124984194142649;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_17419124984194142649 = New<::SE::Editor::NewItem>(nullptr);

            ::SE::Editor::NewItem::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::NewItem>>(s_pDefaultInstance_17419124984194142649);
            Types::RegisterType(::SE::Editor::NewItem::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::NewItem::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::NewItem*>(s_pDefaultInstance_17419124984194142649));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::NewItem::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::NewItem"));
            size = sizeof(::SE::Editor::NewItem);
            alignment = alignof(::SE::Editor::NewItem);
            name = SE_TEXT("NewItem");
            fullName = SE_TEXT("SE::Editor::NewItem");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::NewItem), alignof(::SE::Editor::NewItem));
            return new (pMemory) ::SE::Editor::NewItem(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::NewItem(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_17419124984194142649;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::NewItem>::s_pDefaultInstance_17419124984194142649);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::NewItem>::s_pDefaultInstance_17419124984194142649, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::NewItem const* TTypeCompositeInfo<::SE::Editor::NewItem>::s_pDefaultInstance_17419124984194142649 = nullptr;
}
