...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor DockWindow
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::DockWindow> final : public TypeCompositeInfo
    {
       static ::SE::Editor::DockWindow const* s_pDefaultInstance_10353068051819493851;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_10353068051819493851 = New<::SE::Editor::DockWindow>(nullptr);

            ::SE::Editor::DockWindow::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::DockWindow>>(s_pDefaultInstance_10353068051819493851);
            Types::RegisterType(::SE::Editor::DockWindow::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::DockWindow::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::DockWindow*>(s_pDefaultInstance_10353068051819493851));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::DockWindow::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::DockWindow"));
            size = sizeof(::SE::Editor::DockWindow);
            alignment = alignof(::SE::Editor::DockWindow);
            name = SE_TEXT("DockWindow");
            fullName = SE_TEXT("SE::Editor::DockWindow");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::DockWindow), alignof(::SE::Editor::DockWindow));
            return new (pMemory) ::SE::Editor::DockWindow(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::DockWindow(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_10353068051819493851;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::DockWindow>::s_pDefaultInstance_10353068051819493851);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::DockWindow>::s_pDefaultInstance_10353068051819493851, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::DockWindow const* TTypeCompositeInfo<::SE::Editor::DockWindow>::s_pDefaultInstance_10353068051819493851 = nullptr;
}
