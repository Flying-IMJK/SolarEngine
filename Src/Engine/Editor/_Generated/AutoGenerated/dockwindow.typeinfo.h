...
namespace SE
{
    ...
    {
       static ::SE::Editor::DockWindow const* s_pDefaultInstance_2009181381;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_2009181381 = New<::SE::Editor::DockWindow>(nullptr);

            ::SE::Editor::DockWindow::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::DockWindow>>(s_pDefaultInstance_2009181381);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::DockWindow*>(s_pDefaultInstance_2009181381));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_2009181381;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::DockWindow>::s_pDefaultInstance_2009181381);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::DockWindow>::s_pDefaultInstance_2009181381, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::DockWindow const* TTypeCompositeInfo<::SE::Editor::DockWindow>::s_pDefaultInstance_2009181381 = nullptr;
}
