...
namespace SE
{
    ...
    {
       static ::SE::Editor::PreviewsCache const* s_pDefaultInstance_565572341;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_565572341 = New<::SE::Editor::PreviewsCache>(nullptr);

            ::SE::Editor::PreviewsCache::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::PreviewsCache>>(s_pDefaultInstance_565572341);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::PreviewsCache*>(s_pDefaultInstance_565572341));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_565572341;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::PreviewsCache>::s_pDefaultInstance_565572341);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::PreviewsCache>::s_pDefaultInstance_565572341, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::PreviewsCache const* TTypeCompositeInfo<::SE::Editor::PreviewsCache>::s_pDefaultInstance_565572341 = nullptr;
}
