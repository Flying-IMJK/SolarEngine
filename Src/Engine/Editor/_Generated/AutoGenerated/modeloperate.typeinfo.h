...
namespace SE
{
    ...
    {
       static ::SE::Editor::ModelOperate const* s_pDefaultInstance_88617229;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_88617229 = New<::SE::Editor::ModelOperate>(nullptr);

            ::SE::Editor::ModelOperate::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ModelOperate>>(s_pDefaultInstance_88617229);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::ModelOperate*>(s_pDefaultInstance_88617229));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_88617229;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ModelOperate>::s_pDefaultInstance_88617229);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ModelOperate>::s_pDefaultInstance_88617229, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ModelOperate const* TTypeCompositeInfo<::SE::Editor::ModelOperate>::s_pDefaultInstance_88617229 = nullptr;
}
