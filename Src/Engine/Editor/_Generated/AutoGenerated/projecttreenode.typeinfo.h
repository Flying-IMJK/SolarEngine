...
namespace SE
{
    ...
    {
       static ::SE::Editor::ProjectTreeNode const* s_pDefaultInstance_1236427289;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_1236427289 = New<::SE::Editor::ProjectTreeNode>(nullptr);

            ::SE::Editor::ProjectTreeNode::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ProjectTreeNode>>(s_pDefaultInstance_1236427289);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::ProjectTreeNode*>(s_pDefaultInstance_1236427289));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_1236427289;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ProjectTreeNode>::s_pDefaultInstance_1236427289);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ProjectTreeNode>::s_pDefaultInstance_1236427289, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ProjectTreeNode const* TTypeCompositeInfo<::SE::Editor::ProjectTreeNode>::s_pDefaultInstance_1236427289 = nullptr;
}
