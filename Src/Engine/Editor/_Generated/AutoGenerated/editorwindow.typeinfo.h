...
namespace SE
{
    ...
    {
       static ::SE::Editor::EditorWindow const* s_pDefaultInstance_3139568363;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_3139568363 = New<::SE::Editor::EditorWindow>(nullptr);

            ::SE::Editor::EditorWindow::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::EditorWindow>>(s_pDefaultInstance_3139568363);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::EditorWindow*>(s_pDefaultInstance_3139568363));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_3139568363;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::EditorWindow>::s_pDefaultInstance_3139568363);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::EditorWindow>::s_pDefaultInstance_3139568363, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::EditorWindow const* TTypeCompositeInfo<::SE::Editor::EditorWindow>::s_pDefaultInstance_3139568363 = nullptr;
}
