...
namespace SE
{
    ...
    {
       static ::SE::Editor::TreeNode const* s_pDefaultInstance_3115908514;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_3115908514 = New<::SE::Editor::TreeNode>(nullptr);

            ::SE::Editor::TreeNode::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::TreeNode>>(s_pDefaultInstance_3115908514);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::TreeNode*>(s_pDefaultInstance_3115908514));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_3115908514;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::TreeNode>::s_pDefaultInstance_3115908514);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::TreeNode>::s_pDefaultInstance_3115908514, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::TreeNode const* TTypeCompositeInfo<::SE::Editor::TreeNode>::s_pDefaultInstance_3115908514 = nullptr;
}
