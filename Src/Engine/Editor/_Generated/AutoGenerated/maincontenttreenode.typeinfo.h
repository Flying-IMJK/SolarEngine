...
namespace SE
{
    ...
    {
       static ::SE::Editor::MainContentTreeNode const* s_pDefaultInstance_2654026306;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_2654026306 = New<::SE::Editor::MainContentTreeNode>(nullptr);

            ::SE::Editor::MainContentTreeNode::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::MainContentTreeNode>>(s_pDefaultInstance_2654026306);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::MainContentTreeNode*>(s_pDefaultInstance_2654026306));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_2654026306;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::MainContentTreeNode>::s_pDefaultInstance_2654026306);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::MainContentTreeNode>::s_pDefaultInstance_2654026306, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::MainContentTreeNode const* TTypeCompositeInfo<::SE::Editor::MainContentTreeNode>::s_pDefaultInstance_2654026306 = nullptr;
}
