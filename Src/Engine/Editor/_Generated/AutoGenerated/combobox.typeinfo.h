...
namespace SE
{
    ...
    {
       static ::SE::Editor::ComboBox const* s_pDefaultInstance_888109701;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_888109701 = New<::SE::Editor::ComboBox>(nullptr);

            ::SE::Editor::ComboBox::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ComboBox>>(s_pDefaultInstance_888109701);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::ComboBox*>(s_pDefaultInstance_888109701));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_888109701;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ComboBox>::s_pDefaultInstance_888109701);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ComboBox>::s_pDefaultInstance_888109701, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ComboBox const* TTypeCompositeInfo<::SE::Editor::ComboBox>::s_pDefaultInstance_888109701 = nullptr;
}
