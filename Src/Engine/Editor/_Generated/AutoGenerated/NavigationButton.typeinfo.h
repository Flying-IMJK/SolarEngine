...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor NavigationButton
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::NavigationButton> final : public TypeCompositeInfo
    {
       static ::SE::Editor::NavigationButton const* s_pDefaultInstance_1157629816842924886;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_1157629816842924886 = New<::SE::Editor::NavigationButton>(nullptr);

            ::SE::Editor::NavigationButton::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::NavigationButton>>(s_pDefaultInstance_1157629816842924886);
            Types::RegisterType(::SE::Editor::NavigationButton::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::NavigationButton::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::NavigationButton*>(s_pDefaultInstance_1157629816842924886));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::NavigationButton::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::NavigationButton"));
            size = sizeof(::SE::Editor::NavigationButton);
            alignment = alignof(::SE::Editor::NavigationButton);
            name = SE_TEXT("NavigationButton");
            fullName = SE_TEXT("SE::Editor::NavigationButton");
            ...
            // Add parent info
            // Parent types
            pParentTypeInfo = ::SE::Button::s_pTypeInfo;
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::NavigationButton), alignof(::SE::Editor::NavigationButton));
            return new (pMemory) ::SE::Editor::NavigationButton(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::NavigationButton(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_1157629816842924886;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::NavigationButton>::s_pDefaultInstance_1157629816842924886);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::NavigationButton>::s_pDefaultInstance_1157629816842924886, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::NavigationButton const* TTypeCompositeInfo<::SE::Editor::NavigationButton>::s_pDefaultInstance_1157629816842924886 = nullptr;
}
