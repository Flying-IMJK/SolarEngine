...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor JsonAssetItem
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::JsonAssetItem> final : public TypeCompositeInfo
    {
       static ::SE::Editor::JsonAssetItem const* s_pDefaultInstance_14825922716439826489;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_14825922716439826489 = New<::SE::Editor::JsonAssetItem>(nullptr);

            ::SE::Editor::JsonAssetItem::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::JsonAssetItem>>(s_pDefaultInstance_14825922716439826489);
            Types::RegisterType(::SE::Editor::JsonAssetItem::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::JsonAssetItem::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::JsonAssetItem*>(s_pDefaultInstance_14825922716439826489));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::JsonAssetItem::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::JsonAssetItem"));
            size = sizeof(::SE::Editor::JsonAssetItem);
            alignment = alignof(::SE::Editor::JsonAssetItem);
            name = SE_TEXT("JsonAssetItem");
            fullName = SE_TEXT("SE::Editor::JsonAssetItem");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::JsonAssetItem), alignof(::SE::Editor::JsonAssetItem));
            return new (pMemory) ::SE::Editor::JsonAssetItem(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::JsonAssetItem(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_14825922716439826489;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::JsonAssetItem>::s_pDefaultInstance_14825922716439826489);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::JsonAssetItem>::s_pDefaultInstance_14825922716439826489, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::JsonAssetItem const* TTypeCompositeInfo<::SE::Editor::JsonAssetItem>::s_pDefaultInstance_14825922716439826489 = nullptr;
}
