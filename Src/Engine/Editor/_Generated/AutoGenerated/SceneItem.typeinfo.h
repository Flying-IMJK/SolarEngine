...
namespace SE
{
    ...
    {
       static ::SE::Editor::SceneItem const* s_pDefaultInstance_14104053573157204243;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_14104053573157204243 = New<::SE::Editor::SceneItem>(nullptr);

            ::SE::Editor::SceneItem::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::SceneItem>>(s_pDefaultInstance_14104053573157204243);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::SceneItem*>(s_pDefaultInstance_14104053573157204243));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_14104053573157204243;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::SceneItem>::s_pDefaultInstance_14104053573157204243);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::SceneItem>::s_pDefaultInstance_14104053573157204243, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::SceneItem const* TTypeCompositeInfo<::SE::Editor::SceneItem>::s_pDefaultInstance_14104053573157204243 = nullptr;
}
