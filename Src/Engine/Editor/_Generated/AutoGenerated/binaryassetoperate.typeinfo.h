...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor:: BinaryAssetOperate
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::BinaryAssetOperate> final : public TypeCompositeInfo
    {
       static ::SE::Editor::BinaryAssetOperate const* s_pDefaultInstance_3877794273;
    ...
    public:
        static void RegisterType()
        {
            ...
            ::SE::Editor::BinaryAssetOperate::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::BinaryAssetOperate>>(s_pDefaultInstance_3877794273);
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::BinaryAssetOperate"));
            size = sizeof(::SE::Editor::BinaryAssetOperate);
            alignment = alignof(::SE::Editor::BinaryAssetOperate);
            name = SE_TEXT("BinaryAssetOperate");
        ...
        {
            return s_pDefaultInstance_3877794273;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::BinaryAssetOperate>::s_pDefaultInstance_3877794273);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::BinaryAssetOperate>::s_pDefaultInstance_3877794273, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::BinaryAssetOperate const* TTypeCompositeInfo<::SE::Editor::BinaryAssetOperate>::s_pDefaultInstance_3877794273 = nullptr;
}
