...
namespace SE
{
    ...
    {
       static ::SE::Editor::Tree const* s_pDefaultInstance_460547228;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_460547228 = New<::SE::Editor::Tree>(nullptr);

            ::SE::Editor::Tree::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::Tree>>(s_pDefaultInstance_460547228);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::Tree*>(s_pDefaultInstance_460547228));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_460547228;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::Tree>::s_pDefaultInstance_460547228);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::Tree>::s_pDefaultInstance_460547228, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::Tree const* TTypeCompositeInfo<::SE::Editor::Tree>::s_pDefaultInstance_460547228 = nullptr;
}
