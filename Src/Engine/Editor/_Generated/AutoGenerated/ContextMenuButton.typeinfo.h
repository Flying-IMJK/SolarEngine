...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor ContextMenuButton
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::ContextMenuButton> final : public TypeCompositeInfo
    {
       static ::SE::Editor::ContextMenuButton const* s_pDefaultInstance_10066501220823535884;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_10066501220823535884 = New<::SE::Editor::ContextMenuButton>(nullptr);

            ::SE::Editor::ContextMenuButton::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ContextMenuButton>>(s_pDefaultInstance_10066501220823535884);
            Types::RegisterType(::SE::Editor::ContextMenuButton::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::ContextMenuButton::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::ContextMenuButton*>(s_pDefaultInstance_10066501220823535884));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::ContextMenuButton::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::ContextMenuButton"));
            size = sizeof(::SE::Editor::ContextMenuButton);
            alignment = alignof(::SE::Editor::ContextMenuButton);
            name = SE_TEXT("ContextMenuButton");
            fullName = SE_TEXT("SE::Editor::ContextMenuButton");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::ContextMenuButton), alignof(::SE::Editor::ContextMenuButton));
            return new (pMemory) ::SE::Editor::ContextMenuButton(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::ContextMenuButton(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_10066501220823535884;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContextMenuButton>::s_pDefaultInstance_10066501220823535884);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContextMenuButton>::s_pDefaultInstance_10066501220823535884, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ContextMenuButton const* TTypeCompositeInfo<::SE::Editor::ContextMenuButton>::s_pDefaultInstance_10066501220823535884 = nullptr;
}
