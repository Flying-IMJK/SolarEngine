...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor ContextMenuSeparator
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::ContextMenuSeparator> final : public TypeCompositeInfo
    {
       static ::SE::Editor::ContextMenuSeparator const* s_pDefaultInstance_18139250214343833567;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_18139250214343833567 = New<::SE::Editor::ContextMenuSeparator>(nullptr);

            ::SE::Editor::ContextMenuSeparator::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ContextMenuSeparator>>(s_pDefaultInstance_18139250214343833567);
            Types::RegisterType(::SE::Editor::ContextMenuSeparator::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::ContextMenuSeparator::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::ContextMenuSeparator*>(s_pDefaultInstance_18139250214343833567));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::ContextMenuSeparator::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::ContextMenuSeparator"));
            size = sizeof(::SE::Editor::ContextMenuSeparator);
            alignment = alignof(::SE::Editor::ContextMenuSeparator);
            name = SE_TEXT("ContextMenuSeparator");
            fullName = SE_TEXT("SE::Editor::ContextMenuSeparator");
            ...
            // Add parent info
            // Parent types
            pParentTypeInfo = ::SE::Editor::ContextMenuItem::s_pTypeInfo;
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::ContextMenuSeparator), alignof(::SE::Editor::ContextMenuSeparator));
            return new (pMemory) ::SE::Editor::ContextMenuSeparator(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::ContextMenuSeparator(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_18139250214343833567;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContextMenuSeparator>::s_pDefaultInstance_18139250214343833567);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContextMenuSeparator>::s_pDefaultInstance_18139250214343833567, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ContextMenuSeparator const* TTypeCompositeInfo<::SE::Editor::ContextMenuSeparator>::s_pDefaultInstance_18139250214343833567 = nullptr;
}
