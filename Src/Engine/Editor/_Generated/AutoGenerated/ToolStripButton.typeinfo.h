...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor ToolStripButton
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::ToolStripButton> final : public TypeCompositeInfo
    {
       static ::SE::Editor::ToolStripButton const* s_pDefaultInstance_71825305883529852;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_71825305883529852 = New<::SE::Editor::ToolStripButton>(nullptr);

            ::SE::Editor::ToolStripButton::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ToolStripButton>>(s_pDefaultInstance_71825305883529852);
            Types::RegisterType(::SE::Editor::ToolStripButton::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::ToolStripButton::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::ToolStripButton*>(s_pDefaultInstance_71825305883529852));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::ToolStripButton::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::ToolStripButton"));
            size = sizeof(::SE::Editor::ToolStripButton);
            alignment = alignof(::SE::Editor::ToolStripButton);
            name = SE_TEXT("ToolStripButton");
            fullName = SE_TEXT("SE::Editor::ToolStripButton");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::ToolStripButton), alignof(::SE::Editor::ToolStripButton));
            return new (pMemory) ::SE::Editor::ToolStripButton(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::ToolStripButton(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_71825305883529852;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ToolStripButton>::s_pDefaultInstance_71825305883529852);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ToolStripButton>::s_pDefaultInstance_71825305883529852, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ToolStripButton const* TTypeCompositeInfo<::SE::Editor::ToolStripButton>::s_pDefaultInstance_71825305883529852 = nullptr;
}
