...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor ModelOperate
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::ModelOperate> final : public TypeCompositeInfo
    {
       static ::SE::Editor::ModelOperate const* s_pDefaultInstance_10035831333843798611;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_10035831333843798611 = New<::SE::Editor::ModelOperate>(nullptr);

            ::SE::Editor::ModelOperate::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ModelOperate>>(s_pDefaultInstance_10035831333843798611);
            Types::RegisterType(::SE::Editor::ModelOperate::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::ModelOperate::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::ModelOperate*>(s_pDefaultInstance_10035831333843798611));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::ModelOperate::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::ModelOperate"));
            size = sizeof(::SE::Editor::ModelOperate);
            alignment = alignof(::SE::Editor::ModelOperate);
            name = SE_TEXT("ModelOperate");
            fullName = SE_TEXT("SE::Editor::ModelOperate");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::ModelOperate), alignof(::SE::Editor::ModelOperate));
            return new (pMemory) ::SE::Editor::ModelOperate(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::ModelOperate(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_10035831333843798611;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ModelOperate>::s_pDefaultInstance_10035831333843798611);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ModelOperate>::s_pDefaultInstance_10035831333843798611, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ModelOperate const* TTypeCompositeInfo<::SE::Editor::ModelOperate>::s_pDefaultInstance_10035831333843798611 = nullptr;
}
