...
namespace SE
{
    ...
    {
       static ::SE::Editor::ContextMenu const* s_pDefaultInstance_2471519782;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_2471519782 = New<::SE::Editor::ContextMenu>(nullptr);

            ::SE::Editor::ContextMenu::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ContextMenu>>(s_pDefaultInstance_2471519782);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::ContextMenu*>(s_pDefaultInstance_2471519782));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_2471519782;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContextMenu>::s_pDefaultInstance_2471519782);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContextMenu>::s_pDefaultInstance_2471519782, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ContextMenu const* TTypeCompositeInfo<::SE::Editor::ContextMenu>::s_pDefaultInstance_2471519782 = nullptr;
}
