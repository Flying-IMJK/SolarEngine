...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor ToolStripSeparator
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::ToolStripSeparator> final : public TypeCompositeInfo
    {
       static ::SE::Editor::ToolStripSeparator const* s_pDefaultInstance_14873730716061839151;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_14873730716061839151 = New<::SE::Editor::ToolStripSeparator>(nullptr);

            ::SE::Editor::ToolStripSeparator::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ToolStripSeparator>>(s_pDefaultInstance_14873730716061839151);
            Types::RegisterType(::SE::Editor::ToolStripSeparator::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::ToolStripSeparator::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::ToolStripSeparator*>(s_pDefaultInstance_14873730716061839151));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::ToolStripSeparator::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::ToolStripSeparator"));
            size = sizeof(::SE::Editor::ToolStripSeparator);
            alignment = alignof(::SE::Editor::ToolStripSeparator);
            name = SE_TEXT("ToolStripSeparator");
            fullName = SE_TEXT("SE::Editor::ToolStripSeparator");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::ToolStripSeparator), alignof(::SE::Editor::ToolStripSeparator));
            return new (pMemory) ::SE::Editor::ToolStripSeparator(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::ToolStripSeparator(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_14873730716061839151;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ToolStripSeparator>::s_pDefaultInstance_14873730716061839151);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ToolStripSeparator>::s_pDefaultInstance_14873730716061839151, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ToolStripSeparator const* TTypeCompositeInfo<::SE::Editor::ToolStripSeparator>::s_pDefaultInstance_14873730716061839151 = nullptr;
}
