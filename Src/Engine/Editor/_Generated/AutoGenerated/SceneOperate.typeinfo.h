...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor SceneOperate
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::SceneOperate> final : public TypeCompositeInfo
    {
       static ::SE::Editor::SceneOperate const* s_pDefaultInstance_17314093738311641992;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_17314093738311641992 = New<::SE::Editor::SceneOperate>(nullptr);

            ::SE::Editor::SceneOperate::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::SceneOperate>>(s_pDefaultInstance_17314093738311641992);
            Types::RegisterType(::SE::Editor::SceneOperate::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::SceneOperate::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::SceneOperate*>(s_pDefaultInstance_17314093738311641992));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::SceneOperate::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::SceneOperate"));
            size = sizeof(::SE::Editor::SceneOperate);
            alignment = alignof(::SE::Editor::SceneOperate);
            name = SE_TEXT("SceneOperate");
            fullName = SE_TEXT("SE::Editor::SceneOperate");
            ...
            // Add parent info
            // Parent types
            pParentTypeInfo = ::SE::Editor::AssetOperate::s_pTypeInfo;
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::SceneOperate), alignof(::SE::Editor::SceneOperate));
            return new (pMemory) ::SE::Editor::SceneOperate(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::SceneOperate(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_17314093738311641992;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::SceneOperate>::s_pDefaultInstance_17314093738311641992);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::SceneOperate>::s_pDefaultInstance_17314093738311641992, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::SceneOperate const* TTypeCompositeInfo<::SE::Editor::SceneOperate>::s_pDefaultInstance_17314093738311641992 = nullptr;
}
