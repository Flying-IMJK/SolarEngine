...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor ContentFolder
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::ContentFolder> final : public TypeCompositeInfo
    {
       static ::SE::Editor::ContentFolder const* s_pDefaultInstance_13543728517363963921;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_13543728517363963921 = New<::SE::Editor::ContentFolder>(nullptr);

            ::SE::Editor::ContentFolder::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ContentFolder>>(s_pDefaultInstance_13543728517363963921);
            Types::RegisterType(::SE::Editor::ContentFolder::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::ContentFolder::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::ContentFolder*>(s_pDefaultInstance_13543728517363963921));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::ContentFolder::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::ContentFolder"));
            size = sizeof(::SE::Editor::ContentFolder);
            alignment = alignof(::SE::Editor::ContentFolder);
            name = SE_TEXT("ContentFolder");
            fullName = SE_TEXT("SE::Editor::ContentFolder");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::ContentFolder), alignof(::SE::Editor::ContentFolder));
            return new (pMemory) ::SE::Editor::ContentFolder(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::ContentFolder(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_13543728517363963921;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContentFolder>::s_pDefaultInstance_13543728517363963921);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContentFolder>::s_pDefaultInstance_13543728517363963921, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ContentFolder const* TTypeCompositeInfo<::SE::Editor::ContentFolder>::s_pDefaultInstance_13543728517363963921 = nullptr;
}
