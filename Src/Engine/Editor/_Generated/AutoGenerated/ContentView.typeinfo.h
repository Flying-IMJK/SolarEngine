...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor ContentView
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::ContentView> final : public TypeCompositeInfo
    {
       static ::SE::Editor::ContentView const* s_pDefaultInstance_321619022516591084;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_321619022516591084 = New<::SE::Editor::ContentView>(nullptr);

            ::SE::Editor::ContentView::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ContentView>>(s_pDefaultInstance_321619022516591084);
            Types::RegisterType(::SE::Editor::ContentView::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::ContentView::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::ContentView*>(s_pDefaultInstance_321619022516591084));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::ContentView::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::ContentView"));
            size = sizeof(::SE::Editor::ContentView);
            alignment = alignof(::SE::Editor::ContentView);
            name = SE_TEXT("ContentView");
            fullName = SE_TEXT("SE::Editor::ContentView");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::ContentView), alignof(::SE::Editor::ContentView));
            return new (pMemory) ::SE::Editor::ContentView(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::ContentView(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_321619022516591084;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContentView>::s_pDefaultInstance_321619022516591084);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContentView>::s_pDefaultInstance_321619022516591084, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ContentView const* TTypeCompositeInfo<::SE::Editor::ContentView>::s_pDefaultInstance_321619022516591084 = nullptr;
}
