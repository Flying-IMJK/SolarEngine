...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor ToolStrip
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::ToolStrip> final : public TypeCompositeInfo
    {
       static ::SE::Editor::ToolStrip const* s_pDefaultInstance_12963529998026358600;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_12963529998026358600 = New<::SE::Editor::ToolStrip>(nullptr);

            ::SE::Editor::ToolStrip::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ToolStrip>>(s_pDefaultInstance_12963529998026358600);
            Types::RegisterType(::SE::Editor::ToolStrip::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::ToolStrip::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::ToolStrip*>(s_pDefaultInstance_12963529998026358600));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::ToolStrip::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::ToolStrip"));
            size = sizeof(::SE::Editor::ToolStrip);
            alignment = alignof(::SE::Editor::ToolStrip);
            name = SE_TEXT("ToolStrip");
            fullName = SE_TEXT("SE::Editor::ToolStrip");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::ToolStrip), alignof(::SE::Editor::ToolStrip));
            return new (pMemory) ::SE::Editor::ToolStrip(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::ToolStrip(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_12963529998026358600;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ToolStrip>::s_pDefaultInstance_12963529998026358600);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ToolStrip>::s_pDefaultInstance_12963529998026358600, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ToolStrip const* TTypeCompositeInfo<::SE::Editor::ToolStrip>::s_pDefaultInstance_12963529998026358600 = nullptr;
}
