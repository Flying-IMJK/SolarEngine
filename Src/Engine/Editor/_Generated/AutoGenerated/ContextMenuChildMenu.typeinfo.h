...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor ContextMenuChildMenu
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::ContextMenuChildMenu> final : public TypeCompositeInfo
    {
       static ::SE::Editor::ContextMenuChildMenu const* s_pDefaultInstance_3568608774750306753;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_3568608774750306753 = New<::SE::Editor::ContextMenuChildMenu>(nullptr);

            ::SE::Editor::ContextMenuChildMenu::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ContextMenuChildMenu>>(s_pDefaultInstance_3568608774750306753);
            Types::RegisterType(::SE::Editor::ContextMenuChildMenu::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::ContextMenuChildMenu::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::ContextMenuChildMenu*>(s_pDefaultInstance_3568608774750306753));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::ContextMenuChildMenu::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::ContextMenuChildMenu"));
            size = sizeof(::SE::Editor::ContextMenuChildMenu);
            alignment = alignof(::SE::Editor::ContextMenuChildMenu);
            name = SE_TEXT("ContextMenuChildMenu");
            fullName = SE_TEXT("SE::Editor::ContextMenuChildMenu");
            ...
            // Add parent info
            // Parent types
            pParentTypeInfo = ::SE::Editor::ContextMenuButton::s_pTypeInfo;
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::ContextMenuChildMenu), alignof(::SE::Editor::ContextMenuChildMenu));
            return new (pMemory) ::SE::Editor::ContextMenuChildMenu(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::ContextMenuChildMenu(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_3568608774750306753;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContextMenuChildMenu>::s_pDefaultInstance_3568608774750306753);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContextMenuChildMenu>::s_pDefaultInstance_3568608774750306753, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ContextMenuChildMenu const* TTypeCompositeInfo<::SE::Editor::ContextMenuChildMenu>::s_pDefaultInstance_3568608774750306753 = nullptr;
}
