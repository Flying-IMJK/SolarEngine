...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor Tree
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::Tree> final : public TypeCompositeInfo
    {
       static ::SE::Editor::Tree const* s_pDefaultInstance_15246531970724267828;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_15246531970724267828 = New<::SE::Editor::Tree>(nullptr);

            ::SE::Editor::Tree::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::Tree>>(s_pDefaultInstance_15246531970724267828);
            Types::RegisterType(::SE::Editor::Tree::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::Tree::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::Tree*>(s_pDefaultInstance_15246531970724267828));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::Tree::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::Tree"));
            size = sizeof(::SE::Editor::Tree);
            alignment = alignof(::SE::Editor::Tree);
            name = SE_TEXT("Tree");
            fullName = SE_TEXT("SE::Editor::Tree");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::Tree), alignof(::SE::Editor::Tree));
            return new (pMemory) ::SE::Editor::Tree(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::Tree(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_15246531970724267828;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::Tree>::s_pDefaultInstance_15246531970724267828);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::Tree>::s_pDefaultInstance_15246531970724267828, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::Tree const* TTypeCompositeInfo<::SE::Editor::Tree>::s_pDefaultInstance_15246531970724267828 = nullptr;
}
