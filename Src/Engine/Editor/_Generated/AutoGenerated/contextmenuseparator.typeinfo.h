...
namespace SE
{
    ...
    {
       static ::SE::Editor::ContextMenuSeparator const* s_pDefaultInstance_2936758487;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_2936758487 = New<::SE::Editor::ContextMenuSeparator>(nullptr);

            ::SE::Editor::ContextMenuSeparator::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ContextMenuSeparator>>(s_pDefaultInstance_2936758487);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::ContextMenuSeparator*>(s_pDefaultInstance_2936758487));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_2936758487;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContextMenuSeparator>::s_pDefaultInstance_2936758487);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContextMenuSeparator>::s_pDefaultInstance_2936758487, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ContextMenuSeparator const* TTypeCompositeInfo<::SE::Editor::ContextMenuSeparator>::s_pDefaultInstance_2936758487 = nullptr;
}
