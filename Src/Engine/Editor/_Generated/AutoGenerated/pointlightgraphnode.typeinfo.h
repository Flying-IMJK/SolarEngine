...
namespace SE
{
    ...
    {
       static ::SE::Editor::PointLightGraphNode const* s_pDefaultInstance_2937133478;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_2937133478 = New<::SE::Editor::PointLightGraphNode>(nullptr);

            ::SE::Editor::PointLightGraphNode::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::PointLightGraphNode>>(s_pDefaultInstance_2937133478);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::PointLightGraphNode*>(s_pDefaultInstance_2937133478));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_2937133478;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::PointLightGraphNode>::s_pDefaultInstance_2937133478);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::PointLightGraphNode>::s_pDefaultInstance_2937133478, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::PointLightGraphNode const* TTypeCompositeInfo<::SE::Editor::PointLightGraphNode>::s_pDefaultInstance_2937133478 = nullptr;
}
