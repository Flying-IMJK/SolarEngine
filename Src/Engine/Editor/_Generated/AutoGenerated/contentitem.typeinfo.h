...
namespace SE
{
    ...
    {
       static ::SE::Editor::ContentItem const* s_pDefaultInstance_2080038134;
    ...
    public:
        static void RegisterType()
        {
            ...
            ::SE::Editor::ContentItem::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ContentItem>>(s_pDefaultInstance_2080038134);
    ...
    public:
        ...
        {
            return s_pDefaultInstance_2080038134;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContentItem>::s_pDefaultInstance_2080038134);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContentItem>::s_pDefaultInstance_2080038134, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ContentItem const* TTypeCompositeInfo<::SE::Editor::ContentItem>::s_pDefaultInstance_2080038134 = nullptr;
}
