...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor MainContentTreeNode
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::MainContentTreeNode> final : public TypeCompositeInfo
    {
       static ::SE::Editor::MainContentTreeNode const* s_pDefaultInstance_4071158637666550630;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_4071158637666550630 = New<::SE::Editor::MainContentTreeNode>(nullptr);

            ::SE::Editor::MainContentTreeNode::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::MainContentTreeNode>>(s_pDefaultInstance_4071158637666550630);
            Types::RegisterType(::SE::Editor::MainContentTreeNode::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::MainContentTreeNode::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::MainContentTreeNode*>(s_pDefaultInstance_4071158637666550630));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::MainContentTreeNode::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::MainContentTreeNode"));
            size = sizeof(::SE::Editor::MainContentTreeNode);
            alignment = alignof(::SE::Editor::MainContentTreeNode);
            name = SE_TEXT("MainContentTreeNode");
            fullName = SE_TEXT("SE::Editor::MainContentTreeNode");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::MainContentTreeNode), alignof(::SE::Editor::MainContentTreeNode));
            return new (pMemory) ::SE::Editor::MainContentTreeNode(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::MainContentTreeNode(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_4071158637666550630;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::MainContentTreeNode>::s_pDefaultInstance_4071158637666550630);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::MainContentTreeNode>::s_pDefaultInstance_4071158637666550630, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::MainContentTreeNode const* TTypeCompositeInfo<::SE::Editor::MainContentTreeNode>::s_pDefaultInstance_4071158637666550630 = nullptr;
}
