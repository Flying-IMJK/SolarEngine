...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor TextureOperate
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::TextureOperate> final : public TypeCompositeInfo
    {
       static ::SE::Editor::TextureOperate const* s_pDefaultInstance_5346751845149094085;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_5346751845149094085 = New<::SE::Editor::TextureOperate>(nullptr);

            ::SE::Editor::TextureOperate::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::TextureOperate>>(s_pDefaultInstance_5346751845149094085);
            Types::RegisterType(::SE::Editor::TextureOperate::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::TextureOperate::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::TextureOperate*>(s_pDefaultInstance_5346751845149094085));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::TextureOperate::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::TextureOperate"));
            size = sizeof(::SE::Editor::TextureOperate);
            alignment = alignof(::SE::Editor::TextureOperate);
            name = SE_TEXT("TextureOperate");
            fullName = SE_TEXT("SE::Editor::TextureOperate");
            ...
            // Add parent info
            // Parent types
            pParentTypeInfo = ::SE::Editor::BinaryAssetOperate::s_pTypeInfo;
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::TextureOperate), alignof(::SE::Editor::TextureOperate));
            return new (pMemory) ::SE::Editor::TextureOperate(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::TextureOperate(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_5346751845149094085;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::TextureOperate>::s_pDefaultInstance_5346751845149094085);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::TextureOperate>::s_pDefaultInstance_5346751845149094085, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::TextureOperate const* TTypeCompositeInfo<::SE::Editor::TextureOperate>::s_pDefaultInstance_5346751845149094085 = nullptr;
}
