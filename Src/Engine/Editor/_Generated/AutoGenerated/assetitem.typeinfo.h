...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor:: AssetItem
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::AssetItem> final : public TypeCompositeInfo
    {
       static ::SE::Editor::AssetItem const* s_pDefaultInstance_1881704315;
    ...
    public:
        static void RegisterType()
        {
            ...
            ::SE::Editor::AssetItem::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::AssetItem>>(s_pDefaultInstance_1881704315);
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::AssetItem"));
            size = sizeof(::SE::Editor::AssetItem);
            alignment = alignof(::SE::Editor::AssetItem);
            name = SE_TEXT("AssetItem");
        ...
        {
            return s_pDefaultInstance_1881704315;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::AssetItem>::s_pDefaultInstance_1881704315);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::AssetItem>::s_pDefaultInstance_1881704315, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::AssetItem const* TTypeCompositeInfo<::SE::Editor::AssetItem>::s_pDefaultInstance_1881704315 = nullptr;
}
