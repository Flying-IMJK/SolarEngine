...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor PreviewsCache
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::PreviewsCache> final : public TypeCompositeInfo
    {
       static ::SE::Editor::PreviewsCache const* s_pDefaultInstance_5770434499788019641;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_5770434499788019641 = New<::SE::Editor::PreviewsCache>(nullptr);

            ::SE::Editor::PreviewsCache::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::PreviewsCache>>(s_pDefaultInstance_5770434499788019641);
            Types::RegisterType(::SE::Editor::PreviewsCache::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::PreviewsCache::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::PreviewsCache*>(s_pDefaultInstance_5770434499788019641));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::PreviewsCache::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::PreviewsCache"));
            size = sizeof(::SE::Editor::PreviewsCache);
            alignment = alignof(::SE::Editor::PreviewsCache);
            name = SE_TEXT("PreviewsCache");
            fullName = SE_TEXT("SE::Editor::PreviewsCache");
            ...
            // Add parent info
            // Parent types
            pParentTypeInfo = ::SE::SpriteAtlas::s_pTypeInfo;
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::PreviewsCache), alignof(::SE::Editor::PreviewsCache));
            return new (pMemory) ::SE::Editor::PreviewsCache(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::PreviewsCache(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_5770434499788019641;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::PreviewsCache>::s_pDefaultInstance_5770434499788019641);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::PreviewsCache>::s_pDefaultInstance_5770434499788019641, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::PreviewsCache const* TTypeCompositeInfo<::SE::Editor::PreviewsCache>::s_pDefaultInstance_5770434499788019641 = nullptr;
}
...
ScriptingTypeInitializer Editor::PreviewsCache::TypeInitializer(
    (BinaryModule*)GetBinaryModuleSEEditor(),
    StringAnsiView("SE.Editor.PreviewsCache", ARRAY_SIZE("SE.Editor.PreviewsCache") - 1),
    sizeof(::SE::Editor::PreviewsCache),
    &PreviewsCacheInternal::InitRuntime,
    &ScriptingType::DefaultSpawn, 
    &::SE::SpriteAtlas::TypeInitializer,
    nullptr,
    nullptr
);
}
