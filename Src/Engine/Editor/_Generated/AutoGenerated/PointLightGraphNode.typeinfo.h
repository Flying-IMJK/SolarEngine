...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor PointLightGraphNode
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::PointLightGraphNode> final : public TypeCompositeInfo
    {
       static ::SE::Editor::PointLightGraphNode const* s_pDefaultInstance_6692009711276510002;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_6692009711276510002 = New<::SE::Editor::PointLightGraphNode>(nullptr);

            ::SE::Editor::PointLightGraphNode::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::PointLightGraphNode>>(s_pDefaultInstance_6692009711276510002);
            Types::RegisterType(::SE::Editor::PointLightGraphNode::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::PointLightGraphNode::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::PointLightGraphNode*>(s_pDefaultInstance_6692009711276510002));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::PointLightGraphNode::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::PointLightGraphNode"));
            size = sizeof(::SE::Editor::PointLightGraphNode);
            alignment = alignof(::SE::Editor::PointLightGraphNode);
            name = SE_TEXT("PointLightGraphNode");
            fullName = SE_TEXT("SE::Editor::PointLightGraphNode");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::PointLightGraphNode), alignof(::SE::Editor::PointLightGraphNode));
            return new (pMemory) ::SE::Editor::PointLightGraphNode(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::PointLightGraphNode(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_6692009711276510002;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::PointLightGraphNode>::s_pDefaultInstance_6692009711276510002);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::PointLightGraphNode>::s_pDefaultInstance_6692009711276510002, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::PointLightGraphNode const* TTypeCompositeInfo<::SE::Editor::PointLightGraphNode>::s_pDefaultInstance_6692009711276510002 = nullptr;
}
