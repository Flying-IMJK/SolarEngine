...
namespace SE
{
    ...
    {
       static ::SE::Editor::ContentOperate const* s_pDefaultInstance_4017190167;
    ...
    public:
        static void RegisterType()
        {
            ...
            ::SE::Editor::ContentOperate::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ContentOperate>>(s_pDefaultInstance_4017190167);
    ...
    public:
        ...
        {
            return s_pDefaultInstance_4017190167;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContentOperate>::s_pDefaultInstance_4017190167);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContentOperate>::s_pDefaultInstance_4017190167, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ContentOperate const* TTypeCompositeInfo<::SE::Editor::ContentOperate>::s_pDefaultInstance_4017190167 = nullptr;
}
