...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor ContextMenuItem
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::ContextMenuItem> final : public TypeCompositeInfo
    {
       static ::SE::Editor::ContextMenuItem const* s_pDefaultInstance_6430245311466719367;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_6430245311466719367 = New<::SE::Editor::ContextMenuItem>(nullptr);

            ::SE::Editor::ContextMenuItem::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ContextMenuItem>>(s_pDefaultInstance_6430245311466719367);
            Types::RegisterType(::SE::Editor::ContextMenuItem::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::ContextMenuItem::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::ContextMenuItem*>(s_pDefaultInstance_6430245311466719367));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::ContextMenuItem::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::ContextMenuItem"));
            size = sizeof(::SE::Editor::ContextMenuItem);
            alignment = alignof(::SE::Editor::ContextMenuItem);
            name = SE_TEXT("ContextMenuItem");
            fullName = SE_TEXT("SE::Editor::ContextMenuItem");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::ContextMenuItem), alignof(::SE::Editor::ContextMenuItem));
            return new (pMemory) ::SE::Editor::ContextMenuItem(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::ContextMenuItem(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_6430245311466719367;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContextMenuItem>::s_pDefaultInstance_6430245311466719367);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ContextMenuItem>::s_pDefaultInstance_6430245311466719367, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ContextMenuItem const* TTypeCompositeInfo<::SE::Editor::ContextMenuItem>::s_pDefaultInstance_6430245311466719367 = nullptr;
}
