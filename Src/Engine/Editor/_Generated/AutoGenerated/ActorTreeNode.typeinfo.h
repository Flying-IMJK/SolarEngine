...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor ActorTreeNode
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::ActorTreeNode> final : public TypeCompositeInfo
    {
       static ::SE::Editor::ActorTreeNode const* s_pDefaultInstance_6635391737557849557;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_6635391737557849557 = New<::SE::Editor::ActorTreeNode>(nullptr);

            ::SE::Editor::ActorTreeNode::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::ActorTreeNode>>(s_pDefaultInstance_6635391737557849557);
            Types::RegisterType(::SE::Editor::ActorTreeNode::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::ActorTreeNode::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::ActorTreeNode*>(s_pDefaultInstance_6635391737557849557));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::ActorTreeNode::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::ActorTreeNode"));
            size = sizeof(::SE::Editor::ActorTreeNode);
            alignment = alignof(::SE::Editor::ActorTreeNode);
            name = SE_TEXT("ActorTreeNode");
            fullName = SE_TEXT("SE::Editor::ActorTreeNode");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::ActorTreeNode), alignof(::SE::Editor::ActorTreeNode));
            return new (pMemory) ::SE::Editor::ActorTreeNode(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::ActorTreeNode(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_6635391737557849557;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ActorTreeNode>::s_pDefaultInstance_6635391737557849557);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::ActorTreeNode>::s_pDefaultInstance_6635391737557849557, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::ActorTreeNode const* TTypeCompositeInfo<::SE::Editor::ActorTreeNode>::s_pDefaultInstance_6635391737557849557 = nullptr;
}
