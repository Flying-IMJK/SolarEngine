...
namespace SE
{
    ...
    {
       static ::SE::Editor::DirectionalLightGraphNode const* s_pDefaultInstance_2720332906;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_2720332906 = New<::SE::Editor::DirectionalLightGraphNode>(nullptr);

            ::SE::Editor::DirectionalLightGraphNode::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::DirectionalLightGraphNode>>(s_pDefaultInstance_2720332906);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::DirectionalLightGraphNode*>(s_pDefaultInstance_2720332906));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_2720332906;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::DirectionalLightGraphNode>::s_pDefaultInstance_2720332906);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::DirectionalLightGraphNode>::s_pDefaultInstance_2720332906, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::DirectionalLightGraphNode const* TTypeCompositeInfo<::SE::Editor::DirectionalLightGraphNode>::s_pDefaultInstance_2720332906 = nullptr;
}
