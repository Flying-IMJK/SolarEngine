...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE::Editor DirectionalLightGraphNode
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::Editor::DirectionalLightGraphNode> final : public TypeCompositeInfo
    {
       static ::SE::Editor::DirectionalLightGraphNode const* s_pDefaultInstance_14271121727460265684;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_14271121727460265684 = New<::SE::Editor::DirectionalLightGraphNode>(nullptr);

            ::SE::Editor::DirectionalLightGraphNode::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::DirectionalLightGraphNode>>(s_pDefaultInstance_14271121727460265684);
            Types::RegisterType(::SE::Editor::DirectionalLightGraphNode::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Editor::DirectionalLightGraphNode::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Editor::DirectionalLightGraphNode*>(s_pDefaultInstance_14271121727460265684));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Editor::DirectionalLightGraphNode::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Editor::DirectionalLightGraphNode"));
            size = sizeof(::SE::Editor::DirectionalLightGraphNode);
            alignment = alignof(::SE::Editor::DirectionalLightGraphNode);
            name = SE_TEXT("DirectionalLightGraphNode");
            fullName = SE_TEXT("SE::Editor::DirectionalLightGraphNode");
            ...
            // Add parent info
            // Parent types
            pParentTypeInfo = ::SE::Editor::ActorGraphNode::s_pTypeInfo;
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Editor::DirectionalLightGraphNode), alignof(::SE::Editor::DirectionalLightGraphNode));
            return new (pMemory) ::SE::Editor::DirectionalLightGraphNode(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Editor::DirectionalLightGraphNode(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_14271121727460265684;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::DirectionalLightGraphNode>::s_pDefaultInstance_14271121727460265684);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::DirectionalLightGraphNode>::s_pDefaultInstance_14271121727460265684, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::DirectionalLightGraphNode const* TTypeCompositeInfo<::SE::Editor::DirectionalLightGraphNode>::s_pDefaultInstance_14271121727460265684 = nullptr;
}
