...
namespace SE
{
    ...
    {
       static ::SE::Editor::LayoutElement const* s_pDefaultInstance_703558868;
    ...
    public:
        static void RegisterType()
        {
            ...
            ::SE::Editor::LayoutElement::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::LayoutElement>>(s_pDefaultInstance_703558868);
    ...
    public:
        ...
        {
            return s_pDefaultInstance_703558868;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::LayoutElement>::s_pDefaultInstance_703558868);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::LayoutElement>::s_pDefaultInstance_703558868, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::LayoutElement const* TTypeCompositeInfo<::SE::Editor::LayoutElement>::s_pDefaultInstance_703558868 = nullptr;
}
