...
namespace SE
{
    ...
    {
       static ::SE::Editor::NavigationBar const* s_pDefaultInstance_15027398281353508271;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_15027398281353508271 = New<::SE::Editor::NavigationBar>(nullptr);

            ::SE::Editor::NavigationBar::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Editor::NavigationBar>>(s_pDefaultInstance_15027398281353508271);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Editor::NavigationBar*>(s_pDefaultInstance_15027398281353508271));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_15027398281353508271;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::NavigationBar>::s_pDefaultInstance_15027398281353508271);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Editor::NavigationBar>::s_pDefaultInstance_15027398281353508271, propertyID, arrayIdx);
        }
    };

    ::SE::Editor::NavigationBar const* TTypeCompositeInfo<::SE::Editor::NavigationBar>::s_pDefaultInstance_15027398281353508271 = nullptr;
}
