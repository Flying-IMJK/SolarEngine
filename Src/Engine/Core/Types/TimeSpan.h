...
namespace SE
{
	...
	public:
		...
		inline TimeSpan operator-() const
		{
		...
		inline TimeSpan operator*(float scalar) const
		{
			return TimeSpan((int64)((float)Ticks * scalar));
		}

		inline TimeSpan& operator*=(float scalar)
		{
	...
	public:
		...
		/// </summary>
		inline TimeSpan GetDuration() const
		{
