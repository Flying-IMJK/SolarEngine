...
namespace SE
{
	...
	/// </summary>
	class SE_API_CORE StringView : public StringViewBase<Char>
	{
	public:
		/// <summary>
	...
	/// </summary>
	class SE_API_CORE StringAnsiView : public StringViewBase<char>
	{
	public:
		/// <summary>
		/// Instance of the empty string.
	...
	bool SE_API_CORE operator==(const String& a, const StringView& b);
	...
	bool SE_API_CORE operator==(const StringAnsi& a, const StringAnsiView& b);
...
{
	template<>
	struct SE_API_CORE formatter<SE::StringView, SE::Char>
	{
	...
	template<>
	struct SE_API_CORE formatter<SE::StringView, char>
	{
		template<typename ParseContext>
		auto parse(ParseContext& ctx)
		{
