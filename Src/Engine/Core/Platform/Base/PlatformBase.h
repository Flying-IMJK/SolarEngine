...
namespace SE
{
	...
	extern SE_API_CORE const Char* ToString(ScreenOrientationType value);
	...
	extern SE_API_CORE const Char* ToString(ThreadPriority value);

	/// <summary>
	/// Runtime platform service.
	/// </summary>
	class SE_API_CORE PlatformBase
	{
	public:
		/// <summary>
	...
	public:
		...
		static int64 AtomicExchange(int64 volatile* dst, int64 exchange) = delete;
		...
		/// <returns>The original value of the dst parameter.</returns>
		static int32 AtomicCompareExchange(int32 volatile* dst, int32 exchange, int32 comperand) = delete;
		...
		/// <param name="comperand">The value to compare to destination.</param>
		/// <returns>The original value of the dst parameter.</returns>
		static int64 AtomicCompareExchange(int64 volatile* dst, int64 exchange, int64 comperand) = delete;
		...
		static int64 AtomicIncrement(int64 volatile* dst) = delete;
		...
		static int64 AtomicDecrement(int64 volatile* dst) = delete;
		...
		static int64 AtomicAdd(int64 volatile* dst, int64 value) = delete;
	...
	public:
		...
		static void CreateUUID(UID& result);
	public:
		/// <summary>
	...
	public:
		...
		/// The list of users.
		/// </summary>
		static List<::SE::User*, FixedAllocation<8>> Users;

		/// <summary>
		/// Event called when user gets added (eg. logged in).
		/// </summary>
		static Delegate<User*> UserAdded;

		/// <summary>
		/// Event called when user gets removed (eg. logged out).
		/// </summary>
		static Delegate<User*> UserRemoved;
	...
	public:
		...
		static List<StackFrame, HeapAllocation> GetStackFrames(int32 skipCount = 0, int32 maxDepth = 60, void* context = nullptr);
	...
	extern SE_API_CORE const Char* ToString(PlatformType type);
	extern SE_API_CORE const Char* ToString(ArchitectureType type);
}
