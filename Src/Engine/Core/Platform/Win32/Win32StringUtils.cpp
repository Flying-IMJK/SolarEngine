...
namespace SE
{
	...
	int32 StringUtils::Compare(const Char* str1, int32 strLength1, const Char* str2, int32 strLength2)
	{
		const int32 nMin = std::min(strLength1, strLength2);
		const int cmp = Compare(str1, str2, nMin);
	...
	int32 StringUtils::CompareIgnoreCase(const Char* str1, int32 strLength1, const Char* str2, int32 strLength2)
	{
		const int32 nMin = std::min(strLength1, strLength2);
		const int cmp = CompareIgnoreCase(str1, str2, nMin);
