...
namespace SE
{
	...
	namespace Serialization
	{
		...
		SE_API_CORE bool ShouldSerialize(const UID& v, const void* otherObj);
		SE_API_CORE void Serialize(SerializeContext& context, const UID& v);
		SE_API_CORE void Deserialize(DeserializeContext& context, UID& v);

		SE_API_CORE bool ShouldSerialize(const DateTime& v, const void* otherObj);
		SE_API_CORE void Serialize(SerializeContext& context, const DateTime& v);
		SE_API_CORE void Deserialize(DeserializeContext& context, DateTime& v);

		SE_API_CORE bool ShouldSerialize(const TimeSpan& v, const void* otherObj);
		SE_API_CORE void Serialize(SerializeContext& context, const TimeSpan& v);
		SE_API_CORE void Deserialize(DeserializeContext& context, TimeSpan& v);
		...
		SE_API_CORE bool ShouldSerialize(const Float2& v, const void* otherObj);
		FORCE_INLINE void Serialize(SerializeContext& context, const Float2& v)
		{
			context.stream.Float2(v);
		}
		SE_API_CORE void Deserialize(DeserializeContext& context, Float2& v);

		SE_API_CORE bool ShouldSerialize(const Float3& v, const void* otherObj);
		FORCE_INLINE void Serialize(SerializeContext& context, const Float3& v)
		{
			context.stream.Float3(v);
		}
		SE_API_CORE void Deserialize(DeserializeContext& context, Float3& v);

		SE_API_CORE bool ShouldSerialize(const Float4& v, const void* otherObj);
		FORCE_INLINE void Serialize(SerializeContext& context, const Float4& v)
		{
			context.stream.Float4(v);
		}
		SE_API_CORE void Deserialize(DeserializeContext& context, Float4& v);



		SE_API_CORE bool ShouldSerialize(const Int2& v, const void* otherObj);
		FORCE_INLINE void Serialize(SerializeContext& context, const Int2& v)
		{
			context.stream.Int2(v);
		}
		SE_API_CORE void Deserialize(DeserializeContext& context, Int2& v);


		SE_API_CORE bool ShouldSerialize(const Int4& v, const void* otherObj);
		FORCE_INLINE void Serialize(SerializeContext& context, const Int4& v)
		{
			context.stream.Int4(v);
		}
		SE_API_CORE void Deserialize(DeserializeContext& context, Int4& v);

		SE_API_CORE bool ShouldSerialize(const Quaternion& v, const void* otherObj);
		FORCE_INLINE void Serialize(SerializeContext& context, const Quaternion& v)
		{
			context.stream.Quaternion(v);
		}
		SE_API_CORE void Deserialize(DeserializeContext& context, Quaternion& v);

		SE_API_CORE bool ShouldSerialize(const Color& v, const void* otherObj);
		FORCE_INLINE void Serialize(SerializeContext& context, const Color& v)
		{
			context.stream.Color(v);
		}
		SE_API_CORE void Deserialize(DeserializeContext& context, Color& v);

		SE_API_CORE bool ShouldSerialize(const Color32& v, const void* otherObj);
		SE_API_CORE void Serialize(SerializeContext& context, const Color32& v);
		SE_API_CORE void Deserialize(DeserializeContext& context, Color32& v);

		SE_API_CORE bool ShouldSerialize(const BoundingBox& v, const void* otherObj);
		FORCE_INLINE void Serialize(SerializeContext& context, const BoundingBox& v)
		{
			context.stream.BoundingBox(v);
		}
		SE_API_CORE void Deserialize(DeserializeContext& context, BoundingBox& v);

		SE_API_CORE bool ShouldSerialize(const BoundingSphere& v, const void* otherObj);
		FORCE_INLINE void Serialize(SerializeContext& context, const BoundingSphere& v)
		{
			context.stream.BoundingSphere(v);
		}
		SE_API_CORE void Deserialize(DeserializeContext& context, BoundingSphere& v);

		SE_API_CORE bool ShouldSerialize(const Ray& v, const void* otherObj);
		FORCE_INLINE void Serialize(SerializeContext& context, const Ray& v)
		{
			context.stream.Ray(v);
		}
		SE_API_CORE void Deserialize(DeserializeContext& context, Ray& v);

		SE_API_CORE bool ShouldSerialize(const Rectangle& v, const void* otherObj);
		FORCE_INLINE void Serialize(SerializeContext& context, const Rectangle& v)
		{
			context.stream.Rectangle(v);
		}
		SE_API_CORE void Deserialize(DeserializeContext& context, Rectangle& v);

		SE_API_CORE bool ShouldSerialize(const Transform& v, const void* otherObj);
		...
		SE_API_CORE void Deserialize(DeserializeContext& context, Transform& v);

		SE_API_CORE bool ShouldSerialize(const Matrix& v, const void* otherObj);
		FORCE_INLINE void Serialize(SerializeContext& context, const Matrix& v)
		{
			context.stream.Matrix(v);
		}
		SE_API_CORE void Deserialize(DeserializeContext& context, Matrix& v);
