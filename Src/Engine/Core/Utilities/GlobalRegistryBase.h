...
namespace SE
{
    ...
    public:
        ...
        ~GlobalRegistryBase()
        {
            ...
            else // Find our previous sibling
            {
                ...
                ENGINE_ASSERT( pPrevious != nullptr );
        ...
        GlobalRegistryBase( GlobalRegistryBase const& ) = default;
        GlobalRegistryBase& operator=( GlobalRegistryBase const& rhs ) = default;
    ...
    #define ENGINE_DECLARE_GLOBAL_REGISTRY(T) friend GlobalRegistryBase<T>; static T* s_pHead; static T* s_pTail;
    #define ENGINE_GLOBAL_REGISTRY(T) T* T::s_pHead = nullptr; T* T::s_pTail = nullptr;
}