...
namespace SE
{
	...
	public:
		...
		static SE_API_CORE const Vector4Base<T> Zero;

		// Vector with all components equal 1
		static SE_API_CORE const Vector4Base<T> One;

		// Vector with all components equal 0.5
		static SE_API_CORE const Vector4Base<T> Half;

		// Vector X=1, Y=0, Z=0, W=0
		static SE_API_CORE const Vector4Base<T> UnitX;

		// Vector X=0, Y=1, Z=0, W=0
		static SE_API_CORE const Vector4Base<T> UnitY;

		// Vector X=0, Y=0, Z=1, W=0
		static SE_API_CORE const Vector4Base<T> UnitZ;

		// Vector X=0, Y=0, Z=0, W=1
		static SE_API_CORE const Vector4Base<T> UnitW;

		// Vector with all components equal maximum value.
		static SE_API_CORE const Vector4Base<T> Minimum;

		// Vector with all components equal minimum value.
		static SE_API_CORE const Vector4Base<T> Maximum;
	...
	public:
		...
		SE_API_CORE explicit Vector4Base(const Float2& xy, T z = 0, T w = 0);
		SE_API_CORE explicit Vector4Base(const Float2& xy, const Float2& zw);
		SE_API_CORE explicit Vector4Base(const Float3& xyz, T w = 0);
		SE_API_CORE explicit Vector4Base(const Int2& xy, T z = 0, T w = 0);
		SE_API_CORE explicit Vector4Base(const Int3& xyz, T w = 0);
		SE_API_CORE explicit Vector4Base(const Double2& xy, T z = 0, T w = 0);
		SE_API_CORE explicit Vector4Base(const Double2& xy, const Double2& zw);
		SE_API_CORE explicit Vector4Base(const Double3& xyz, T w = 0);
		SE_API_CORE explicit Vector4Base(const Color& color);
		SE_API_CORE explicit Vector4Base(const Rectangle& rect);
	...
	public:
		...
		SE_API_CORE static Vector4Base Transform(const Vector4Base& v, const Matrix& m);
	};
...
template<> SE_API_CORE const SE::Float4 SE::Float4::Zero;
template<> SE_API_CORE const SE::Float4 SE::Float4::One;
template<> SE_API_CORE const SE::Float4 SE::Float4::UnitX;
template<> SE_API_CORE const SE::Float4 SE::Float4::UnitY;
template<> SE_API_CORE const SE::Float4 SE::Float4::UnitZ;
template<> SE_API_CORE const SE::Float4 SE::Float4::UnitW;
template<> SE_API_CORE const SE::Float4 SE::Float4::Minimum;
template<> SE_API_CORE const SE::Float4 SE::Float4::Maximum;

template<> SE_API_CORE const SE::Double4 SE::Double4::Zero;
template<> SE_API_CORE const SE::Double4 SE::Double4::One;
template<> SE_API_CORE const SE::Double4 SE::Double4::UnitX;
template<> SE_API_CORE const SE::Double4 SE::Double4::UnitY;
template<> SE_API_CORE const SE::Double4 SE::Double4::UnitZ;
template<> SE_API_CORE const SE::Double4 SE::Double4::UnitW;
template<> SE_API_CORE const SE::Double4 SE::Double4::Minimum;
template<> SE_API_CORE const SE::Double4 SE::Double4::Maximum;

template<> SE_API_CORE const SE::Int4 SE::Int4::Zero;
template<> SE_API_CORE const SE::Int4 SE::Int4::One;
template<> SE_API_CORE const SE::Int4 SE::Int4::UnitX;
template<> SE_API_CORE const SE::Int4 SE::Int4::UnitY;
template<> SE_API_CORE const SE::Int4 SE::Int4::UnitZ;
template<> SE_API_CORE const SE::Int4 SE::Int4::UnitW;
template<> SE_API_CORE const SE::Int4 SE::Int4::Minimum;
template<> SE_API_CORE const SE::Int4 SE::Int4::Maximum;
#endif
