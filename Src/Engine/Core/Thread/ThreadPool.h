...
namespace SE::Threading
{
	...
	/// </summary>
	class SE_API_CORE ThreadPool
	{
		friend class ThreadPoolTask;
		friend SE_API_CORE bool Init();
	private:
	...
	/// </summary>
	class SE_API_CORE ThreadPoolTask : public Task
	{
		friend ThreadPool;
	...
	/// </summary>
	class SE_API_CORE ThreadPoolActionTask : public ThreadPoolTask
	{
	protected:
