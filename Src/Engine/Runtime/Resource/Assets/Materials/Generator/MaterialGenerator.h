...
namespace SE
{
    ...
    private:
        ...
        List<MaterialLayer*> _layers;
        List<MaterialGraphBox*, FixedAllocation<16>> _vsToPsInterpolants;
    ...
    public:
        ...
        MaterialLayer* GetLayer(const UID& id, Node* caller);
    ...
    private:
        ...
        SerializedMaterialParam* findParam(const UID& id, MaterialLayer* layer);
        MaterialGraphParameter* findGraphParam(const UID& id);
        ...
        void WriteCustomGlobalCode(const List<const MaterialGraph::Node*, InlinedAllocation<8>>& nodes, int32 templateInputsMapping);
