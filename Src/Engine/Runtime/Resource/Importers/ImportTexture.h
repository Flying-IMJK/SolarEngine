...
namespace SE
{
	...
	{
	public:
		typedef TextureUtils::Options Options;
	...
	public:
		...
		/// <summary>
		/// Creates the Texture. Argument must be TextureInitData*.
		/// </summary>
		/// <param name="context">The importing context.</param>
		/// <returns>Result.</returns>
		...
		/// <returns>Result.</returns>
		static CreateAssetResult Create(CreateAssetContext& context, TextureInitData* initData);
	...
	private:
		...
		static CreateAssetResult Create(CreateAssetContext& context, const TextureInitData& textureData, Options& options);
	};
}
