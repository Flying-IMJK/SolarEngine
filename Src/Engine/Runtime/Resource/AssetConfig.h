...
#define ASSETS_LOADING_EXTRA_VERIFICATION (BUILD_DEBUG || SE_EDITOR)
...
#define ENABLE_ASSETS_DISCOVERY (SE_EDITOR)

// Default extension for all asset files
#define ASSET_FILES_EXTENSION SE_TEXT("sge")
#define ASSET_FILES_EXTENSION_WITH_DOT SE_TEXT(".sge")

// Default extension for all package files
#define PACKAGE_FILES_EXTENSION SE_TEXT("flaxpac")
#define PACKAGE_FILES_EXTENSION_WITH_DOT SE_TEXT(".flaxpac")
