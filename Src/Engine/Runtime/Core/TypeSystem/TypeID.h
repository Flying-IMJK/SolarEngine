...
namespace SE
{
	class SE_API_RUNTIME TypeID : public StringID
	{
	public:
...
{
    template <>
    struct SE_API_RUNTIME hash<SE::TypeID>
    {
...
{
	template<>
	struct SE_API_RUNTIME formatter<::SE::TypeID, ::SE::Char>
	{
