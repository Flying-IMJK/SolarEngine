...
namespace SE
{
	...
	// Parameters: Reflect, API, NoSpawn, NoConstructor, Abstract, Sealed, Static,
	// Deprecated, Template, Name="...", Attributes="...", Tag="NativeInvokeUseName".
	...
	// Parameters: Reflect, API, ReadOnly, Hidden, Deprecated, Attributes="...",
	// Category="...", ToolsReadOnly, ShowInRestrictedMode, Meta="..." or Metadata="...".
	// Bare metadata expressions are also accepted, e.g. SE_PROPERTY(Reflect, Range(0, 1)).
	// ReadOnly, Hidden, Deprecated and Attributes apply to generated C# bindings.
	// Category, ToolsReadOnly, ShowInRestrictedMode and Meta apply to C++ reflection.
	#define SE_PROPERTY(...)

	// Method annotation. Parameters: API, NoProxy, Hidden, Deprecated, Attributes="...".
