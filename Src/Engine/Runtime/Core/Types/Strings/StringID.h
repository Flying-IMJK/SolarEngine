...
namespace SE
{
	...
	SE_API_RUNTIME __declspec(noinline) const Char* GetStringIDToString(StringID id);
...
{
	template<>
	struct SE_API_RUNTIME formatter<::SE::StringID, SE::Char>
	{
