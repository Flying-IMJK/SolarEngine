...
namespace SE
{
	...
	String DateTime::ToString() const
	{
		...
		return String::Format(SE_TEXT("{0}.{1:0>2}.{2:0>2} {3:0>2}::{4:0>2}:{5:0>2}"), year, month, day, timeSpan.GetHours(), timeSpan.GetMinutes(), timeSpan.GetSeconds());
	}
	...
	String DateTime::ToFileNameString() const
	{
		int32 year, month, day;
		GetDate(year, month, day);
		return String::Format(SE_TEXT("{0}_{1:0>2}_{2:0>2} {3:0>2}_{4:0>2}_{5:0>2}"), year, month, day, GetHour(), GetMinute(), GetSecond());
	}
