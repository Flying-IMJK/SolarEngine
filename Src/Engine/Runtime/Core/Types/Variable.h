...
/// </summary>
	...
	SE_TYPEDEF() typedef Vector2Base<float> Float2;
	SE_TYPEDEF() typedef Vector2Base<double> Double2;
	SE_TYPEDEF() typedef Vector2Base<int32> Int2;

	// Vector3
	template<typename T> struct Vector3Base;
	SE_TYPEDEF() typedef Vector3Base<float> Float3;
	SE_TYPEDEF() typedef Vector3Base<double> Double3;
	SE_TYPEDEF() typedef Vector3Base<int32> Int3;

	// Vector4
	template<typename T> struct Vector4Base;
	SE_TYPEDEF() typedef Vector4Base<float> Float4;
	SE_TYPEDEF() typedef Vector4Base<double> Double4;
	SE_TYPEDEF() typedef Vector4Base<int32> Int4;
