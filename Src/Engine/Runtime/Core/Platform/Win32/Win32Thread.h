...
#include "Runtime/Core/Platform/Base/ThreadBase.h"
...
namespace SE
{
	...
	/// </summary>
	class SE_API_RUNTIME Win32Thread : public ThreadBase
	{
	private:
		void* _thread;
	...
	public:
		...
		Win32Thread(Threading::IRunnable* runnable, const String& name, ThreadPriority priority);
	...
	public:
		...
		static Win32Thread* Create(Threading::IRunnable* runnable, const String& name, ThreadPriority priority = ThreadPriority::Normal, uint32 stackSize = 0);
