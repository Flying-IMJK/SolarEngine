...
namespace SE
{
	...
	extern SE_API_RUNTIME const Char* ToString(ScreenOrientationType value);
	...
	SE_INJECT_CODE(cpp, "#include \"Runtime/Core/Platform/Platform.h\"");
	...
	extern SE_API_RUNTIME const Char* ToString(PlatformType type);
	extern SE_API_RUNTIME const Char* ToString(ArchitectureType type);
}
