...
#include "Runtime/Core/Platform/Win32/Win32Platform.h"
...
namespace SE
{
	...
	/// </summary>
	class SE_API_RUNTIME WindowsPlatform : public Win32Platform
	{
	public:
		...
		static long __stdcall SehExceptionHandler(_EXCEPTION_POINTERS* ep);
	...
	public:
		...
		static void PreInit(void* hInstance, int icon);
