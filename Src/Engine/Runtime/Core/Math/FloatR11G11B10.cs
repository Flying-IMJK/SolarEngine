...
namespace SE
{
    ...
    public struct FloatR11G11B10
    {
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref = "T:SE.Float3" /> to <see cref = "T:SE.FloatR11G11B10" />.
        /// </summary>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref = "T:SE.FloatR11G11B10" /> to <see cref = "T:SE.Float3" />.
        /// </summary>
        /// <param name="value">The value to be converted.</param>
        /// <returns>The converted value.</returns>
