...
namespace SE
{
    ...
    /// </summary>
    class SE_API_RUNTIME CollisionsHelper
    {
    public:
        /// <summary>
        ...
        /// <param name="p1">The line second point.</param>
        /// <param name="result">When the method completes, contains the closest point between the two objects.</param>
        static void ClosestPointPointLine(const Float3& point, const Float3& p0, const Float3& p1, Float3& result);
        ...
        /// <param name="p1">The line second point.</param>
        /// <returns>The closest point between the two objects.</result>
        static Float3 ClosestPointPointLine(const Float3& point, const Float3& p0, const Float3& p1);
        ...
        /// <param name="result">When the method completes, contains the closest point between the two objects.</param>
        static void ClosestPointPointTriangle(const Float3& point, const Float3& vertex1, const Float3& vertex2, const Float3& vertex3, Float3& result);
        ...
        static Float3 ClosestPointPointTriangle(const Float3& point, const Float3& vertex1, const Float3& vertex2, const Float3& vertex3);
        ...
        /// <param name="point">The point to test.</param>
        /// <param name="result">When the method completes, contains the closest point between the two objects.</param>
        static void ClosestPointPlanePoint(const Plane& plane, const Float3& point, Float3& result);
        ...
        /// <param name="point">The point to test.</param>
        /// <returns>The closest point between the two objects.</returns>
        static Float3 ClosestPointPlanePoint(const Plane& plane, const Float3& point);

        /// <summary>
        /// Determines the closest point between a <see cref="AABB" /> and a point.
        /// </summary>
        /// <param name="box">The box to test.</param>
        /// <param name="point">The point to test.</param>
        /// <param name="result">When the method completes, contains the closest point between the two objects.</param>
        static void ClosestPointBoxPoint(const BoundingBox& box, const Float3& point, Float3& result);
        ...
        /// <param name="point">The point to test.</param>
        /// <returns>The closest point between the two objects.</returns>
        static Float3 ClosestPointBoxPoint(const BoundingBox& box, const Float3& point);
        ...
        static void ClosestPointSpherePoint(const BoundingSphere& sphere, const Float3& point, Float3& result);
        ...
        /// <param name="sphere">The sphere to test.</param>
        /// <param name="point">The point to test.</param>
        /// <returns>The closest point between the two objects; or, if the point is directly in the center of the sphere, contains <see cref="Float3.Zero" />.</return>
        static Float3 ClosestPointSpherePoint(const BoundingSphere& sphere, const Float3& point);
        ...
        /// intersection.
        /// </remarks>
        static void ClosestPointSphereSphere(const BoundingSphere& sphere1, const BoundingSphere& sphere2, Float3& result);
        ...
        /// <param name="sphere1">The first sphere to test.</param>
        /// <param name="sphere2">The second sphere to test.</param>
        /// <returns>The closest point between the two objects; or, if the point is directly in the center of the sphere, contains <see cref="Float3.Zero" />.</returns>
        /// <remarks>
        /// If the two spheres are overlapping, but not directly on top of each other, the closest point
        /// is the 'closest' point of intersection. This can also be considered is the deepest point of
        /// intersection.
        /// </remarks>
        static Float3 ClosestPointSphereSphere(const BoundingSphere& sphere1, const BoundingSphere& sphere2);
        ...
        static float DistancePlanePoint(const Plane& plane, const Float3& point);

        /// <summary>
        /// Determines the distance between a <see cref="AABB" /> and a point.
        /// </summary>
        /// <param name="box">The box to test.</param>
        /// <param name="point">The point to test.</param>
        /// <returns>The distance between the two objects.</returns>
        static float DistanceBoxPoint(const BoundingBox& box, const Float3& point);
        ...
        /// <param name="point">The point to test.</param>
        /// <returns>The distance between the two objects.</returns>
        static float DistanceSpherePoint(const BoundingSphere& sphere, const Float3& point);
        ...
        static bool RayIntersectsPoint(const Ray& ray, const Float3& point);
        ...
        /// </remarks>
        static bool RayIntersectsRay(const Ray& ray1, const Ray& ray2, Float3& point);
        ...
        static bool RayIntersectsPlane(const Ray& ray, const Plane& plane, Float3& point);
        ...
        /// </remarks>
        static bool RayIntersectsTriangle(const Ray& ray, const Float3& vertex1, const Float3& vertex2, const Float3& vertex3, float& distance);
        ...
        /// this method returns false.
        /// </remarks>
        static bool RayIntersectsTriangle(const Ray& ray, const Float3& vertex1, const Float3& vertex2, const Float3& vertex3, float& distance, Float3& normal);
        ...
        /// <param name="point">When the method completes, contains the point of intersection, or <see cref="Float3.Zero" /> if there was no intersection.</param>
        /// <returns>Whether the two objects intersected.</returns>
        static bool RayIntersectsTriangle(const Ray& ray, const Float3& vertex1, const Float3& vertex2, const Float3& vertex3, Float3& point);

        /// <summary>
        /// Determines whether there is an intersection between a <see cref="Ray" /> and a <see cref="AABB" />.
        /// </summary>
        /// <param name="ray">The ray to test.</param>
        /// <param name="box">The box to test.</param>
        /// <param name="distance">When the method completes, contains the distance of the intersection, or 0 if there was no intersection.</param>
        ...
        /// <param name="normal">When the method completes, contains the intersection surface normal vector, or Float3::Up if there was no intersection.</param>
        /// <returns>Whether the two objects intersected.</returns>
        static bool RayIntersectsBox(const Ray& ray, const BoundingBox& box, float& distance, Float3& normal);
        ...
        /// <param name="point">When the method completes, contains the point of intersection, or <see cref="Float3.Zero" /> if there was no intersection.</param>
        /// <returns>Whether the two objects intersected.</returns>
        static bool RayIntersectsBox(const Ray& ray, const BoundingBox& box, Float3& point);
        ...
        /// <param name="normal">When the method completes, contains the intersection surface normal vector, or Float3::Up if there was no intersection.</param>
        /// <returns>Whether the two objects intersected.</returns>
        static bool RayIntersectsSphere(const Ray& ray, const BoundingSphere& sphere, float& distance, Float3& normal);
        ...
        /// <param name="point">When the method completes, contains the point of intersection, or <see cref="Float3.Zero" /> if there was no intersection.</param>
        /// <returns>Whether the two objects intersected.</returns>
        static bool RayIntersectsSphere(const Ray& ray, const BoundingSphere& sphere, Float3& point);
        ...
        /// <param name="point">The point to test.</param>
        /// <returns>Whether the two objects intersected.</returns>
        static PlaneIntersectionType PlaneIntersectsPoint(const Plane& plane, const Float3& point);
        ...
        /// <param name="vertex3">The third vertex of the triangle to test.</param>
        /// <returns>Whether the two objects intersected.</returns>
        static PlaneIntersectionType PlaneIntersectsTriangle(const Plane& plane, const Float3& vertex1, const Float3& vertex2, const Float3& vertex3);

        /// <summary>
        /// Determines whether there is an intersection between a <see cref="Plane" /> and a <see cref="AABB" />.
        /// </summary>
        /// <param name="plane">The plane to test.</param>
        /// <param name="box">The box to test.</param>
        /// <returns>Whether the two objects intersected.</returns>
        ...
        /// <summary>
        /// Determines whether there is an intersection between a <see cref="AABB" /> and a <see cref="AABB" />.
        /// </summary>
        /// <param name="box1">The first box to test.</param>
        /// <param name="box2">The second box to test.</param>
        /// <returns>Whether the two objects intersected.</returns>
        ...
        /// <param name="vertex3">The third vertex of the triangle to test.</param>
        /// <returns>Whether the two objects intersected.</returns>
        static bool SphereIntersectsTriangle(const BoundingSphere& sphere, const Float3& vertex1, const Float3& vertex2, const Float3& vertex3);

        /// <summary>
        /// Determines whether there is an intersection between a <see cref="Sphere" /> and a
        /// <see cref="Sphere" />.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether a <see cref="AABB" /> contains a point.
        /// </summary>
        /// <param name="box">The box to test.</param>
        /// <param name="point">The point to test.</param>
        /// <returns>The type of containment the two objects have.</returns>
        static ContainmentType BoxContainsPoint(const BoundingBox& box, const Float3& point);

        /// <summary>
        /// Determines whether a <see cref="AABB" /> contains a <see cref="AABB" />.
        /// </summary>
        /// <param name="box1">The first box to test.</param>
        /// <param name="box2">The second box to test.</param>
        /// <returns>The type of containment the two objects have.</returns>
        ...
        /// <summary>
        /// Determines whether a <see cref="AABB" /> contains a <see cref="Sphere" />.
        /// </summary>
        /// <param name="box">The box to test.</param>
        /// <param name="sphere">The sphere to test.</param>
        /// <returns>The type of containment the two objects have.</returns>
        ...
        /// <param name="point">The point to test.</param>
        /// <returns>The type of containment the two objects have.</returns>
        static ContainmentType SphereContainsPoint(const BoundingSphere& sphere, const Float3& point);
        ...
        /// <param name="vertex3">The third vertex of the triangle to test.</param>
        /// <returns>The type of containment the two objects have.</returns>
        static ContainmentType SphereContainsTriangle(const BoundingSphere& sphere, const Float3& vertex1, const Float3& vertex2, const Float3& vertex3);

        /// <summary>
        /// Determines whether a <see cref="Sphere" /> contains a <see cref="AABB" />.
        /// </summary>
        /// <param name="sphere">The sphere to test.</param>
        /// <param name="box">The box to test.</param>
        /// <returns>The type of containment the two objects have.</returns>
        ...
        static Float2 LineHitsBox(const Float3& lineStart, const Float3& lineEnd, const Float3& boxMin, const Float3& boxMax);
