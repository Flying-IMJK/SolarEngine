...
namespace SE
{
	...
	public:
		...
		static SE_API_RUNTIME const Vector3Base<T> Zero;

		// Vector with all components equal one (1, 1, 1).
		static SE_API_RUNTIME const Vector3Base<T> One;

		// Vector with all components equal half (0.5, 0.5, 0.5).
		static SE_API_RUNTIME const Vector3Base<T> Half;

		// The X unit vector (1, 0, 0).
		static SE_API_RUNTIME const Vector3Base<T> UnitX;

		// The Y unit vector (0, 1, 0).
		static SE_API_RUNTIME const Vector3Base<T> UnitY;

		// The Z unit vector (0, 0, 1).
		static SE_API_RUNTIME const Vector3Base<T> UnitZ;

		// A unit vector designating up (0, 1, 0).
		static SE_API_RUNTIME const Vector3Base<T> Up;

		// A unit vector designating down (0, -1, 0).
		static SE_API_RUNTIME const Vector3Base<T> Down;

		// A unit vector designating a (-1, 0, 0).
		static SE_API_RUNTIME const Vector3Base<T> Left;

		// A unit vector designating b (1, 0, 0).
		static SE_API_RUNTIME const Vector3Base<T> Right;

		// A unit vector designating forward in a a-handed coordinate system (0, 0, 1).
		static SE_API_RUNTIME const Vector3Base<T> Forward;

		// A unit vector designating backward in a a-handed coordinate system (0, 0, -1).
		static SE_API_RUNTIME const Vector3Base<T> Backward;

		// Vector with all components equal maximum value.
		static SE_API_RUNTIME const Vector3Base<T> Minimum;

		// Vector with all components equal minimum value.
		static SE_API_RUNTIME const Vector3Base<T> Maximum;
	...
	public:
		...
		SE_API_RUNTIME Vector3Base(const Float2& xy, T z = 0);
		SE_API_RUNTIME Vector3Base(const Double2& xy, T z = 0);
		SE_API_RUNTIME Vector3Base(const Int2& xy, T z = 0);
		SE_API_RUNTIME Vector3Base(const Int3& xyz);
		SE_API_RUNTIME explicit Vector3Base(const Float4& xyz);
		SE_API_RUNTIME explicit Vector3Base(const Double4& xyz);
		SE_API_RUNTIME explicit Vector3Base(const Int4& xyz);
		SE_API_RUNTIME explicit Vector3Base(const Color& color);
	...
	public:
		...
		static SE_API_RUNTIME void Hermite(const Vector3Base& value1, const Vector3Base& tangent1, const Vector3Base& value2, const Vector3Base& tangent2, T amount, Vector3Base& result);
		...
		static SE_API_RUNTIME void Reflect(const Vector3Base& vector, const Vector3Base& normal, Vector3Base& result);
		...
		static SE_API_RUNTIME void Transform(const Vector3Base& vector, const Quaternion& rotation, Vector3Base& result);

		// Transforms a 3D vector by the given Quaternion rotation
		// @param vector The vector to rotate
		// @param rotation The Quaternion rotation to apply
		// @returns The transformed Vector3
		static SE_API_RUNTIME Vector3Base Transform(const Vector3Base& vector, const Quaternion& rotation);

		// Transforms a 3D vector by the given matrix
		// @param vector The source vector
		// @param transform The transformation matrix
		// @param result When the method completes, contains the transformed Vector3
		static SE_API_RUNTIME void Transform(const Vector3Base& vector, const Matrix& transform, Vector3Base& result);

		// Transforms a 3D vector by the given matrix
		// @param vector The source vector
		// @param transform The transformation matrix
		// @param result When the method completes, contains the transformed Vector3
		static SE_API_RUNTIME void Transform(const Vector3Base& vector, const Matrix3x3& transform, Vector3Base& result);

		// Transforms a 3D vector by the given transformation
		// @param vector The source vector
		// @param transform The transformation
		// @param result When the method completes, contains the transformed Vector3
		static SE_API_RUNTIME void Transform(const Vector3Base& vector, const ::SE::Transform& transform, Vector3Base& result);

		// Transforms a 3D vector by the given matrix
		// @param vector The source vector
		// @param transform The transformation matrix
		// @returns Transformed Vector3
		static SE_API_RUNTIME Vector3Base Transform(const Vector3Base& vector, const Matrix& transform);

		// Transforms a 3D vector by the given transformation
		// @param vector The source vector
		// @param transform The transformation
		// @returns Transformed Vector3
		static SE_API_RUNTIME Vector3Base Transform(const Vector3Base& vector, const ::SE::Transform& transform);

		// Transforms a 3D vector by the given matrix
		// @param vector The source vector
		// @param transform The transformation matrix
		// @param result When the method completes, contains the transformed Vector4
		static SE_API_RUNTIME void Transform(const Vector3Base& vector, const Matrix& transform, Vector4Base<T>& result);
		...
		static SE_API_RUNTIME void TransformCoordinate(const Vector3Base& coordinate, const Matrix& transform, Vector3Base& result);
		...
		static SE_API_RUNTIME void TransformNormal(const Vector3Base& normal, const Matrix& transform, Vector3Base& result);
		...
		static SE_API_RUNTIME Vector3Base Project(const Vector3Base& vector, const Vector3Base& onNormal);
		...
		static SE_API_RUNTIME void Project(const Vector3Base& vector, float x, float y, float width, float height, float minZ, float maxZ, const Matrix& worldViewProjection, Vector3Base& result);
		...
		static SE_API_RUNTIME void Unproject(const Vector3Base& vector, float x, float y, float width, float height, float minZ, float maxZ, const Matrix& worldViewProjection, Vector3Base& result);
		...
		static SE_API_RUNTIME void CreateOrthonormalBasis(Vector3Base& xAxis, Vector3Base& yAxis, Vector3Base& zAxis);
		...
		SE_API_RUNTIME void FindBestAxisVectors(Vector3Base& firstAxis, Vector3Base& secondAxis) const;
		...
		static SE_API_RUNTIME T TriangleArea(const Vector3Base& v0, const Vector3Base& v1, const Vector3Base& v2);
		...
		static SE_API_RUNTIME T Angle(const Vector3Base& from, const Vector3Base& to);
	};
...
template<> SE_API_RUNTIME const SE::Float3 SE::Float3::Zero;
template<> SE_API_RUNTIME const SE::Float3 SE::Float3::One;
template<> SE_API_RUNTIME const SE::Float3 SE::Float3::Half;
template<> SE_API_RUNTIME const SE::Float3 SE::Float3::UnitX;
template<> SE_API_RUNTIME const SE::Float3 SE::Float3::UnitY;
template<> SE_API_RUNTIME const SE::Float3 SE::Float3::UnitZ;
template<> SE_API_RUNTIME const SE::Float3 SE::Float3::Up;
template<> SE_API_RUNTIME const SE::Float3 SE::Float3::Down;
template<> SE_API_RUNTIME const SE::Float3 SE::Float3::Left;
template<> SE_API_RUNTIME const SE::Float3 SE::Float3::Right;
template<> SE_API_RUNTIME const SE::Float3 SE::Float3::Forward;
template<> SE_API_RUNTIME const SE::Float3 SE::Float3::Backward;
template<> SE_API_RUNTIME const SE::Float3 SE::Float3::Minimum;
template<> SE_API_RUNTIME const SE::Float3 SE::Float3::Maximum;

template<> SE_API_RUNTIME const SE::Double3 SE::Double3::Zero;
template<> SE_API_RUNTIME const SE::Double3 SE::Double3::One;
template<> SE_API_RUNTIME const SE::Double3 SE::Double3::Half;
template<> SE_API_RUNTIME const SE::Double3 SE::Double3::UnitX;
template<> SE_API_RUNTIME const SE::Double3 SE::Double3::UnitY;
template<> SE_API_RUNTIME const SE::Double3 SE::Double3::UnitZ;
template<> SE_API_RUNTIME const SE::Double3 SE::Double3::Up;
template<> SE_API_RUNTIME const SE::Double3 SE::Double3::Down;
template<> SE_API_RUNTIME const SE::Double3 SE::Double3::Left;
template<> SE_API_RUNTIME const SE::Double3 SE::Double3::Right;
template<> SE_API_RUNTIME const SE::Double3 SE::Double3::Forward;
template<> SE_API_RUNTIME const SE::Double3 SE::Double3::Backward;
template<> SE_API_RUNTIME const SE::Double3 SE::Double3::Minimum;
template<> SE_API_RUNTIME const SE::Double3 SE::Double3::Maximum;

template<> SE_API_RUNTIME const SE::Int3 SE::Int3::Zero;
template<> SE_API_RUNTIME const SE::Int3 SE::Int3::One;
template<> SE_API_RUNTIME const SE::Int3 SE::Int3::Half;
template<> SE_API_RUNTIME const SE::Int3 SE::Int3::UnitX;
template<> SE_API_RUNTIME const SE::Int3 SE::Int3::UnitY;
template<> SE_API_RUNTIME const SE::Int3 SE::Int3::UnitZ;
template<> SE_API_RUNTIME const SE::Int3 SE::Int3::Up;
template<> SE_API_RUNTIME const SE::Int3 SE::Int3::Down;
template<> SE_API_RUNTIME const SE::Int3 SE::Int3::Left;
template<> SE_API_RUNTIME const SE::Int3 SE::Int3::Right;
template<> SE_API_RUNTIME const SE::Int3 SE::Int3::Forward;
template<> SE_API_RUNTIME const SE::Int3 SE::Int3::Backward;
template<> SE_API_RUNTIME const SE::Int3 SE::Int3::Minimum;
template<> SE_API_RUNTIME const SE::Int3 SE::Int3::Maximum;
#endif
