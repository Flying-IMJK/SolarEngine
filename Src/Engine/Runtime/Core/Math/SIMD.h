...
namespace SE
{
    namespace SIMD
    {
        struct SE_API_RUNTIME alignas(16) IntMask
        {
        ...
        struct SE_API_RUNTIME alignas(16) UIntMask
        {
            inline operator __m128() const { return reinterpret_cast<__m128 const &>(*this); }
            inline operator __m128i() const { return _mm_castps_si128(*this); }
            inline operator __m128d() const { return _mm_castps_pd(*this); }
        ...
        struct SE_API_RUNTIME alignas(16) FloatMask
        {
            inline operator __m128() const { return reinterpret_cast<__m128 const &>(*this); }
            inline operator __m128i() const { return _mm_castps_si128(*this); }
            inline operator __m128d() const { return _mm_castps_pd(*this); }
        ...
        namespace Int
        {
            ...
            inline bool NotEqual(__m128 V1, __m128 V2)
            {
                __m128i vTemp = _mm_cmpeq_epi32(_mm_castps_si128(V1), _mm_castps_si128(V2));
                return ((_mm_movemask_ps(_mm_castsi128_ps(vTemp)) != 0xF) != 0);
            }

            inline __m128 And(__m128 V1, __m128 V2)
            {
                return _mm_and_ps(V1, V2);
            }

            inline __m128 Or(__m128 V1, __m128 V2)
            {
        ...
        static __m128 const g_tanEstCoefficients = {2.484f, -1.954923183e-1f, 2.467401101f, Math::ONE_OVER_PI};
