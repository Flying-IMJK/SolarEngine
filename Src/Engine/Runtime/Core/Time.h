...
namespace SE
{
    ...
    public:
        ...
        inline Microseconds &operator=(float time)
        {
            m_value = time;
            return *this;
        }
    ...
    public:
        ...
        inline Milliseconds &operator=(float time)
        {
            m_value = time;
            return *this;
        }
    ...
    public:
        ...
        inline Seconds &operator=(float time)
        {
            m_value = time;
            return *this;
        }
    ...
    class SE_API_RUNTIME Nanoseconds
    {
    public:
        ...
        inline Nanoseconds &operator=(uint64_t time)
        {
            m_value = time;
            return *this;
        }
        inline Nanoseconds &operator=(Nanoseconds time)
        {
        ...
        inline Nanoseconds &operator+=(uint64_t const time)
        {
            m_value += time;
            return *this;
        };
        inline Nanoseconds &operator+=(Nanoseconds const time)
        {
            m_value += time.m_value;
            return *this;
        };
    ...
    inline Microseconds &Microseconds::operator=(Milliseconds time)
    {
        m_value = time.m_value * 1000;
        return *this;
    }
    inline Microseconds &Microseconds::operator=(Seconds time)
    {
        m_value = time.m_value * 1000000;
        return *this;
    }
    ...
    inline Milliseconds &Milliseconds::operator=(Microseconds time)
    {
        m_value = time.m_value / 1000;
        return *this;
    }
    inline Milliseconds &Milliseconds::operator=(Seconds time)
    {
        m_value = time.m_value * 1000;
        return *this;
    }
    ...
    inline Seconds &Seconds::operator=(Microseconds time)
    {
        m_value = time.m_value / 1000000;
        return *this;
    }
    inline Seconds &Seconds::operator=(Milliseconds time)
    {
        m_value = time.m_value / 1000;
        return *this;
    }
    ...
    inline Microseconds &Microseconds::operator+=(float const time)
    {
        m_value += time;
        return *this;
    }
    inline Microseconds &Microseconds::operator+=(Microseconds const time)
    {
        m_value += time.m_value;
        return *this;
    }
    inline Microseconds &Microseconds::operator+=(Milliseconds const time)
    {
        *this += (Microseconds)time;
        return *this;
    }
    inline Microseconds &Microseconds::operator+=(Seconds const time)
    {
        *this += (Microseconds)time;
        return *this;
    }
    ...
    inline Milliseconds &Milliseconds::operator+=(float const time)
    {
        m_value += time;
        return *this;
    }
    inline Milliseconds &Milliseconds::operator+=(Milliseconds const time)
    {
        m_value += time.m_value;
        return *this;
    }
    inline Milliseconds &Milliseconds::operator+=(Microseconds const time)
    {
        *this += (Milliseconds)time;
        return *this;
    }
    inline Milliseconds &Milliseconds::operator+=(Seconds const time)
    {
        *this += (Milliseconds)time;
        return *this;
    }
    ...
    inline Seconds &Seconds::operator+=(float const time)
    {
        m_value += time;
        return *this;
    }
    inline Seconds &Seconds::operator+=(Seconds const time)
    {
        m_value += time.m_value;
        return *this;
    }
    inline Seconds &Seconds::operator+=(Microseconds const time)
    {
        *this += (Seconds)time;
        return *this;
    }
    inline Seconds &Seconds::operator+=(Milliseconds const time)
    {
        *this += (Seconds)time;
        return *this;
    }
    ...
    struct SE_API_RUNTIME PlatformClock
    {
    ...
    class SE_API_RUNTIME EngineClock
    {
