...
namespace SE::Log
{
    ...
    class SE_API_RUNTIME Notification
    {
    ...
    SE_API_RUNTIME StringView GetSeverityAsString( Severity severity );

    // Lifetime
    //-------------------------------------------------------------------------

    struct SE_API_RUNTIME System
    {
        // Lifetime
        //-------------------------------------------------------------------------
