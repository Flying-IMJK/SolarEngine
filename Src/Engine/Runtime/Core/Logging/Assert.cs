...
namespace SE
{
    ...
    public static class Assert
    {
        ...
        {
            AreEqual(expected, actual, null, Log.FloatComparer.ComparerWithDefaultTolerance);
        }
        ...
        {
            AreEqual(expected, actual, message, Log.FloatComparer.ComparerWithDefaultTolerance);
        }
        ...
        {
            AreEqual(expected, actual, message, new Log.FloatComparer(tolerance));
        }
        ...
        {
            AreNotEqual(expected, actual, null, Log.FloatComparer.ComparerWithDefaultTolerance);
        }
        ...
        {
            AreNotEqual(expected, actual, message, Log.FloatComparer.ComparerWithDefaultTolerance);
        }
        ...
        {
            AreNotEqual(expected, actual, message, new Log.FloatComparer(tolerance));
        }
        ...
        {
            if (RaiseExceptions)
                throw new Log.AssertionException(message, userMessage);
            if (message == null)
