...
namespace SE
{
	...
	struct ShaderPermutation
	{
		...
		List<ShaderPermutationEntry> Entries;
	...
	public:
		...
		/// </summary>
		List <ShaderPermutation> Permutations;
	...
	public:
		...
		{
			ENGINE_ASSERT(Math::RangeInclusive(permutationIndex, 0, Permutations.Count() - 1));
		...
		void GetDefinitionsForPermutation(int32 permutationIndex, List<ShaderMacro>& macros) const
		{
			ENGINE_ASSERT(Math::RangeInclusive(permutationIndex, 0, Permutations.Count() - 1));
	...
	public:
		...
		/// Vertex Shaders
		/// </summary>
		List <VertexShaderMeta> VS;

		/// <summary>
		/// Hull Shaders
		/// </summary>
		List <HullShaderMeta> HS;

		/// <summary>
		/// Domain Shaders
		/// </summary>
		List <DomainShaderMeta> DS;

		/// <summary>
		/// Geometry Shaders
		/// </summary>
		List <GeometryShaderMeta> GS;

		/// <summary>
		/// Pixel Shaders
		/// </summary>
		List <PixelShaderMeta> PS;

		/// <summary>
		/// Compute Shaders
		/// </summary>
		List <ComputeShaderMeta> CS;

		/// <summary>
		/// Constant Buffers
		/// </summary>
		List <ConstantBufferMeta> CB;
	...
	public:
		...
		void GetShaders(List<const ShaderFunctionMeta*>& functions) const
		{
