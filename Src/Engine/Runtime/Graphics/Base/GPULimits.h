...
namespace SE
{
	...
	enum class FormatSupport : int32
	{
		...
		/// <summary>
		/// CharsFormat can be displayed on screen.
		/// </summary>
		Display = 524288,

		/// <summary>
		/// CharsFormat can't be cast to another format.
		/// </summary>
		CastWithinBitLayout = 1048576,

		/// <summary>
		/// CharsFormat can be used as a multi-sampled render target.
		/// </summary>
		MultisampleRenderTarget = 2097152,

		/// <summary>
		/// CharsFormat can be used as a multi-sampled texture and read into a shader with the shader Load function.
		/// </summary>
		MultisampleLoad = 4194304,

		/// <summary>
		/// CharsFormat can be used with the shader gather function.
		/// </summary>
		ShaderGather = 8388608,

		/// <summary>
		/// CharsFormat supports casting when the resource is a back buffer.
		/// </summary>
		BackBufferCast = 16777216,

		/// <summary>
		/// CharsFormat can be used for an unordered access view.
		/// </summary>
		TypedUnorderedAccessView = 33554432,

		/// <summary>
		/// CharsFormat can be used with the shader gather with comparison function.
		/// </summary>
		ShaderGatherComparison = 67108864,

		/// <summary>
		/// CharsFormat can be used with the decoder output.
		/// </summary>
		DecoderOutput = 134217728,

		/// <summary>
		/// CharsFormat can be used with the video processor output.
		/// </summary>
		VideoProcessorOutput = 268435456,

		/// <summary>
		/// CharsFormat can be used with the video processor input.
		/// </summary>
		VideoProcessorInput = 536870912,

		/// <summary>
		/// CharsFormat can be used with the video encoder.
		/// </summary>
