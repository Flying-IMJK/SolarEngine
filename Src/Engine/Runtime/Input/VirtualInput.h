...
namespace SE
{
	...
	struct AxisConfig
	{
		...
		/// </summary>
		SE_FIELD(API(Attributes="EditorOrder(50)"))
		float DeadZone;
		...
		/// </summary>
		SE_FIELD(API(Attributes="EditorOrder(60)"))
		float Sensitivity;
