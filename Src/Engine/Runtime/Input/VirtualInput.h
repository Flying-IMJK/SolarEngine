...
//		SE_PROPERTY(API, Attributes="EditorOrder(0)")
		...
		/// </summary>
//		SE_PROPERTY(API, Attributes="EditorOrder(5)")
...
//		SE_PROPERTY(API, Attributes="EditorOrder(20)")
		...
		/// </summary>
//		SE_PROPERTY(API, Attributes="EditorOrder(30)")
		GamepadButton GamepadButton;

		/// <summary>
		/// Which gamepad should be used.
		/// </summary>
//		SE_PROPERTY(API, Attributes="EditorOrder(40)")
...
//		SE_PROPERTY(API, Attributes="EditorOrder(50)")
		...
		/// </summary>
//		SE_PROPERTY(API, Attributes="EditorOrder(60)")
		float Sensitivity;
