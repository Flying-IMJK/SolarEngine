...
namespace SE
{
    ...
    public:
        ...
        SEField(SEClass* parentClass, void* handle, const char* name, void* type, int fieldOffset, SEFieldAttributes attributes);
    ...
    public:
        ...
        void GetValue(SEObject* instance, void* result) const;
        ...
        /// <param name="instance">The object of given type to get value from.</param>
        /// <param name="result">The return value of undefined type.</param>
        void GetValueReference(SEObject* instance, void* result) const;
        ...
        SEObject* GetValueBoxed(SEObject* instance) const;
        ...
        void SetValue(SEObject* instance, void* value) const;
