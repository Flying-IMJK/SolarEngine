...
namespace SE
{
    ...
    /// </summary>
    class SE_API_RUNTIME SEProperty
    {
        friend SEClass;

    protected:
        mutable SEMethod* _getMethod;
        mutable SEMethod* _setMethod;
    ...
    public:
        ...
        SEProperty(SEClass* parentClass, const char* name, void* getterHandle, void* setterHandle, SEMethodAttributes getterAttributes, SEMethodAttributes setterAttributes);
    ...
    public:
        ...
        /// </summary>
        SEMethod* GetGetMethod() const;

        /// <summary>
        /// Gets property set method.
        /// </summary>
        SEMethod* GetSetMethod() const;

        /// <summary>
        /// Gets property visibility in the class.
        /// </summary>
        SEVisibility GetVisibility() const;
    ...
    public:
        ...
        SEObject* GetValue(SEObject* instance, SEObject** exception) const;
        ...
        void SetValue(SEObject* instance, void* value, SEObject** exception) const;
