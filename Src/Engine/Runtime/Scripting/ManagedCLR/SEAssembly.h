...
namespace SE
{
    ...
    /// </summary>
    class SE_API_RUNTIME SEAssembly
    {
        friend SEDomain;
        friend Scripting;

    public:
        typedef Dictionary<StringAnsi, SEClass*> ClassesDictionary;
    ...
    public:
        ...
        SEAssembly(SEDomain* domain, const StringAnsiView& name);
        ...
        SEAssembly(SEDomain* domain, const StringAnsiView& name, const StringAnsiView& fullname, void* handle);
    ...
    public:
        ...
        /// </summary>
        typedef Delegate<SEAssembly*> AssemblyDelegate;
    ...
    public:
        ...
        /// </summary>
        FORCE_INLINE SEDomain* GetDomain() const
        {
            return m_Domain;
        }
    ...
    public:
        ...
        SEClass* GetClass(const StringAnsiView& typeName) const;
