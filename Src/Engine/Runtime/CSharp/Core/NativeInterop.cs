...
namespace SE.Interop
{
    ...
    /// <summary>
    /// Provides the C# implementation of the NativeInterop layer.
    /// C++ calls (via load_assembly_and_get_function_pointer) once
    /// during engine startup to receive all function pointers.
    /// </summary>
    public static unsafe partial class NativeInterop
    {
        ...
        internal static class MarshalHelperReferenceType<T> where T : class
        {
            ...
            internal static void ToNativePointer(ref T managedValue, IntPtr nativePtr)
            {
                ...
                else if (managedValue is SE.Object obj)
                    managedPtr = SE.Object.GetUnmanagedPtr(obj);
                else
        ...
        private static Type[] GetAssemblyTypes(Assembly assembly)
        {
            ...
            var allAssemblies = NativeInteropUtils.GetAssemblies();
            ...
            Assert.IsTrue(NativeInteropUtils.GetAssemblies().Count(x => x.GetName().Name == "FlaxEngine.CSharp") == 1);
            return types;
        }
    ...
    internal class NativeInteropException : Exception
    {
        ...
        {
#if !BUILD_RELEASE
            Debug.Logger.LogHandler.LogWrite(Log.LogType.Error, "Native interop exception!");
#endif
        }
    }
}
