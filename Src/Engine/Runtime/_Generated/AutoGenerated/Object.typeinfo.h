...
{
    template<>
    class  TTypeCompositeInfo<::SE::Object> final : public TypeCompositeInfo
    {
       static ::SE::Object const* s_pDefaultInstance_3736568981954949674;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_3736568981954949674 = New<::SE::Object>(nullptr);

            ::SE::Object::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Object>>(s_pDefaultInstance_3736568981954949674);
            Types::RegisterType(::SE::Object::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Object::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Object*>(s_pDefaultInstance_3736568981954949674));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Object::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Object"));
            size = sizeof(::SE::Object);
            alignment = alignof(::SE::Object);
            name = SE_TEXT("Object");
            fullName = SE_TEXT("SE::Object");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Object), alignof(::SE::Object));
            return new (pMemory) ::SE::Object(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Object(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_3736568981954949674;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Object>::s_pDefaultInstance_3736568981954949674);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Object>::s_pDefaultInstance_3736568981954949674, propertyID, arrayIdx);
        }
    };

    ::SE::Object const* TTypeCompositeInfo<::SE::Object>::s_pDefaultInstance_3736568981954949674 = nullptr;
}
