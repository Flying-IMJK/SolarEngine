...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE VScrollBar
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::VScrollBar> final : public TypeCompositeInfo
    {
       static ::SE::VScrollBar const* s_pDefaultInstance_10572712127249052605;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_10572712127249052605 = New<::SE::VScrollBar>(nullptr);

            ::SE::VScrollBar::s_pTypeInfo = New<TTypeCompositeInfo<::SE::VScrollBar>>(s_pDefaultInstance_10572712127249052605);
            Types::RegisterType(::SE::VScrollBar::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::VScrollBar::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::VScrollBar*>(s_pDefaultInstance_10572712127249052605));
            Delete(const_cast<TypeCompositeInfo*>(::SE::VScrollBar::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::VScrollBar"));
            size = sizeof(::SE::VScrollBar);
            alignment = alignof(::SE::VScrollBar);
            name = SE_TEXT("VScrollBar");
            fullName = SE_TEXT("SE::VScrollBar");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::VScrollBar), alignof(::SE::VScrollBar));
            return new (pMemory) ::SE::VScrollBar(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::VScrollBar(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_10572712127249052605;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::VScrollBar>::s_pDefaultInstance_10572712127249052605);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::VScrollBar>::s_pDefaultInstance_10572712127249052605, propertyID, arrayIdx);
        }
    };

    ::SE::VScrollBar const* TTypeCompositeInfo<::SE::VScrollBar>::s_pDefaultInstance_10572712127249052605 = nullptr;
}
