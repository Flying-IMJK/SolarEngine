...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE GPUBufferDescription
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::GPUBufferDescription> final : public TypeCompositeInfo
    {
       static ::SE::GPUBufferDescription const* s_pDefaultInstance_14368095860320016383;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_14368095860320016383 = New<::SE::GPUBufferDescription>(nullptr);

            ::SE::GPUBufferDescription::s_pTypeInfo = New<TTypeCompositeInfo<::SE::GPUBufferDescription>>(s_pDefaultInstance_14368095860320016383);
            Types::RegisterType(::SE::GPUBufferDescription::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::GPUBufferDescription::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::GPUBufferDescription*>(s_pDefaultInstance_14368095860320016383));
            Delete(const_cast<TypeCompositeInfo*>(::SE::GPUBufferDescription::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::GPUBufferDescription"));
            size = sizeof(::SE::GPUBufferDescription);
            alignment = alignof(::SE::GPUBufferDescription);
            name = SE_TEXT("GPUBufferDescription");
            fullName = SE_TEXT("SE::GPUBufferDescription");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::GPUBufferDescription), alignof(::SE::GPUBufferDescription));
            return new (pMemory) ::SE::GPUBufferDescription(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::GPUBufferDescription(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_14368095860320016383;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::GPUBufferDescription>::s_pDefaultInstance_14368095860320016383);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::GPUBufferDescription>::s_pDefaultInstance_14368095860320016383, propertyID, arrayIdx);
        }
    };

    ::SE::GPUBufferDescription const* TTypeCompositeInfo<::SE::GPUBufferDescription>::s_pDefaultInstance_14368095860320016383 = nullptr;
}
