...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE WindowRootControl
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::WindowRootControl> final : public TypeCompositeInfo
    {
       static ::SE::WindowRootControl const* s_pDefaultInstance_5689042715335224854;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_5689042715335224854 = New<::SE::WindowRootControl>(nullptr);

            ::SE::WindowRootControl::s_pTypeInfo = New<TTypeCompositeInfo<::SE::WindowRootControl>>(s_pDefaultInstance_5689042715335224854);
            Types::RegisterType(::SE::WindowRootControl::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::WindowRootControl::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::WindowRootControl*>(s_pDefaultInstance_5689042715335224854));
            Delete(const_cast<TypeCompositeInfo*>(::SE::WindowRootControl::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::WindowRootControl"));
            size = sizeof(::SE::WindowRootControl);
            alignment = alignof(::SE::WindowRootControl);
            name = SE_TEXT("WindowRootControl");
            fullName = SE_TEXT("SE::WindowRootControl");
            ...
            // Add parent info
            // Parent types
            pParentTypeInfo = ::SE::RootControl::s_pTypeInfo;
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::WindowRootControl), alignof(::SE::WindowRootControl));
            return new (pMemory) ::SE::WindowRootControl(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::WindowRootControl(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_5689042715335224854;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::WindowRootControl>::s_pDefaultInstance_5689042715335224854);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::WindowRootControl>::s_pDefaultInstance_5689042715335224854, propertyID, arrayIdx);
        }
    };

    ::SE::WindowRootControl const* TTypeCompositeInfo<::SE::WindowRootControl>::s_pDefaultInstance_5689042715335224854 = nullptr;
}
