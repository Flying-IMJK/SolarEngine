...
namespace SE
{
    ...
    {
       static ::SE::WindowRootControl const* s_pDefaultInstance_1262018478;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_1262018478 = New<::SE::WindowRootControl>(nullptr);

            ::SE::WindowRootControl::s_pTypeInfo = New<TTypeCompositeInfo<::SE::WindowRootControl>>(s_pDefaultInstance_1262018478);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::WindowRootControl*>(s_pDefaultInstance_1262018478));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_1262018478;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::WindowRootControl>::s_pDefaultInstance_1262018478);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::WindowRootControl>::s_pDefaultInstance_1262018478, propertyID, arrayIdx);
        }
    };

    ::SE::WindowRootControl const* TTypeCompositeInfo<::SE::WindowRootControl>::s_pDefaultInstance_1262018478 = nullptr;
}
