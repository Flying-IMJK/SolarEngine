...
namespace SE
{
    ...
    {
       static ::SE::TextureBrush const* s_pDefaultInstance_2854955462;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_2854955462 = New<::SE::TextureBrush>(nullptr);

            ::SE::TextureBrush::s_pTypeInfo = New<TTypeCompositeInfo<::SE::TextureBrush>>(s_pDefaultInstance_2854955462);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::TextureBrush*>(s_pDefaultInstance_2854955462));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_2854955462;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::TextureBrush>::s_pDefaultInstance_2854955462);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::TextureBrush>::s_pDefaultInstance_2854955462, propertyID, arrayIdx);
        }
    };

    ::SE::TextureBrush const* TTypeCompositeInfo<::SE::TextureBrush>::s_pDefaultInstance_2854955462 = nullptr;
}
