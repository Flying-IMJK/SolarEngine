...
namespace SE
{
    ...
    {
       static ::SE::ModelBase const* s_pDefaultInstance_4209231965;
    ...
    public:
        static void RegisterType()
        {
            ...
            ::SE::ModelBase::s_pTypeInfo = New<TTypeCompositeInfo<::SE::ModelBase>>(s_pDefaultInstance_4209231965);
    ...
    public:
        ...
        {
            return s_pDefaultInstance_4209231965;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::ModelBase>::s_pDefaultInstance_4209231965);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::ModelBase>::s_pDefaultInstance_4209231965, propertyID, arrayIdx);
        }
    };

    ::SE::ModelBase const* TTypeCompositeInfo<::SE::ModelBase>::s_pDefaultInstance_4209231965 = nullptr;
}
