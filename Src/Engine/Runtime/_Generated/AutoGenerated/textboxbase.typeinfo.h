...
namespace SE
{
    ...
    {
       static ::SE::TextBoxBase const* s_pDefaultInstance_2065328698;
    ...
    public:
        static void RegisterType()
        {
            ...
            ::SE::TextBoxBase::s_pTypeInfo = New<TTypeCompositeInfo<::SE::TextBoxBase>>(s_pDefaultInstance_2065328698);
    ...
    public:
        ...
        {
            return s_pDefaultInstance_2065328698;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::TextBoxBase>::s_pDefaultInstance_2065328698);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::TextBoxBase>::s_pDefaultInstance_2065328698, propertyID, arrayIdx);
        }
    };

    ::SE::TextBoxBase const* TTypeCompositeInfo<::SE::TextBoxBase>::s_pDefaultInstance_2065328698 = nullptr;
}
