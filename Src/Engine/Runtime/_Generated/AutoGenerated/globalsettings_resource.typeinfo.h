...
namespace SE
{
    ...
    {
       static ::SE::ResourceGlobalSettings const* s_pDefaultInstance_2552019387;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_2552019387 = New<::SE::ResourceGlobalSettings>(nullptr);

            ::SE::ResourceGlobalSettings::s_pTypeInfo = New<TTypeCompositeInfo<::SE::ResourceGlobalSettings>>(s_pDefaultInstance_2552019387);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::ResourceGlobalSettings*>(s_pDefaultInstance_2552019387));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_2552019387;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::ResourceGlobalSettings>::s_pDefaultInstance_2552019387);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::ResourceGlobalSettings>::s_pDefaultInstance_2552019387, propertyID, arrayIdx);
        }
    };

    ::SE::ResourceGlobalSettings const* TTypeCompositeInfo<::SE::ResourceGlobalSettings>::s_pDefaultInstance_2552019387 = nullptr;
}
