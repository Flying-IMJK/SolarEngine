...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE TextureGroup
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::TextureGroup> final : public TypeCompositeInfo
    {
       static ::SE::TextureGroup const* s_pDefaultInstance_6287524673838761591;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_6287524673838761591 = New<::SE::TextureGroup>(nullptr);

            ::SE::TextureGroup::s_pTypeInfo = New<TTypeCompositeInfo<::SE::TextureGroup>>(s_pDefaultInstance_6287524673838761591);
            Types::RegisterType(::SE::TextureGroup::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::TextureGroup::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::TextureGroup*>(s_pDefaultInstance_6287524673838761591));
            Delete(const_cast<TypeCompositeInfo*>(::SE::TextureGroup::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::TextureGroup"));
            size = sizeof(::SE::TextureGroup);
            alignment = alignof(::SE::TextureGroup);
            name = SE_TEXT("TextureGroup");
            fullName = SE_TEXT("SE::TextureGroup");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::TextureGroup), alignof(::SE::TextureGroup));
            return new (pMemory) ::SE::TextureGroup(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::TextureGroup(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_6287524673838761591;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::TextureGroup>::s_pDefaultInstance_6287524673838761591);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::TextureGroup>::s_pDefaultInstance_6287524673838761591, propertyID, arrayIdx);
        }
    };

    ::SE::TextureGroup const* TTypeCompositeInfo<::SE::TextureGroup>::s_pDefaultInstance_6287524673838761591 = nullptr;
}
