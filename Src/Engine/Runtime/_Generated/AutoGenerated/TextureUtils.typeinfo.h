...
namespace SE
{
    ...
    {
       static ::SE::TextureUtils::Options const* s_pDefaultInstance_7107051612004107513;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_7107051612004107513 = New<::SE::TextureUtils::Options>(nullptr);

            ::SE::TextureUtils::Options::s_pTypeInfo = New<TTypeCompositeInfo<::SE::TextureUtils::Options>>(s_pDefaultInstance_7107051612004107513);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::TextureUtils::Options*>(s_pDefaultInstance_7107051612004107513));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_7107051612004107513;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::TextureUtils::Options>::s_pDefaultInstance_7107051612004107513);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::TextureUtils::Options>::s_pDefaultInstance_7107051612004107513, propertyID, arrayIdx);
        }
    };

    ::SE::TextureUtils::Options const* TTypeCompositeInfo<::SE::TextureUtils::Options>::s_pDefaultInstance_7107051612004107513 = nullptr;
}
