...
namespace SE
{
    ...
    {
       static ::SE::TextBox const* s_pDefaultInstance_1625208287;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_1625208287 = New<::SE::TextBox>(nullptr);

            ::SE::TextBox::s_pTypeInfo = New<TTypeCompositeInfo<::SE::TextBox>>(s_pDefaultInstance_1625208287);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::TextBox*>(s_pDefaultInstance_1625208287));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_1625208287;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::TextBox>::s_pDefaultInstance_1625208287);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::TextBox>::s_pDefaultInstance_1625208287, propertyID, arrayIdx);
        }
    };

    ::SE::TextBox const* TTypeCompositeInfo<::SE::TextBox>::s_pDefaultInstance_1625208287 = nullptr;
}
