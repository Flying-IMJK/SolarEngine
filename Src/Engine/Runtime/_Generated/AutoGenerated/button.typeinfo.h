...
namespace SE
{
    ...
    {
       static ::SE::Button const* s_pDefaultInstance_2226955661;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_2226955661 = New<::SE::Button>(nullptr);

            ::SE::Button::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Button>>(s_pDefaultInstance_2226955661);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Button*>(s_pDefaultInstance_2226955661));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_2226955661;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Button>::s_pDefaultInstance_2226955661);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Button>::s_pDefaultInstance_2226955661, propertyID, arrayIdx);
        }
    };

    ::SE::Button const* TTypeCompositeInfo<::SE::Button>::s_pDefaultInstance_2226955661 = nullptr;
}
