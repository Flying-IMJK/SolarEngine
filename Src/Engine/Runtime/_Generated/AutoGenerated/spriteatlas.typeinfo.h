...
namespace SE
{
    ...
    {
       static ::SE::SpriteAtlas const* s_pDefaultInstance_775405789;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_775405789 = New<::SE::SpriteAtlas>(nullptr);

            ::SE::SpriteAtlas::s_pTypeInfo = New<TTypeCompositeInfo<::SE::SpriteAtlas>>(s_pDefaultInstance_775405789);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::SpriteAtlas*>(s_pDefaultInstance_775405789));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_775405789;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::SpriteAtlas>::s_pDefaultInstance_775405789);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::SpriteAtlas>::s_pDefaultInstance_775405789, propertyID, arrayIdx);
        }
    };

    ::SE::SpriteAtlas const* TTypeCompositeInfo<::SE::SpriteAtlas>::s_pDefaultInstance_775405789 = nullptr;
}
