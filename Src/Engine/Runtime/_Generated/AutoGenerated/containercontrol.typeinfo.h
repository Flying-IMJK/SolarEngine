...
namespace SE
{
    ...
    {
       static ::SE::ContainerControl const* s_pDefaultInstance_2028840693;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_2028840693 = New<::SE::ContainerControl>(nullptr);

            ::SE::ContainerControl::s_pTypeInfo = New<TTypeCompositeInfo<::SE::ContainerControl>>(s_pDefaultInstance_2028840693);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::ContainerControl*>(s_pDefaultInstance_2028840693));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_2028840693;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::ContainerControl>::s_pDefaultInstance_2028840693);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::ContainerControl>::s_pDefaultInstance_2028840693, propertyID, arrayIdx);
        }
    };

    ::SE::ContainerControl const* TTypeCompositeInfo<::SE::ContainerControl>::s_pDefaultInstance_2028840693 = nullptr;
}
