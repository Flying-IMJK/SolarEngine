...
{
    template<>
    class  TTypeCompositeInfo<::SE::Scene> final : public TypeCompositeInfo
    {
       static ::SE::Scene const* s_pDefaultInstance_18005636085922756035;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_18005636085922756035 = New<::SE::Scene>(nullptr);

            ::SE::Scene::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Scene>>(s_pDefaultInstance_18005636085922756035);
            Types::RegisterType(::SE::Scene::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Scene::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Scene*>(s_pDefaultInstance_18005636085922756035));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Scene::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Scene"));
            size = sizeof(::SE::Scene);
            alignment = alignof(::SE::Scene);
            name = SE_TEXT("Scene");
            fullName = SE_TEXT("SE::Scene");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Scene), alignof(::SE::Scene));
            return new (pMemory) ::SE::Scene(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Scene(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_18005636085922756035;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Scene>::s_pDefaultInstance_18005636085922756035);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Scene>::s_pDefaultInstance_18005636085922756035, propertyID, arrayIdx);
        }
    };

    ::SE::Scene const* TTypeCompositeInfo<::SE::Scene>::s_pDefaultInstance_18005636085922756035 = nullptr;
}
...
ScriptingTypeInitializer Scene::TypeInitializer(
    (BinaryModule*)GetBinaryModuleSERuntime(),
    StringAnsiView("SE.Scene", ARRAY_SIZE("SE.Scene") - 1),
    sizeof(::SE::Scene),
    &SceneInternal::InitRuntime,
    (ScriptingType::SpawnHandler)&::SE::Scene::Spawn,
