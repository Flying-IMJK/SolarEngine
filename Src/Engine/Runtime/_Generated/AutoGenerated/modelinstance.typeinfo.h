...
namespace SE
{
    ...
    {
       static ::SE::ModelInstance const* s_pDefaultInstance_1038293047;
    ...
    public:
        static void RegisterType()
        {
            ...
            ::SE::ModelInstance::s_pTypeInfo = New<TTypeCompositeInfo<::SE::ModelInstance>>(s_pDefaultInstance_1038293047);
    ...
    public:
        ...
        {
            return s_pDefaultInstance_1038293047;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::ModelInstance>::s_pDefaultInstance_1038293047);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::ModelInstance>::s_pDefaultInstance_1038293047, propertyID, arrayIdx);
        }
    };

    ::SE::ModelInstance const* TTypeCompositeInfo<::SE::ModelInstance>::s_pDefaultInstance_1038293047 = nullptr;
}
