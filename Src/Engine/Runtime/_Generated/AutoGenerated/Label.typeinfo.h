...
{
    template<>
    class  TTypeCompositeInfo<::SE::Label> final : public TypeCompositeInfo
    {
       static ::SE::Label const* s_pDefaultInstance_13475747489022087917;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_13475747489022087917 = New<::SE::Label>(nullptr);

            ::SE::Label::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Label>>(s_pDefaultInstance_13475747489022087917);
            Types::RegisterType(::SE::Label::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Label::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Label*>(s_pDefaultInstance_13475747489022087917));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Label::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Label"));
            size = sizeof(::SE::Label);
            alignment = alignof(::SE::Label);
            name = SE_TEXT("Label");
            fullName = SE_TEXT("SE::Label");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Label), alignof(::SE::Label));
            return new (pMemory) ::SE::Label(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Label(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_13475747489022087917;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Label>::s_pDefaultInstance_13475747489022087917);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Label>::s_pDefaultInstance_13475747489022087917, propertyID, arrayIdx);
        }
    };

    ::SE::Label const* TTypeCompositeInfo<::SE::Label>::s_pDefaultInstance_13475747489022087917 = nullptr;
}
