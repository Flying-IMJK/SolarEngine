...
{
    template<>
    class  TTypeCompositeInfo<::SE::Control> final : public TypeCompositeInfo
    {
       static ::SE::Control const* s_pDefaultInstance_6214406300345596462;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_6214406300345596462 = New<::SE::Control>(nullptr);

            ::SE::Control::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Control>>(s_pDefaultInstance_6214406300345596462);
            Types::RegisterType(::SE::Control::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Control::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Control*>(s_pDefaultInstance_6214406300345596462));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Control::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Control"));
            size = sizeof(::SE::Control);
            alignment = alignof(::SE::Control);
            name = SE_TEXT("Control");
            fullName = SE_TEXT("SE::Control");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Control), alignof(::SE::Control));
            return new (pMemory) ::SE::Control(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Control(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_6214406300345596462;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Control>::s_pDefaultInstance_6214406300345596462);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Control>::s_pDefaultInstance_6214406300345596462, propertyID, arrayIdx);
        }
    };

    ::SE::Control const* TTypeCompositeInfo<::SE::Control>::s_pDefaultInstance_6214406300345596462 = nullptr;
}
