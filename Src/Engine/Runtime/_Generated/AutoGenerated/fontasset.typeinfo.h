...
namespace SE
{
    ...
    {
       static ::SE::FontAsset const* s_pDefaultInstance_3981540872;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_3981540872 = New<::SE::FontAsset>(nullptr);

            ::SE::FontAsset::s_pTypeInfo = New<TTypeCompositeInfo<::SE::FontAsset>>(s_pDefaultInstance_3981540872);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::FontAsset*>(s_pDefaultInstance_3981540872));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_3981540872;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::FontAsset>::s_pDefaultInstance_3981540872);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::FontAsset>::s_pDefaultInstance_3981540872, propertyID, arrayIdx);
        }
    };

    ::SE::FontAsset const* TTypeCompositeInfo<::SE::FontAsset>::s_pDefaultInstance_3981540872 = nullptr;
}
