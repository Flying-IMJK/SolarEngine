...
namespace SE
{
    ...
    {
       static ::SE::MaterialBase const* s_pDefaultInstance_3667066235;
    ...
    public:
        static void RegisterType()
        {
            ...
            ::SE::MaterialBase::s_pTypeInfo = New<TTypeCompositeInfo<::SE::MaterialBase>>(s_pDefaultInstance_3667066235);
    ...
    public:
        ...
        {
            return s_pDefaultInstance_3667066235;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::MaterialBase>::s_pDefaultInstance_3667066235);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::MaterialBase>::s_pDefaultInstance_3667066235, propertyID, arrayIdx);
        }
    };

    ::SE::MaterialBase const* TTypeCompositeInfo<::SE::MaterialBase>::s_pDefaultInstance_3667066235 = nullptr;
}
