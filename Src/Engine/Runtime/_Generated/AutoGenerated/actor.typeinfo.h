...
namespace SE
{
    ...
    {
       static ::SE::Actor const* s_pDefaultInstance_1627456842;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_1627456842 = New<::SE::Actor>(nullptr);

            ::SE::Actor::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Actor>>(s_pDefaultInstance_1627456842);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Actor*>(s_pDefaultInstance_1627456842));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_1627456842;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Actor>::s_pDefaultInstance_1627456842);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Actor>::s_pDefaultInstance_1627456842, propertyID, arrayIdx);
        }
    };

    ::SE::Actor const* TTypeCompositeInfo<::SE::Actor>::s_pDefaultInstance_1627456842 = nullptr;
}
...
namespace SE
{
    ...
    {
       static ::SE::RenderActor const* s_pDefaultInstance_2831955210;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_2831955210 = New<::SE::RenderActor>(nullptr);

            ::SE::RenderActor::s_pTypeInfo = New<TTypeCompositeInfo<::SE::RenderActor>>(s_pDefaultInstance_2831955210);
        ...
        static void UnregisterType()
        {
            ...
            // Destroy default type instance
            Delete(const_cast<::SE::RenderActor*>(s_pDefaultInstance_2831955210));
    ...
    public:
        ...
        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_2831955210;
        }
        ...
        virtual bool AreAllPropertiesSetToDefault(IType const *pTypeInstance) const override
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::RenderActor>::s_pDefaultInstance_2831955210);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::RenderActor>::s_pDefaultInstance_2831955210, propertyID, arrayIdx);
        }
    };

    ::SE::RenderActor const* TTypeCompositeInfo<::SE::RenderActor>::s_pDefaultInstance_2831955210 = nullptr;
}
