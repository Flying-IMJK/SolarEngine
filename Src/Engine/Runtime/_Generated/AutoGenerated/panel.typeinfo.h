...
namespace SE
{
    ...
    {
       static ::SE::Panel const* s_pDefaultInstance_1645166913;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_1645166913 = New<::SE::Panel>(nullptr);

            ::SE::Panel::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Panel>>(s_pDefaultInstance_1645166913);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Panel*>(s_pDefaultInstance_1645166913));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_1645166913;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Panel>::s_pDefaultInstance_1645166913);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Panel>::s_pDefaultInstance_1645166913, propertyID, arrayIdx);
        }
    };

    ::SE::Panel const* TTypeCompositeInfo<::SE::Panel>::s_pDefaultInstance_1645166913 = nullptr;
}
