...
{
    template<>
    class  TTypeCompositeInfo<::SE::Image> final : public TypeCompositeInfo
    {
       static ::SE::Image const* s_pDefaultInstance_15551649207135957578;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_15551649207135957578 = New<::SE::Image>(nullptr);

            ::SE::Image::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Image>>(s_pDefaultInstance_15551649207135957578);
            Types::RegisterType(::SE::Image::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Image::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Image*>(s_pDefaultInstance_15551649207135957578));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Image::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Image"));
            size = sizeof(::SE::Image);
            alignment = alignof(::SE::Image);
            name = SE_TEXT("Image");
            fullName = SE_TEXT("SE::Image");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Image), alignof(::SE::Image));
            return new (pMemory) ::SE::Image(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Image(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_15551649207135957578;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Image>::s_pDefaultInstance_15551649207135957578);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Image>::s_pDefaultInstance_15551649207135957578, propertyID, arrayIdx);
        }
    };

    ::SE::Image const* TTypeCompositeInfo<::SE::Image>::s_pDefaultInstance_15551649207135957578 = nullptr;
}
