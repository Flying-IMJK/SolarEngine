...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE CubeTexture
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::CubeTexture> final : public TypeCompositeInfo
    {
       static ::SE::CubeTexture const* s_pDefaultInstance_9681002936699795563;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_9681002936699795563 = New<::SE::CubeTexture>(nullptr);

            ::SE::CubeTexture::s_pTypeInfo = New<TTypeCompositeInfo<::SE::CubeTexture>>(s_pDefaultInstance_9681002936699795563);
            Types::RegisterType(::SE::CubeTexture::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::CubeTexture::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::CubeTexture*>(s_pDefaultInstance_9681002936699795563));
            Delete(const_cast<TypeCompositeInfo*>(::SE::CubeTexture::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::CubeTexture"));
            size = sizeof(::SE::CubeTexture);
            alignment = alignof(::SE::CubeTexture);
            name = SE_TEXT("CubeTexture");
            fullName = SE_TEXT("SE::CubeTexture");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::CubeTexture), alignof(::SE::CubeTexture));
            return new (pMemory) ::SE::CubeTexture(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::CubeTexture(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_9681002936699795563;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::CubeTexture>::s_pDefaultInstance_9681002936699795563);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::CubeTexture>::s_pDefaultInstance_9681002936699795563, propertyID, arrayIdx);
        }
    };

    ::SE::CubeTexture const* TTypeCompositeInfo<::SE::CubeTexture>::s_pDefaultInstance_9681002936699795563 = nullptr;
}
...
ScriptingTypeInitializer CubeTexture::TypeInitializer(
    (BinaryModule*)GetBinaryModuleSERuntime(),
    StringAnsiView("SE.CubeTexture", ARRAY_SIZE("SE.CubeTexture") - 1),
    sizeof(::SE::CubeTexture),
    &CubeTextureInternal::InitRuntime,
