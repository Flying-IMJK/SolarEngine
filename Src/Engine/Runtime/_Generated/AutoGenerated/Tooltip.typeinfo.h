...
namespace SE
{
    ...
    {
       static ::SE::Tooltip const* s_pDefaultInstance_12410369628963233312;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_12410369628963233312 = New<::SE::Tooltip>(nullptr);

            ::SE::Tooltip::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Tooltip>>(s_pDefaultInstance_12410369628963233312);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Tooltip*>(s_pDefaultInstance_12410369628963233312));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_12410369628963233312;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Tooltip>::s_pDefaultInstance_12410369628963233312);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Tooltip>::s_pDefaultInstance_12410369628963233312, propertyID, arrayIdx);
        }
    };

    ::SE::Tooltip const* TTypeCompositeInfo<::SE::Tooltip>::s_pDefaultInstance_12410369628963233312 = nullptr;
}
