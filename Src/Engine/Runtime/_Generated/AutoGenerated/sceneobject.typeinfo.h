...
namespace SE
{
    ...
    {
       static ::SE::SceneObject const* s_pDefaultInstance_4177153974;
    ...
    public:
        static void RegisterType()
        {
            ...
            ::SE::SceneObject::s_pTypeInfo = New<TTypeCompositeInfo<::SE::SceneObject>>(s_pDefaultInstance_4177153974);
    ...
    public:
        ...
        {
            return s_pDefaultInstance_4177153974;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::SceneObject>::s_pDefaultInstance_4177153974);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::SceneObject>::s_pDefaultInstance_4177153974, propertyID, arrayIdx);
        }
    };

    ::SE::SceneObject const* TTypeCompositeInfo<::SE::SceneObject>::s_pDefaultInstance_4177153974 = nullptr;
}
