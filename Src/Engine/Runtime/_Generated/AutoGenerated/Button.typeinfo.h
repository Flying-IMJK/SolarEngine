...
{
    template<>
    class  TTypeCompositeInfo<::SE::Button> final : public TypeCompositeInfo
    {
       static ::SE::Button const* s_pDefaultInstance_1684683681994211489;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_1684683681994211489 = New<::SE::Button>(nullptr);

            ::SE::Button::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Button>>(s_pDefaultInstance_1684683681994211489);
            Types::RegisterType(::SE::Button::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Button::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Button*>(s_pDefaultInstance_1684683681994211489));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Button::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Button"));
            size = sizeof(::SE::Button);
            alignment = alignof(::SE::Button);
            name = SE_TEXT("Button");
            fullName = SE_TEXT("SE::Button");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Button), alignof(::SE::Button));
            return new (pMemory) ::SE::Button(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Button(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_1684683681994211489;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Button>::s_pDefaultInstance_1684683681994211489);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Button>::s_pDefaultInstance_1684683681994211489, propertyID, arrayIdx);
        }
    };

    ::SE::Button const* TTypeCompositeInfo<::SE::Button>::s_pDefaultInstance_1684683681994211489 = nullptr;
}
