...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE RootControl
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::RootControl> final : public TypeCompositeInfo
    {
       static ::SE::RootControl const* s_pDefaultInstance_8909280460316066158;
    ...
    public:
        static void RegisterType()
        {
            ...
            ::SE::RootControl::s_pTypeInfo = New<TTypeCompositeInfo<::SE::RootControl>>(s_pDefaultInstance_8909280460316066158);
            Types::RegisterType(::SE::RootControl::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::RootControl::s_pTypeInfo);
            
            Delete(const_cast<TypeCompositeInfo*>(::SE::RootControl::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::RootControl"));
            size = sizeof(::SE::RootControl);
            alignment = alignof(::SE::RootControl);
            name = SE_TEXT("RootControl");
            fullName = SE_TEXT("SE::RootControl");
        ...
        {
            return s_pDefaultInstance_8909280460316066158;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::RootControl>::s_pDefaultInstance_8909280460316066158);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::RootControl>::s_pDefaultInstance_8909280460316066158, propertyID, arrayIdx);
        }
    };

    ::SE::RootControl const* TTypeCompositeInfo<::SE::RootControl>::s_pDefaultInstance_8909280460316066158 = nullptr;
}
