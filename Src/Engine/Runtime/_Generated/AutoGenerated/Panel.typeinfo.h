...
{
    template<>
    class  TTypeCompositeInfo<::SE::Panel> final : public TypeCompositeInfo
    {
       static ::SE::Panel const* s_pDefaultInstance_17376081029061842773;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_17376081029061842773 = New<::SE::Panel>(nullptr);

            ::SE::Panel::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Panel>>(s_pDefaultInstance_17376081029061842773);
            Types::RegisterType(::SE::Panel::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Panel::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Panel*>(s_pDefaultInstance_17376081029061842773));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Panel::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Panel"));
            size = sizeof(::SE::Panel);
            alignment = alignof(::SE::Panel);
            name = SE_TEXT("Panel");
            fullName = SE_TEXT("SE::Panel");
            ...
            // Add parent info
            // Parent types
            pParentTypeInfo = ::SE::ScrollableControl::s_pTypeInfo;
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Panel), alignof(::SE::Panel));
            return new (pMemory) ::SE::Panel(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Panel(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_17376081029061842773;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Panel>::s_pDefaultInstance_17376081029061842773);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Panel>::s_pDefaultInstance_17376081029061842773, propertyID, arrayIdx);
        }
    };

    ::SE::Panel const* TTypeCompositeInfo<::SE::Panel>::s_pDefaultInstance_17376081029061842773 = nullptr;
}
