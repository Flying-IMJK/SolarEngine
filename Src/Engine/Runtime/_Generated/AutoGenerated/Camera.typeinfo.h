...
{
    template<>
    class  TTypeCompositeInfo<::SE::Camera> final : public TypeCompositeInfo
    {
       static ::SE::Camera const* s_pDefaultInstance_10983842142704242622;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_10983842142704242622 = New<::SE::Camera>(nullptr);

            ::SE::Camera::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Camera>>(s_pDefaultInstance_10983842142704242622);
            Types::RegisterType(::SE::Camera::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Camera::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Camera*>(s_pDefaultInstance_10983842142704242622));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Camera::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Camera"));
            size = sizeof(::SE::Camera);
            alignment = alignof(::SE::Camera);
            name = SE_TEXT("Camera");
            fullName = SE_TEXT("SE::Camera");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Camera), alignof(::SE::Camera));
            return new (pMemory) ::SE::Camera(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Camera(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_10983842142704242622;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Camera>::s_pDefaultInstance_10983842142704242622);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Camera>::s_pDefaultInstance_10983842142704242622, propertyID, arrayIdx);
        }
    };

    ::SE::Camera const* TTypeCompositeInfo<::SE::Camera>::s_pDefaultInstance_10983842142704242622 = nullptr;
}
...
ScriptingTypeInitializer Camera::TypeInitializer(
    (BinaryModule*)GetBinaryModuleSERuntime(),
    StringAnsiView("SE.Camera", ARRAY_SIZE("SE.Camera") - 1),
    sizeof(::SE::Camera),
    &CameraInternal::InitRuntime,
    (ScriptingType::SpawnHandler)&::SE::Camera::Spawn,
