...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE ContentStats
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::ContentStats> final : public TypeCompositeInfo
    {
       static ::SE::ContentStats const* s_pDefaultInstance_14648785177019465089;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_14648785177019465089 = New<::SE::ContentStats>(nullptr);

            ::SE::ContentStats::s_pTypeInfo = New<TTypeCompositeInfo<::SE::ContentStats>>(s_pDefaultInstance_14648785177019465089);
            Types::RegisterType(::SE::ContentStats::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::ContentStats::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::ContentStats*>(s_pDefaultInstance_14648785177019465089));
            Delete(const_cast<TypeCompositeInfo*>(::SE::ContentStats::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::ContentStats"));
            size = sizeof(::SE::ContentStats);
            alignment = alignof(::SE::ContentStats);
            name = SE_TEXT("ContentStats");
            fullName = SE_TEXT("SE::ContentStats");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::ContentStats), alignof(::SE::ContentStats));
            return new (pMemory) ::SE::ContentStats(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::ContentStats(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_14648785177019465089;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::ContentStats>::s_pDefaultInstance_14648785177019465089);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::ContentStats>::s_pDefaultInstance_14648785177019465089, propertyID, arrayIdx);
        }
    };

    ::SE::ContentStats const* TTypeCompositeInfo<::SE::ContentStats>::s_pDefaultInstance_14648785177019465089 = nullptr;
}
