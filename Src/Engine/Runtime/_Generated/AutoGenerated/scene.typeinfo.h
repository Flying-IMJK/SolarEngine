...
namespace SE
{
    ...
    {
       static ::SE::Scene const* s_pDefaultInstance_1648787039;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_1648787039 = New<::SE::Scene>(nullptr);

            ::SE::Scene::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Scene>>(s_pDefaultInstance_1648787039);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Scene*>(s_pDefaultInstance_1648787039));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_1648787039;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Scene>::s_pDefaultInstance_1648787039);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Scene>::s_pDefaultInstance_1648787039, propertyID, arrayIdx);
        }
    };

    ::SE::Scene const* TTypeCompositeInfo<::SE::Scene>::s_pDefaultInstance_1648787039 = nullptr;
}
