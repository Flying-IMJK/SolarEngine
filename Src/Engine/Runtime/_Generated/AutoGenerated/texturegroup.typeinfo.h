...
namespace SE
{
    ...
    {
       static ::SE::TextureGroup const* s_pDefaultInstance_2860878607;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_2860878607 = New<::SE::TextureGroup>(nullptr);

            ::SE::TextureGroup::s_pTypeInfo = New<TTypeCompositeInfo<::SE::TextureGroup>>(s_pDefaultInstance_2860878607);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::TextureGroup*>(s_pDefaultInstance_2860878607));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_2860878607;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::TextureGroup>::s_pDefaultInstance_2860878607);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::TextureGroup>::s_pDefaultInstance_2860878607, propertyID, arrayIdx);
        }
    };

    ::SE::TextureGroup const* TTypeCompositeInfo<::SE::TextureGroup>::s_pDefaultInstance_2860878607 = nullptr;
}
