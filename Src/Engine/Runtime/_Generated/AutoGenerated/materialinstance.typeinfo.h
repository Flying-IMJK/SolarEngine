...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE:: MaterialInstance
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::MaterialInstance> final : public TypeCompositeInfo
    {
       static ::SE::MaterialInstance const* s_pDefaultInstance_507751509;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_507751509 = New<::SE::MaterialInstance>(nullptr);

            ::SE::MaterialInstance::s_pTypeInfo = New<TTypeCompositeInfo<::SE::MaterialInstance>>(s_pDefaultInstance_507751509);
            Types::RegisterType(::SE::MaterialInstance::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::MaterialInstance::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::MaterialInstance*>(s_pDefaultInstance_507751509));
            Delete(const_cast<TypeCompositeInfo*>(::SE::MaterialInstance::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::MaterialInstance"));
            size = sizeof(::SE::MaterialInstance);
            alignment = alignof(::SE::MaterialInstance);
            name = SE_TEXT("MaterialInstance");
            fullName = SE_TEXT("SE::MaterialInstance");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::MaterialInstance), alignof(::SE::MaterialInstance));
            return new (pMemory) ::SE::MaterialInstance(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::MaterialInstance(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_507751509;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::MaterialInstance>::s_pDefaultInstance_507751509);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::MaterialInstance>::s_pDefaultInstance_507751509, propertyID, arrayIdx);
        }
    };

    ::SE::MaterialInstance const* TTypeCompositeInfo<::SE::MaterialInstance>::s_pDefaultInstance_507751509 = nullptr;
}
