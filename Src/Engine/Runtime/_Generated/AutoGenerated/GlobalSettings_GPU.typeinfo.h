...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE GPUGlobalSettings
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::GPUGlobalSettings> final : public TypeCompositeInfo
    {
       static ::SE::GPUGlobalSettings const* s_pDefaultInstance_13339529183501856827;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_13339529183501856827 = New<::SE::GPUGlobalSettings>(nullptr);

            ::SE::GPUGlobalSettings::s_pTypeInfo = New<TTypeCompositeInfo<::SE::GPUGlobalSettings>>(s_pDefaultInstance_13339529183501856827);
            Types::RegisterType(::SE::GPUGlobalSettings::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::GPUGlobalSettings::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::GPUGlobalSettings*>(s_pDefaultInstance_13339529183501856827));
            Delete(const_cast<TypeCompositeInfo*>(::SE::GPUGlobalSettings::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::GPUGlobalSettings"));
            size = sizeof(::SE::GPUGlobalSettings);
            alignment = alignof(::SE::GPUGlobalSettings);
            name = SE_TEXT("GPUGlobalSettings");
            fullName = SE_TEXT("SE::GPUGlobalSettings");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::GPUGlobalSettings), alignof(::SE::GPUGlobalSettings));
            return new (pMemory) ::SE::GPUGlobalSettings(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::GPUGlobalSettings(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_13339529183501856827;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::GPUGlobalSettings>::s_pDefaultInstance_13339529183501856827);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::GPUGlobalSettings>::s_pDefaultInstance_13339529183501856827, propertyID, arrayIdx);
        }
    };

    ::SE::GPUGlobalSettings const* TTypeCompositeInfo<::SE::GPUGlobalSettings>::s_pDefaultInstance_13339529183501856827 = nullptr;
}
