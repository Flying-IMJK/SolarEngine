...
namespace SE
{
    ...
    {
       static ::SE::CubeTexture const* s_pDefaultInstance_1483649761;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_1483649761 = New<::SE::CubeTexture>(nullptr);

            ::SE::CubeTexture::s_pTypeInfo = New<TTypeCompositeInfo<::SE::CubeTexture>>(s_pDefaultInstance_1483649761);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::CubeTexture*>(s_pDefaultInstance_1483649761));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_1483649761;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::CubeTexture>::s_pDefaultInstance_1483649761);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::CubeTexture>::s_pDefaultInstance_1483649761, propertyID, arrayIdx);
        }
    };

    ::SE::CubeTexture const* TTypeCompositeInfo<::SE::CubeTexture>::s_pDefaultInstance_1483649761 = nullptr;
}
