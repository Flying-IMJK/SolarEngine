...
namespace SE
{
    ...
    {
       static ::SE::Control const* s_pDefaultInstance_1524636274;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_1524636274 = New<::SE::Control>(nullptr);

            ::SE::Control::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Control>>(s_pDefaultInstance_1524636274);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Control*>(s_pDefaultInstance_1524636274));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_1524636274;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Control>::s_pDefaultInstance_1524636274);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Control>::s_pDefaultInstance_1524636274, propertyID, arrayIdx);
        }
    };

    ::SE::Control const* TTypeCompositeInfo<::SE::Control>::s_pDefaultInstance_1524636274 = nullptr;
}
