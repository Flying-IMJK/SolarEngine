...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE DirectionalLight
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::DirectionalLight> final : public TypeCompositeInfo
    {
       static ::SE::DirectionalLight const* s_pDefaultInstance_17767089569603398129;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_17767089569603398129 = New<::SE::DirectionalLight>(nullptr);

            ::SE::DirectionalLight::s_pTypeInfo = New<TTypeCompositeInfo<::SE::DirectionalLight>>(s_pDefaultInstance_17767089569603398129);
            Types::RegisterType(::SE::DirectionalLight::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::DirectionalLight::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::DirectionalLight*>(s_pDefaultInstance_17767089569603398129));
            Delete(const_cast<TypeCompositeInfo*>(::SE::DirectionalLight::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::DirectionalLight"));
            size = sizeof(::SE::DirectionalLight);
            alignment = alignof(::SE::DirectionalLight);
            name = SE_TEXT("DirectionalLight");
            fullName = SE_TEXT("SE::DirectionalLight");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::DirectionalLight), alignof(::SE::DirectionalLight));
            return new (pMemory) ::SE::DirectionalLight(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::DirectionalLight(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_17767089569603398129;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::DirectionalLight>::s_pDefaultInstance_17767089569603398129);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::DirectionalLight>::s_pDefaultInstance_17767089569603398129, propertyID, arrayIdx);
        }
    };

    ::SE::DirectionalLight const* TTypeCompositeInfo<::SE::DirectionalLight>::s_pDefaultInstance_17767089569603398129 = nullptr;
}
...
namespace SE
{
class DirectionalLightInternal
{
public:
...
ScriptingTypeInitializer DirectionalLight::TypeInitializer(
    (BinaryModule*)GetBinaryModuleSERuntime(),
    StringAnsiView("SE.DirectionalLight", ARRAY_SIZE("SE.DirectionalLight") - 1),
    sizeof(::SE::DirectionalLight),
    &DirectionalLightInternal::InitRuntime,
    (ScriptingType::SpawnHandler)&::SE::DirectionalLight::Spawn,
