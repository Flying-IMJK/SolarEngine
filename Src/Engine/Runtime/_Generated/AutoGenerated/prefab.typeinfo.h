...
namespace SE
{
    ...
    {
       static ::SE::Prefab const* s_pDefaultInstance_2770738625;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_2770738625 = New<::SE::Prefab>(nullptr);

            ::SE::Prefab::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Prefab>>(s_pDefaultInstance_2770738625);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Prefab*>(s_pDefaultInstance_2770738625));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_2770738625;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Prefab>::s_pDefaultInstance_2770738625);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Prefab>::s_pDefaultInstance_2770738625, propertyID, arrayIdx);
        }
    };

    ::SE::Prefab const* TTypeCompositeInfo<::SE::Prefab>::s_pDefaultInstance_2770738625 = nullptr;
}
