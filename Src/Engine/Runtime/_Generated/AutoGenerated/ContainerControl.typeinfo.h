...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE ContainerControl
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::ContainerControl> final : public TypeCompositeInfo
    {
       static ::SE::ContainerControl const* s_pDefaultInstance_6520122861330313661;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_6520122861330313661 = New<::SE::ContainerControl>(nullptr);

            ::SE::ContainerControl::s_pTypeInfo = New<TTypeCompositeInfo<::SE::ContainerControl>>(s_pDefaultInstance_6520122861330313661);
            Types::RegisterType(::SE::ContainerControl::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::ContainerControl::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::ContainerControl*>(s_pDefaultInstance_6520122861330313661));
            Delete(const_cast<TypeCompositeInfo*>(::SE::ContainerControl::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::ContainerControl"));
            size = sizeof(::SE::ContainerControl);
            alignment = alignof(::SE::ContainerControl);
            name = SE_TEXT("ContainerControl");
            fullName = SE_TEXT("SE::ContainerControl");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::ContainerControl), alignof(::SE::ContainerControl));
            return new (pMemory) ::SE::ContainerControl(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::ContainerControl(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_6520122861330313661;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::ContainerControl>::s_pDefaultInstance_6520122861330313661);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::ContainerControl>::s_pDefaultInstance_6520122861330313661, propertyID, arrayIdx);
        }
    };

    ::SE::ContainerControl const* TTypeCompositeInfo<::SE::ContainerControl>::s_pDefaultInstance_6520122861330313661 = nullptr;
}
