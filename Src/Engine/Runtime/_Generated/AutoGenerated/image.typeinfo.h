...
namespace SE
{
    ...
    {
       static ::SE::Image const* s_pDefaultInstance_1637282612;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_1637282612 = New<::SE::Image>(nullptr);

            ::SE::Image::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Image>>(s_pDefaultInstance_1637282612);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Image*>(s_pDefaultInstance_1637282612));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_1637282612;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Image>::s_pDefaultInstance_1637282612);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Image>::s_pDefaultInstance_1637282612, propertyID, arrayIdx);
        }
    };

    ::SE::Image const* TTypeCompositeInfo<::SE::Image>::s_pDefaultInstance_1637282612 = nullptr;
}
