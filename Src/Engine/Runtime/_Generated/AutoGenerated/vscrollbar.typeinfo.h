...
namespace SE
{
    ...
    {
       static ::SE::VScrollBar const* s_pDefaultInstance_3297741227;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_3297741227 = New<::SE::VScrollBar>(nullptr);

            ::SE::VScrollBar::s_pTypeInfo = New<TTypeCompositeInfo<::SE::VScrollBar>>(s_pDefaultInstance_3297741227);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::VScrollBar*>(s_pDefaultInstance_3297741227));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_3297741227;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::VScrollBar>::s_pDefaultInstance_3297741227);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::VScrollBar>::s_pDefaultInstance_3297741227, propertyID, arrayIdx);
        }
    };

    ::SE::VScrollBar const* TTypeCompositeInfo<::SE::VScrollBar>::s_pDefaultInstance_3297741227 = nullptr;
}
