...
namespace SE
{
class GPUPipelineStateInternal
{
public:
...
ScriptingTypeInitializer GPUPipelineState::TypeInitializer(
    (BinaryModule*)GetBinaryModuleSERuntime(),
    StringAnsiView("SE.GPUPipelineState", ARRAY_SIZE("SE.GPUPipelineState") - 1),
    sizeof(::SE::GPUPipelineState),
    &GPUPipelineStateInternal::InitRuntime,
    (ScriptingType::SpawnHandler)&::SE::GPUPipelineState::Spawn,
