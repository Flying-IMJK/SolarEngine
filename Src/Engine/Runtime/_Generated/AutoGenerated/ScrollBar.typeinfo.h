...
namespace SE
{
    ...
    {
       static ::SE::ScrollBar const* s_pDefaultInstance_6541648910625238409;
    ...
    public:
        static void RegisterType()
        {
            ...
            ::SE::ScrollBar::s_pTypeInfo = New<TTypeCompositeInfo<::SE::ScrollBar>>(s_pDefaultInstance_6541648910625238409);
    ...
    public:
        ...
        {
            return s_pDefaultInstance_6541648910625238409;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::ScrollBar>::s_pDefaultInstance_6541648910625238409);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::ScrollBar>::s_pDefaultInstance_6541648910625238409, propertyID, arrayIdx);
        }
    };

    ::SE::ScrollBar const* TTypeCompositeInfo<::SE::ScrollBar>::s_pDefaultInstance_6541648910625238409 = nullptr;
}
