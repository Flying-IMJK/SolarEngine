...
namespace SE
{
    ...
    {
       static ::SE::HScrollBar const* s_pDefaultInstance_7316791940347843215;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_7316791940347843215 = New<::SE::HScrollBar>(nullptr);

            ::SE::HScrollBar::s_pTypeInfo = New<TTypeCompositeInfo<::SE::HScrollBar>>(s_pDefaultInstance_7316791940347843215);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::HScrollBar*>(s_pDefaultInstance_7316791940347843215));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_7316791940347843215;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::HScrollBar>::s_pDefaultInstance_7316791940347843215);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::HScrollBar>::s_pDefaultInstance_7316791940347843215, propertyID, arrayIdx);
        }
    };

    ::SE::HScrollBar const* TTypeCompositeInfo<::SE::HScrollBar>::s_pDefaultInstance_7316791940347843215 = nullptr;
}
