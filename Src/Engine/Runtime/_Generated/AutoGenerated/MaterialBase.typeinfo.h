...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE MaterialBase
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::MaterialBase> final : public TypeCompositeInfo
    {
       static ::SE::MaterialBase const* s_pDefaultInstance_17327364129321104565;
    ...
    public:
        static void RegisterType()
        {
            ...
            ::SE::MaterialBase::s_pTypeInfo = New<TTypeCompositeInfo<::SE::MaterialBase>>(s_pDefaultInstance_17327364129321104565);
            Types::RegisterType(::SE::MaterialBase::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::MaterialBase::s_pTypeInfo);
            
            Delete(const_cast<TypeCompositeInfo*>(::SE::MaterialBase::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::MaterialBase"));
            size = sizeof(::SE::MaterialBase);
            alignment = alignof(::SE::MaterialBase);
            name = SE_TEXT("MaterialBase");
            fullName = SE_TEXT("SE::MaterialBase");
        ...
        {
            return s_pDefaultInstance_17327364129321104565;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::MaterialBase>::s_pDefaultInstance_17327364129321104565);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::MaterialBase>::s_pDefaultInstance_17327364129321104565, propertyID, arrayIdx);
        }
    };

    ::SE::MaterialBase const* TTypeCompositeInfo<::SE::MaterialBase>::s_pDefaultInstance_17327364129321104565 = nullptr;
}
...
ScriptingTypeInitializer MaterialBase::TypeInitializer(
    (BinaryModule*)GetBinaryModuleSERuntime(),
    StringAnsiView("SE.MaterialBase", ARRAY_SIZE("SE.MaterialBase") - 1),
    sizeof(::SE::MaterialBase),
    &MaterialBaseInternal::InitRuntime,
