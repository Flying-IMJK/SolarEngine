...
namespace SE
{
    ...
    {
       static ::SE::Light const* s_pDefaultInstance_1640703209;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_1640703209 = New<::SE::Light>(nullptr);

            ::SE::Light::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Light>>(s_pDefaultInstance_1640703209);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Light*>(s_pDefaultInstance_1640703209));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_1640703209;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Light>::s_pDefaultInstance_1640703209);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Light>::s_pDefaultInstance_1640703209, propertyID, arrayIdx);
        }
    };

    ::SE::Light const* TTypeCompositeInfo<::SE::Light>::s_pDefaultInstance_1640703209 = nullptr;
}
...
namespace SE
{
    ...
    {
       static ::SE::LightWithShadow const* s_pDefaultInstance_162854315;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_162854315 = New<::SE::LightWithShadow>(nullptr);

            ::SE::LightWithShadow::s_pTypeInfo = New<TTypeCompositeInfo<::SE::LightWithShadow>>(s_pDefaultInstance_162854315);
        ...
        static void UnregisterType()
        {
            ...
            // Destroy default type instance
            Delete(const_cast<::SE::LightWithShadow*>(s_pDefaultInstance_162854315));
    ...
    public:
        ...
        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_162854315;
        }
        ...
        virtual bool AreAllPropertiesSetToDefault(IType const *pTypeInstance) const override
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::LightWithShadow>::s_pDefaultInstance_162854315);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::LightWithShadow>::s_pDefaultInstance_162854315, propertyID, arrayIdx);
        }
    };

    ::SE::LightWithShadow const* TTypeCompositeInfo<::SE::LightWithShadow>::s_pDefaultInstance_162854315 = nullptr;
}
