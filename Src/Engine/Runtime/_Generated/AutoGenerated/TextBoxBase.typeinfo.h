...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE TextBoxBase
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::TextBoxBase> final : public TypeCompositeInfo
    {
       static ::SE::TextBoxBase const* s_pDefaultInstance_16262267352107648246;
    ...
    public:
        static void RegisterType()
        {
            ...
            ::SE::TextBoxBase::s_pTypeInfo = New<TTypeCompositeInfo<::SE::TextBoxBase>>(s_pDefaultInstance_16262267352107648246);
            Types::RegisterType(::SE::TextBoxBase::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::TextBoxBase::s_pTypeInfo);
            
            Delete(const_cast<TypeCompositeInfo*>(::SE::TextBoxBase::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::TextBoxBase"));
            size = sizeof(::SE::TextBoxBase);
            alignment = alignof(::SE::TextBoxBase);
            name = SE_TEXT("TextBoxBase");
            fullName = SE_TEXT("SE::TextBoxBase");
        ...
        {
            return s_pDefaultInstance_16262267352107648246;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::TextBoxBase>::s_pDefaultInstance_16262267352107648246);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::TextBoxBase>::s_pDefaultInstance_16262267352107648246, propertyID, arrayIdx);
        }
    };

    ::SE::TextBoxBase const* TTypeCompositeInfo<::SE::TextBoxBase>::s_pDefaultInstance_16262267352107648246 = nullptr;
}
