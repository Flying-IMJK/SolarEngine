...
namespace SE
{
    ...
    {
       static ::SE::GPUBufferDescription const* s_pDefaultInstance_3790654107;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_3790654107 = New<::SE::GPUBufferDescription>(nullptr);

            ::SE::GPUBufferDescription::s_pTypeInfo = New<TTypeCompositeInfo<::SE::GPUBufferDescription>>(s_pDefaultInstance_3790654107);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::GPUBufferDescription*>(s_pDefaultInstance_3790654107));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_3790654107;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::GPUBufferDescription>::s_pDefaultInstance_3790654107);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::GPUBufferDescription>::s_pDefaultInstance_3790654107, propertyID, arrayIdx);
        }
    };

    ::SE::GPUBufferDescription const* TTypeCompositeInfo<::SE::GPUBufferDescription>::s_pDefaultInstance_3790654107 = nullptr;
}
