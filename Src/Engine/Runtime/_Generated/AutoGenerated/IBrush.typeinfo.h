...
{
    template<>
    class  TTypeCompositeInfo<::SE::IBrush> final : public TypeCompositeInfo
    {
       static ::SE::IBrush const* s_pDefaultInstance_15413372031090016420;
    ...
    public:
        static void RegisterType()
        {
            ...
            ::SE::IBrush::s_pTypeInfo = New<TTypeCompositeInfo<::SE::IBrush>>(s_pDefaultInstance_15413372031090016420);
            Types::RegisterType(::SE::IBrush::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::IBrush::s_pTypeInfo);
            
            Delete(const_cast<TypeCompositeInfo*>(::SE::IBrush::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::IBrush"));
            size = sizeof(::SE::IBrush);
            alignment = alignof(::SE::IBrush);
            name = SE_TEXT("IBrush");
            fullName = SE_TEXT("SE::IBrush");
        ...
        {
            return s_pDefaultInstance_15413372031090016420;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::IBrush>::s_pDefaultInstance_15413372031090016420);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::IBrush>::s_pDefaultInstance_15413372031090016420, propertyID, arrayIdx);
        }
    };

    ::SE::IBrush const* TTypeCompositeInfo<::SE::IBrush>::s_pDefaultInstance_15413372031090016420 = nullptr;
}
