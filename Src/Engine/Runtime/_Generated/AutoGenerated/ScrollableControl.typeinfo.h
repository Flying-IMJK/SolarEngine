...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE ScrollableControl
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::ScrollableControl> final : public TypeCompositeInfo
    {
       static ::SE::ScrollableControl const* s_pDefaultInstance_5112138384579302521;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_5112138384579302521 = New<::SE::ScrollableControl>(nullptr);

            ::SE::ScrollableControl::s_pTypeInfo = New<TTypeCompositeInfo<::SE::ScrollableControl>>(s_pDefaultInstance_5112138384579302521);
            Types::RegisterType(::SE::ScrollableControl::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::ScrollableControl::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::ScrollableControl*>(s_pDefaultInstance_5112138384579302521));
            Delete(const_cast<TypeCompositeInfo*>(::SE::ScrollableControl::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::ScrollableControl"));
            size = sizeof(::SE::ScrollableControl);
            alignment = alignof(::SE::ScrollableControl);
            name = SE_TEXT("ScrollableControl");
            fullName = SE_TEXT("SE::ScrollableControl");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::ScrollableControl), alignof(::SE::ScrollableControl));
            return new (pMemory) ::SE::ScrollableControl(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::ScrollableControl(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_5112138384579302521;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::ScrollableControl>::s_pDefaultInstance_5112138384579302521);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::ScrollableControl>::s_pDefaultInstance_5112138384579302521, propertyID, arrayIdx);
        }
    };

    ::SE::ScrollableControl const* TTypeCompositeInfo<::SE::ScrollableControl>::s_pDefaultInstance_5112138384579302521 = nullptr;
}
