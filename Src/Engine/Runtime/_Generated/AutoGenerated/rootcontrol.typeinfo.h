...
namespace SE
{
    ...
    {
       static ::SE::RootControl const* s_pDefaultInstance_3435900022;
    ...
    public:
        static void RegisterType()
        {
            ...
            ::SE::RootControl::s_pTypeInfo = New<TTypeCompositeInfo<::SE::RootControl>>(s_pDefaultInstance_3435900022);
    ...
    public:
        ...
        {
            return s_pDefaultInstance_3435900022;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::RootControl>::s_pDefaultInstance_3435900022);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::RootControl>::s_pDefaultInstance_3435900022, propertyID, arrayIdx);
        }
    };

    ::SE::RootControl const* TTypeCompositeInfo<::SE::RootControl>::s_pDefaultInstance_3435900022 = nullptr;
}
