...
namespace SE
{
    ...
    {
       static ::SE::DirectionalLight const* s_pDefaultInstance_3629024119;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_3629024119 = New<::SE::DirectionalLight>(nullptr);

            ::SE::DirectionalLight::s_pTypeInfo = New<TTypeCompositeInfo<::SE::DirectionalLight>>(s_pDefaultInstance_3629024119);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::DirectionalLight*>(s_pDefaultInstance_3629024119));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_3629024119;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::DirectionalLight>::s_pDefaultInstance_3629024119);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::DirectionalLight>::s_pDefaultInstance_3629024119, propertyID, arrayIdx);
        }
    };

    ::SE::DirectionalLight const* TTypeCompositeInfo<::SE::DirectionalLight>::s_pDefaultInstance_3629024119 = nullptr;
}
