...
namespace SE
{
    ...
    {
       static ::SE::Shader const* s_pDefaultInstance_12808215627302104792;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_12808215627302104792 = New<::SE::Shader>(nullptr);

            ::SE::Shader::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Shader>>(s_pDefaultInstance_12808215627302104792);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Shader*>(s_pDefaultInstance_12808215627302104792));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_12808215627302104792;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Shader>::s_pDefaultInstance_12808215627302104792);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Shader>::s_pDefaultInstance_12808215627302104792, propertyID, arrayIdx);
        }
    };

    ::SE::Shader const* TTypeCompositeInfo<::SE::Shader>::s_pDefaultInstance_12808215627302104792 = nullptr;
}
...
ScriptingTypeInitializer Shader::TypeInitializer(
    (BinaryModule*)GetBinaryModuleSERuntime(),
    StringAnsiView("SE.Shader", ARRAY_SIZE("SE.Shader") - 1),
    sizeof(::SE::Shader),
    &ShaderInternal::InitRuntime,
