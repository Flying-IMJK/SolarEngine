...
{
    template<>
    class  TTypeCompositeInfo<::SE::TextBox> final : public TypeCompositeInfo
    {
       static ::SE::TextBox const* s_pDefaultInstance_3679095753747301099;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_3679095753747301099 = New<::SE::TextBox>(nullptr);

            ::SE::TextBox::s_pTypeInfo = New<TTypeCompositeInfo<::SE::TextBox>>(s_pDefaultInstance_3679095753747301099);
            Types::RegisterType(::SE::TextBox::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::TextBox::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::TextBox*>(s_pDefaultInstance_3679095753747301099));
            Delete(const_cast<TypeCompositeInfo*>(::SE::TextBox::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::TextBox"));
            size = sizeof(::SE::TextBox);
            alignment = alignof(::SE::TextBox);
            name = SE_TEXT("TextBox");
            fullName = SE_TEXT("SE::TextBox");
            ...
            // Add parent info
            // Parent types
            pParentTypeInfo = ::SE::TextBoxBase::s_pTypeInfo;
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::TextBox), alignof(::SE::TextBox));
            return new (pMemory) ::SE::TextBox(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::TextBox(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_3679095753747301099;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::TextBox>::s_pDefaultInstance_3679095753747301099);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::TextBox>::s_pDefaultInstance_3679095753747301099, propertyID, arrayIdx);
        }
    };

    ::SE::TextBox const* TTypeCompositeInfo<::SE::TextBox>::s_pDefaultInstance_3679095753747301099 = nullptr;
}
