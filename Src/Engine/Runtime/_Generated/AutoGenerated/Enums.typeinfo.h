...
namespace SE
{
class CursorLockModeInternal
{
public:
    static ScriptingType::EnumItem Items[];
};

ScriptingType::EnumItem CursorLockModeInternal::Items[] = {
    { (uint64)::SE::CursorLockMode::None, "None" },
    { (uint64)::SE::CursorLockMode::Locked, "Locked" },
    { (uint64)::SE::CursorLockMode::Clipped, "Clipped" },
    { 0, nullptr }
};

inline ScriptingTypeInitializer CursorLockMode_TypeInitializer(
    (BinaryModule*)GetBinaryModuleSERuntime(),
    StringAnsiView("SE::CursorLockMode", ARRAY_SIZE("SE::CursorLockMode") - 1),
    sizeof(::SE::CursorLockMode),
    StableID::Generate<::SE::CursorLockMode>(),
    CursorLockModeInternal::Items
);

}
namespace SE
{
class MouseButtonInternal
{
public:
    static ScriptingType::EnumItem Items[];
};

ScriptingType::EnumItem MouseButtonInternal::Items[] = {
    { (uint64)::SE::MouseButton::None, "None" },
    { (uint64)::SE::MouseButton::Left, "Left" },
    { (uint64)::SE::MouseButton::Middle, "Middle" },
    { (uint64)::SE::MouseButton::Right, "Right" },
    { (uint64)::SE::MouseButton::Extended1, "Extended1" },
    { (uint64)::SE::MouseButton::Extended2, "Extended2" },
    { (uint64)::SE::MouseButton::MAX, "MAX" },
    { 0, nullptr }
};

inline ScriptingTypeInitializer MouseButton_TypeInitializer(
    (BinaryModule*)GetBinaryModuleSERuntime(),
    StringAnsiView("SE::MouseButton", ARRAY_SIZE("SE::MouseButton") - 1),
    sizeof(::SE::MouseButton),
    StableID::Generate<::SE::MouseButton>(),
    MouseButtonInternal::Items
);

}
namespace SE
{
class GamepadAxisInternal
{
public:
    static ScriptingType::EnumItem Items[];
};

ScriptingType::EnumItem GamepadAxisInternal::Items[] = {
    { (uint64)::SE::GamepadAxis::None, "None" },
    { (uint64)::SE::GamepadAxis::LeftStickX, "LeftStickX" },
    { (uint64)::SE::GamepadAxis::LeftStickY, "LeftStickY" },
    { (uint64)::SE::GamepadAxis::RightStickX, "RightStickX" },
    { (uint64)::SE::GamepadAxis::RightStickY, "RightStickY" },
    { (uint64)::SE::GamepadAxis::LeftTrigger, "LeftTrigger" },
    { (uint64)::SE::GamepadAxis::RightTrigger, "RightTrigger" },
    { (uint64)::SE::GamepadAxis::MAX, "MAX" },
    { 0, nullptr }
};

inline ScriptingTypeInitializer GamepadAxis_TypeInitializer(
    (BinaryModule*)GetBinaryModuleSERuntime(),
    StringAnsiView("SE::GamepadAxis", ARRAY_SIZE("SE::GamepadAxis") - 1),
    sizeof(::SE::GamepadAxis),
    StableID::Generate<::SE::GamepadAxis>(),
    GamepadAxisInternal::Items
);

}
namespace SE
{
class GamepadButtonInternal
{
public:
    static ScriptingType::EnumItem Items[];
};

ScriptingType::EnumItem GamepadButtonInternal::Items[] = {
    { (uint64)::SE::GamepadButton::None, "None" },
    { (uint64)::SE::GamepadButton::DPadUp, "DPadUp" },
    { (uint64)::SE::GamepadButton::DPadDown, "DPadDown" },
    { (uint64)::SE::GamepadButton::DPadLeft, "DPadLeft" },
    { (uint64)::SE::GamepadButton::DPadRight, "DPadRight" },
    { (uint64)::SE::GamepadButton::Start, "Start" },
    { (uint64)::SE::GamepadButton::Back, "Back" },
    { (uint64)::SE::GamepadButton::LeftThumb, "LeftThumb" },
    { (uint64)::SE::GamepadButton::RightThumb, "RightThumb" },
    { (uint64)::SE::GamepadButton::LeftShoulder, "LeftShoulder" },
    { (uint64)::SE::GamepadButton::RightShoulder, "RightShoulder" },
    { (uint64)::SE::GamepadButton::LeftTrigger, "LeftTrigger" },
    { (uint64)::SE::GamepadButton::RightTrigger, "RightTrigger" },
    { (uint64)::SE::GamepadButton::A, "A" },
    { (uint64)::SE::GamepadButton::B, "B" },
    { (uint64)::SE::GamepadButton::X, "X" },
    { (uint64)::SE::GamepadButton::Y, "Y" },
    { (uint64)::SE::GamepadButton::LeftStickUp, "LeftStickUp" },
    { (uint64)::SE::GamepadButton::LeftStickDown, "LeftStickDown" },
    { (uint64)::SE::GamepadButton::LeftStickLeft, "LeftStickLeft" },
    { (uint64)::SE::GamepadButton::LeftStickRight, "LeftStickRight" },
    { (uint64)::SE::GamepadButton::RightStickUp, "RightStickUp" },
    { (uint64)::SE::GamepadButton::RightStickDown, "RightStickDown" },
    { (uint64)::SE::GamepadButton::RightStickLeft, "RightStickLeft" },
    { (uint64)::SE::GamepadButton::RightStickRight, "RightStickRight" },
    { (uint64)::SE::GamepadButton::MAX, "MAX" },
    { 0, nullptr }
};

inline ScriptingTypeInitializer GamepadButton_TypeInitializer(
    (BinaryModule*)GetBinaryModuleSERuntime(),
    StringAnsiView("SE::GamepadButton", ARRAY_SIZE("SE::GamepadButton") - 1),
    sizeof(::SE::GamepadButton),
    StableID::Generate<::SE::GamepadButton>(),
    GamepadButtonInternal::Items
);

}
namespace SE
{
class InputActionModeInternal
{
public:
    static ScriptingType::EnumItem Items[];
};

ScriptingType::EnumItem InputActionModeInternal::Items[] = {
    { (uint64)::SE::InputActionMode::Pressing, "Pressing" },
    { (uint64)::SE::InputActionMode::Press, "Press" },
    { (uint64)::SE::InputActionMode::Release, "Release" },
    { 0, nullptr }
};

inline ScriptingTypeInitializer InputActionMode_TypeInitializer(
    (BinaryModule*)GetBinaryModuleSERuntime(),
    StringAnsiView("SE::InputActionMode", ARRAY_SIZE("SE::InputActionMode") - 1),
    sizeof(::SE::InputActionMode),
    StableID::Generate<::SE::InputActionMode>(),
    InputActionModeInternal::Items
);

}
namespace SE
{
class InputActionStateInternal
{
public:
    static ScriptingType::EnumItem Items[];
};

ScriptingType::EnumItem InputActionStateInternal::Items[] = {
    { (uint64)::SE::InputActionState::None, "None" },
    { (uint64)::SE::InputActionState::Waiting, "Waiting" },
    { (uint64)::SE::InputActionState::Pressing, "Pressing" },
    { (uint64)::SE::InputActionState::Press, "Press" },
    { (uint64)::SE::InputActionState::Release, "Release" },
    { 0, nullptr }
};

inline ScriptingTypeInitializer InputActionState_TypeInitializer(
    (BinaryModule*)GetBinaryModuleSERuntime(),
    StringAnsiView("SE::InputActionState", ARRAY_SIZE("SE::InputActionState") - 1),
    sizeof(::SE::InputActionState),
    StableID::Generate<::SE::InputActionState>(),
    InputActionStateInternal::Items
);

}
namespace SE
{
class InputGamepadIndexInternal
{
public:
    static ScriptingType::EnumItem Items[];
};

ScriptingType::EnumItem InputGamepadIndexInternal::Items[] = {
    { (uint64)::SE::InputGamepadIndex::All, "All" },
    { (uint64)::SE::InputGamepadIndex::Gamepad0, "Gamepad0" },
    { (uint64)::SE::InputGamepadIndex::Gamepad1, "Gamepad1" },
    { (uint64)::SE::InputGamepadIndex::Gamepad2, "Gamepad2" },
    { (uint64)::SE::InputGamepadIndex::Gamepad3, "Gamepad3" },
    { (uint64)::SE::InputGamepadIndex::Gamepad4, "Gamepad4" },
    { (uint64)::SE::InputGamepadIndex::Gamepad5, "Gamepad5" },
    { 0, nullptr }
};

inline ScriptingTypeInitializer InputGamepadIndex_TypeInitializer(
    (BinaryModule*)GetBinaryModuleSERuntime(),
    StringAnsiView("SE::InputGamepadIndex", ARRAY_SIZE("SE::InputGamepadIndex") - 1),
    sizeof(::SE::InputGamepadIndex),
    StableID::Generate<::SE::InputGamepadIndex>(),
    InputGamepadIndexInternal::Items
);

}
namespace SE
{
class InputAxisTypeInternal
{
public:
    static ScriptingType::EnumItem Items[];
};

ScriptingType::EnumItem InputAxisTypeInternal::Items[] = {
    { (uint64)::SE::InputAxisType::MouseX, "MouseX" },
    { (uint64)::SE::InputAxisType::MouseY, "MouseY" },
    { (uint64)::SE::InputAxisType::MouseWheel, "MouseWheel" },
    { (uint64)::SE::InputAxisType::GamepadLeftStickX, "GamepadLeftStickX" },
    { (uint64)::SE::InputAxisType::GamepadLeftStickY, "GamepadLeftStickY" },
    { (uint64)::SE::InputAxisType::GamepadRightStickX, "GamepadRightStickX" },
    { (uint64)::SE::InputAxisType::GamepadRightStickY, "GamepadRightStickY" },
    { (uint64)::SE::InputAxisType::GamepadLeftTrigger, "GamepadLeftTrigger" },
    { (uint64)::SE::InputAxisType::GamepadRightTrigger, "GamepadRightTrigger" },
    { (uint64)::SE::InputAxisType::KeyboardOnly, "KeyboardOnly" },
    { (uint64)::SE::InputAxisType::GamepadDPadX, "GamepadDPadX" },
    { (uint64)::SE::InputAxisType::GamepadDPadY, "GamepadDPadY" },
    { 0, nullptr }
};

inline ScriptingTypeInitializer InputAxisType_TypeInitializer(
    (BinaryModule*)GetBinaryModuleSERuntime(),
    StringAnsiView("SE::InputAxisType", ARRAY_SIZE("SE::InputAxisType") - 1),
    sizeof(::SE::InputAxisType),
    StableID::Generate<::SE::InputAxisType>(),
    InputAxisTypeInternal::Items
);
