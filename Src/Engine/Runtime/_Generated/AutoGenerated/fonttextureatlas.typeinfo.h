...
namespace SE
{
    ...
    {
       static ::SE::FontTextureAtlas const* s_pDefaultInstance_3550967246;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_3550967246 = New<::SE::FontTextureAtlas>(nullptr);

            ::SE::FontTextureAtlas::s_pTypeInfo = New<TTypeCompositeInfo<::SE::FontTextureAtlas>>(s_pDefaultInstance_3550967246);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::FontTextureAtlas*>(s_pDefaultInstance_3550967246));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_3550967246;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::FontTextureAtlas>::s_pDefaultInstance_3550967246);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::FontTextureAtlas>::s_pDefaultInstance_3550967246, propertyID, arrayIdx);
        }
    };

    ::SE::FontTextureAtlas const* TTypeCompositeInfo<::SE::FontTextureAtlas>::s_pDefaultInstance_3550967246 = nullptr;
}
