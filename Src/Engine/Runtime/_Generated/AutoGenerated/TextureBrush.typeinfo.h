...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE TextureBrush
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::TextureBrush> final : public TypeCompositeInfo
    {
       static ::SE::TextureBrush const* s_pDefaultInstance_5046703024518027860;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_5046703024518027860 = New<::SE::TextureBrush>(nullptr);

            ::SE::TextureBrush::s_pTypeInfo = New<TTypeCompositeInfo<::SE::TextureBrush>>(s_pDefaultInstance_5046703024518027860);
            Types::RegisterType(::SE::TextureBrush::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::TextureBrush::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::TextureBrush*>(s_pDefaultInstance_5046703024518027860));
            Delete(const_cast<TypeCompositeInfo*>(::SE::TextureBrush::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::TextureBrush"));
            size = sizeof(::SE::TextureBrush);
            alignment = alignof(::SE::TextureBrush);
            name = SE_TEXT("TextureBrush");
            fullName = SE_TEXT("SE::TextureBrush");
            ...
            // Add parent info
            // Parent types
            pParentTypeInfo = ::SE::IBrush::s_pTypeInfo;
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::TextureBrush), alignof(::SE::TextureBrush));
            return new (pMemory) ::SE::TextureBrush(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::TextureBrush(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_5046703024518027860;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::TextureBrush>::s_pDefaultInstance_5046703024518027860);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::TextureBrush>::s_pDefaultInstance_5046703024518027860, propertyID, arrayIdx);
        }
    };

    ::SE::TextureBrush const* TTypeCompositeInfo<::SE::TextureBrush>::s_pDefaultInstance_5046703024518027860 = nullptr;
}
