...
ScriptingTypeInitializer GPUResourceView::TypeInitializer(
    (BinaryModule*)GetBinaryModuleSERuntime(),
    StringAnsiView("SE.GPUResourceView", ARRAY_SIZE("SE.GPUResourceView") - 1),
    sizeof(::SE::GPUResourceView),
    &GPUResourceViewInternal::InitRuntime,
...
ScriptingTypeInitializer GPUResource::TypeInitializer(
    (BinaryModule*)GetBinaryModuleSERuntime(),
    StringAnsiView("SE.GPUResource", ARRAY_SIZE("SE.GPUResource") - 1),
    sizeof(::SE::GPUResource),
    &GPUResourceInternal::InitRuntime,
    &ScriptingType::DefaultSpawn, 
    &::SE::ScriptingObject::TypeInitializer,
    nullptr,
    nullptr
