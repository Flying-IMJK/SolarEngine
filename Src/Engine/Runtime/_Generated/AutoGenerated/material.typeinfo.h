...
namespace SE
{
    ...
    {
       static ::SE::Material const* s_pDefaultInstance_3367358624;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_3367358624 = New<::SE::Material>(nullptr);

            ::SE::Material::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Material>>(s_pDefaultInstance_3367358624);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Material*>(s_pDefaultInstance_3367358624));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_3367358624;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Material>::s_pDefaultInstance_3367358624);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Material>::s_pDefaultInstance_3367358624, propertyID, arrayIdx);
        }
    };

    ::SE::Material const* TTypeCompositeInfo<::SE::Material>::s_pDefaultInstance_3367358624 = nullptr;
}
