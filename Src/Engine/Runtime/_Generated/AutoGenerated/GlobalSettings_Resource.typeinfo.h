...
//-------------------------------------------------------------------------
// TypeCompositeInfo: SE ResourceGlobalSettings
//-------------------------------------------------------------------------
...
{
    template<>
    class  TTypeCompositeInfo<::SE::ResourceGlobalSettings> final : public TypeCompositeInfo
    {
       static ::SE::ResourceGlobalSettings const* s_pDefaultInstance_4617877992155457339;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_4617877992155457339 = New<::SE::ResourceGlobalSettings>(nullptr);

            ::SE::ResourceGlobalSettings::s_pTypeInfo = New<TTypeCompositeInfo<::SE::ResourceGlobalSettings>>(s_pDefaultInstance_4617877992155457339);
            Types::RegisterType(::SE::ResourceGlobalSettings::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::ResourceGlobalSettings::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::ResourceGlobalSettings*>(s_pDefaultInstance_4617877992155457339));
            Delete(const_cast<TypeCompositeInfo*>(::SE::ResourceGlobalSettings::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::ResourceGlobalSettings"));
            size = sizeof(::SE::ResourceGlobalSettings);
            alignment = alignof(::SE::ResourceGlobalSettings);
            name = SE_TEXT("ResourceGlobalSettings");
            fullName = SE_TEXT("SE::ResourceGlobalSettings");
            ...
            // Add parent info
            // Parent types
            pParentTypeInfo = ::SE::GlobalSettings::s_pTypeInfo;
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::ResourceGlobalSettings), alignof(::SE::ResourceGlobalSettings));
            return new (pMemory) ::SE::ResourceGlobalSettings(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::ResourceGlobalSettings(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_4617877992155457339;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::ResourceGlobalSettings>::s_pDefaultInstance_4617877992155457339);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::ResourceGlobalSettings>::s_pDefaultInstance_4617877992155457339, propertyID, arrayIdx);
        }
    };

    ::SE::ResourceGlobalSettings const* TTypeCompositeInfo<::SE::ResourceGlobalSettings>::s_pDefaultInstance_4617877992155457339 = nullptr;
}
