...
{
    template<>
    class  TTypeCompositeInfo<::SE::Shader> final : public TypeCompositeInfo
    {
       static ::SE::Shader const* s_pDefaultInstance_2876139816;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_2876139816 = New<::SE::Shader>(nullptr);

            ::SE::Shader::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Shader>>(s_pDefaultInstance_2876139816);
            Types::RegisterType(::SE::Shader::s_pTypeInfo);
        }

        static void UnregisterType()
        {
            Types::UnregisterType(::SE::Shader::s_pTypeInfo);
            // Destroy default type instance
            Delete(const_cast<::SE::Shader*>(s_pDefaultInstance_2876139816));
            Delete(const_cast<TypeCompositeInfo*>(::SE::Shader::s_pTypeInfo));
        }
    ...
    public:
        ...
        {
            // Create type info
            id = TypeID(SE_TEXT("SE::Shader"));
            size = sizeof(::SE::Shader);
            alignment = alignof(::SE::Shader);
            name = SE_TEXT("Shader");
            fullName = SE_TEXT("SE::Shader");
        ...
        {
            auto pMemory = PlatformAllocator::Allocate(sizeof(::SE::Shader), alignof(::SE::Shader));
            return new (pMemory) ::SE::Shader(nullptr);
        }

        virtual void CreateTypeInPlace( IType* pAllocatedMemory ) const override final
        {
            ENGINE_ASSERT( pAllocatedMemory != nullptr );
            new (pAllocatedMemory) ::SE::Shader(nullptr);
         }

        virtual IType const *GetDefaultInstance() const override
        {
            return s_pDefaultInstance_2876139816;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Shader>::s_pDefaultInstance_2876139816);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Shader>::s_pDefaultInstance_2876139816, propertyID, arrayIdx);
        }
    };

    ::SE::Shader const* TTypeCompositeInfo<::SE::Shader>::s_pDefaultInstance_2876139816 = nullptr;
}
