...
namespace SE
{
    ...
    {
       static ::SE::GPUGlobalSettings const* s_pDefaultInstance_1594080223;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_1594080223 = New<::SE::GPUGlobalSettings>(nullptr);

            ::SE::GPUGlobalSettings::s_pTypeInfo = New<TTypeCompositeInfo<::SE::GPUGlobalSettings>>(s_pDefaultInstance_1594080223);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::GPUGlobalSettings*>(s_pDefaultInstance_1594080223));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_1594080223;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::GPUGlobalSettings>::s_pDefaultInstance_1594080223);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::GPUGlobalSettings>::s_pDefaultInstance_1594080223, propertyID, arrayIdx);
        }
    };

    ::SE::GPUGlobalSettings const* TTypeCompositeInfo<::SE::GPUGlobalSettings>::s_pDefaultInstance_1594080223 = nullptr;
}
