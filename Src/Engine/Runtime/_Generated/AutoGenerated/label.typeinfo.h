...
namespace SE
{
    ...
    {
       static ::SE::Label const* s_pDefaultInstance_1640410161;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_1640410161 = New<::SE::Label>(nullptr);

            ::SE::Label::s_pTypeInfo = New<TTypeCompositeInfo<::SE::Label>>(s_pDefaultInstance_1640410161);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::Label*>(s_pDefaultInstance_1640410161));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_1640410161;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::Label>::s_pDefaultInstance_1640410161);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::Label>::s_pDefaultInstance_1640410161, propertyID, arrayIdx);
        }
    };

    ::SE::Label const* TTypeCompositeInfo<::SE::Label>::s_pDefaultInstance_1640410161 = nullptr;
}
