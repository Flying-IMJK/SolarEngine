...
namespace SE
{
    ...
    {
       static ::SE::BinaryAsset const* s_pDefaultInstance_2541197718;
    ...
    public:
        static void RegisterType()
        {
            ...
            ::SE::BinaryAsset::s_pTypeInfo = New<TTypeCompositeInfo<::SE::BinaryAsset>>(s_pDefaultInstance_2541197718);
    ...
    public:
        ...
        {
            return s_pDefaultInstance_2541197718;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::BinaryAsset>::s_pDefaultInstance_2541197718);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::BinaryAsset>::s_pDefaultInstance_2541197718, propertyID, arrayIdx);
        }
    };

    ::SE::BinaryAsset const* TTypeCompositeInfo<::SE::BinaryAsset>::s_pDefaultInstance_2541197718 = nullptr;
}
