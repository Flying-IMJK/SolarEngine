...
namespace SE
{
    ...
    {
       static ::SE::ScrollableControl const* s_pDefaultInstance_762640789;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_762640789 = New<::SE::ScrollableControl>(nullptr);

            ::SE::ScrollableControl::s_pTypeInfo = New<TTypeCompositeInfo<::SE::ScrollableControl>>(s_pDefaultInstance_762640789);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::ScrollableControl*>(s_pDefaultInstance_762640789));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_762640789;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::ScrollableControl>::s_pDefaultInstance_762640789);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::ScrollableControl>::s_pDefaultInstance_762640789, propertyID, arrayIdx);
        }
    };

    ::SE::ScrollableControl const* TTypeCompositeInfo<::SE::ScrollableControl>::s_pDefaultInstance_762640789 = nullptr;
}
