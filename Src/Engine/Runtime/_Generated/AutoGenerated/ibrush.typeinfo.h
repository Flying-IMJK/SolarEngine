...
namespace SE
{
    ...
    {
       static ::SE::IBrush const* s_pDefaultInstance_2440350782;
    ...
    public:
        static void RegisterType()
        {
            ...
            ::SE::IBrush::s_pTypeInfo = New<TTypeCompositeInfo<::SE::IBrush>>(s_pDefaultInstance_2440350782);
    ...
    public:
        ...
        {
            return s_pDefaultInstance_2440350782;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::IBrush>::s_pDefaultInstance_2440350782);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::IBrush>::s_pDefaultInstance_2440350782, propertyID, arrayIdx);
        }
    };

    ::SE::IBrush const* TTypeCompositeInfo<::SE::IBrush>::s_pDefaultInstance_2440350782 = nullptr;
}
