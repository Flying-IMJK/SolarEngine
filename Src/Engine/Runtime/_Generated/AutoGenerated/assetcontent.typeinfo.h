...
namespace SE
{
    ...
    {
       static ::SE::ContentStats const* s_pDefaultInstance_2741167195;

    public:
        static void RegisterType()
        {
            s_pDefaultInstance_2741167195 = New<::SE::ContentStats>(nullptr);

            ::SE::ContentStats::s_pTypeInfo = New<TTypeCompositeInfo<::SE::ContentStats>>(s_pDefaultInstance_2741167195);
        ...
        static void UnregisterType()
        {
            ...
            Delete(const_cast<::SE::ContentStats*>(s_pDefaultInstance_2741167195));
    ...
    public:
        ...
        {
            return s_pDefaultInstance_2741167195;
        }
        ...
        {
            return AreAllPropertyValuesEqual(pTypeInstance, TTypeCompositeInfo<::SE::ContentStats>::s_pDefaultInstance_2741167195);
        }

        virtual bool IsPropertyValueSetToDefault(IType const *pTypeInstance, uint32 propertyID, int32_t arrayIdx = -1) const override
        {
            return IsPropertyValueEqual(pTypeInstance, TTypeCompositeInfo<::SE::ContentStats>::s_pDefaultInstance_2741167195, propertyID, arrayIdx);
        }
    };

    ::SE::ContentStats const* TTypeCompositeInfo<::SE::ContentStats>::s_pDefaultInstance_2741167195 = nullptr;
}
