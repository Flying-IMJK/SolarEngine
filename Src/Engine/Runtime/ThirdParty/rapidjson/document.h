...
public:
    ...
    */
	...
	::SE::StringAnsiView GetStringAnsiView() const { RAPIDJSON_ASSERT(IsString()); return data_.f.flags & kInlineStrFlag ? ::SE::StringAnsiView(data_.ss.str, data_.ss.GetLength()) : ::SE::StringAnsiView(GetStringPointer(), data_.s.length); }
	::SE::String GetText() const
	{
		::SE::String result;
		if (IsString())
		{
	...
	::SE::StringAnsi GetTextAnsi() const
	{
		::SE::StringAnsi result;
		if (IsString())
		{
			if (data_.f.flags & kInlineStrFlag)
