...
namespace SE
{
    ...
    public:
        ...
        SE_FIELD(API(Attributes="EditorOrder(20), EditorDisplay(\"Light\")"))
        ...
        SE_FIELD(API(Attributes="EditorOrder(30), EditorDisplay(\"Light\"), Limit(0.0f, 100000000.0f, 0.1f)"))
        ...
        SE_FIELD(API(Attributes="EditorOrder(35), Limit(0, float.MaxValue, 10.0f), EditorDisplay(\"Light\")"))
        ...
        SE_FIELD(API(Attributes="EditorOrder(40), DefaultValue(1.0f), Limit(0, 100, 0.1f), EditorDisplay(\"Light\", \"Indirect Lighting Intensity\")"))
        ...
        SE_FIELD(API(Attributes="EditorOrder(110), DefaultValue(1.0f), Limit(0, 100, 0.01f), EditorDisplay(\"Volumetric Fog\", \"Scattering Intensity\")"))
        ...
        SE_FIELD(API(Attributes="EditorOrder(120), EditorDisplay(\"Volumetric Fog\", \"Cast Shadow\")"))
    ...
    public:
        ...
        SE_FIELD(API(Attributes="EditorOrder(40), EditorDisplay(\"Light\", \"Minimum Roughness\"), Limit(0.0f, 1.0f, 0.01f)"))
        ...
        SE_FIELD(API(Attributes="EditorOrder(80), EditorDisplay(\"Shadow\", \"Distance\"), Limit(0, 1000000)"))
        ...
        SE_FIELD(API(Attributes="EditorOrder(90), EditorDisplay(\"Shadow\", \"Fade Distance\"), Limit(0.0f, 10000.0f, 0.1f)"))
        ...
        SE_FIELD(API(Attributes="EditorOrder(70), EditorDisplay(\"Shadow\", \"Sharpness\"), Limit(1.0f, 10.0f, 0.001f)"))
        ...
        SE_FIELD(API(Attributes="EditorOrder(75), EditorDisplay(\"Shadow\", \"Strength\"), Limit(0.0f, 1.0f, 0.001f)"))
        ...
        SE_FIELD(API(Attributes="EditorOrder(95), EditorDisplay(\"Shadow\", \"Depth Bias\"), Limit(0.0f, 10.0f, 0.0001f)"))
        ...
        SE_FIELD(API(Attributes="EditorOrder(96), EditorDisplay(\"Shadow\", \"Normal Offset Scale\"), Limit(0.0f, 100.0f, 0.1f)"))
        ...
        SE_FIELD(API(Attributes="EditorOrder(99), EditorDisplay(\"Shadow\"), Limit(0.0f, 0.1f, 0.001f)"))
        ...
        SE_FIELD(API(Attributes="EditorOrder(60), EditorDisplay(\"Shadow\", \"Mode\")"))
