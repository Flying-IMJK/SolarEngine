...
namespace SE
{
    ...
    public:
        ...
        /// <returns>The created actor (root) or null if failed.</returns>
        static Actor* SpawnPrefab(Prefab* prefab, Actor* parent, Dictionary<UID, SceneObject*, HeapAllocation>* objectsCache, bool withSynchronization = true);
        ...
        /// <param name="withSynchronization">True if perform prefab changes synchronization for the spawned objects. It will check if need to add new objects due to nested prefab modifications.</param>
        /// <returns>The created actor (root) or null if failed.</returns>
        static Actor* SpawnPrefab(Prefab* prefab, const Transform& transform, Actor* parent, Dictionary<UID, SceneObject*, HeapAllocation>* objectsCache, bool withSynchronization = true);
        ...
        static bool FilterPrefabInstancesToSave(const UID& prefabId, List<SceneObject*, HeapAllocation>& objects, bool showWarning = true);
        ...
        /// </summary>
        static Dictionary<UID, List<Actor*, HeapAllocation>, HeapAllocation> PrefabsReferences;
