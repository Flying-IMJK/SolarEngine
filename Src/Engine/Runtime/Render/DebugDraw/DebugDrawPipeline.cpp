...
namespace SE
{
    ...
    void DebugDrawPipeline::setupPipelines()
    {
        ...
        color_blend_attachment_state.srcColorBlendFactor = RHIBlendFactor::SRC_ALPHA;
        color_blend_attachment_state.dstColorBlendFactor = RHIBlendFactor::ONE_MINUS_SRC_ALPHA;
        color_blend_attachment_state.colorBlendOp = RHIBlendOp::ADD;
        color_blend_attachment_state.srcAlphaBlendFactor = RHIBlendFactor::ONE;
        color_blend_attachment_state.dstAlphaBlendFactor = RHIBlendFactor::ZERO;
        color_blend_attachment_state.alphaBlendOp = RHIBlendOp::ADD;
