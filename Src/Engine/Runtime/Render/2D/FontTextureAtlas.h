...
namespace SE
{
    ...
    public:
        ...
        FontTextureAtlasSlot* AddEntry(uint32 targetWidth, uint32 targetHeight, const List<byte>& data);
        ...
        /// <param name="data">The data.</param>
        void CopyDataIntoSlot(const FontTextureAtlasSlot* slot, const List<byte>& data);
