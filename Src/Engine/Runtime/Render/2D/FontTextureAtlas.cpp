...
namespace SE
{
    ...
    {
        _format = format;
        _bytesPerPixel = PixelFormatGetSizeInBytes(format);
    ...
    FontTextureAtlasSlot* FontTextureAtlas::AddEntry(uint32 targetWidth, uint32 targetHeight, const List<byte>& data)
    {
    ...
    void FontTextureAtlas::CopyDataIntoSlot(const FontTextureAtlasSlot* slot, const List<byte>& data)
    {
