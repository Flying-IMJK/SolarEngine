...
namespace SE
{
    ...
    /// </summary>
    GES_PACK_STRUCT(struct SE_API_RUNTIME LightData {
        Float2 SpotAngles;
        float SourceRadius;
        float SourceLength;
        Float3 Color;
    ...
    /// Structure that contains information about light for shaders.
    /// </summary>
    GES_PACK_STRUCT(struct SE_API_RUNTIME LightShadowData {
    ...
    /// </summary>
    GES_PACK_STRUCT(struct SE_API_RUNTIME InstanceData
    {
    ...
    {
        DrawCall DrawCall;
        List<InstanceData, RendererAllocation> Instances;
    };
    ...
    /// </summary>
    class SE_API_RUNTIME RenderList : public Object
    {
    public:
        RenderList();
        ...
        static void ReturnToPool(RenderList* cache);
    ...
    public:
        ...
        /// </summary>
        List<RendererDirectionalLightData> DirectionalLights;

        /// <summary>
        /// Light pass members - point lights
        /// </summary>
        List<RendererPointLightData> PointLights;

        /// <summary>
        /// Light pass members - spot lights
        /// </summary>
        List<RendererSpotLightData> SpotLights;

        /// <summary>
        /// Light pass members - sky lights
        /// </summary>
        List<RendererSkyLightData> SkyLights;
        ...
        /// </summary>
        List<DrawCall> VolumetricFogParticles;
        ...
        // struct SE_API_RUNTIME BlendableSettings
        // {
        ...
        /// </summary>
        // List<BlendableSettings> Blendable;
    ...
    public:
        ...
        FORCE_INLINE void SortDrawCalls(const RenderContext& renderContext, bool reverseDistance, DrawCallsListType listType)
        {
        ...
        FORCE_INLINE void ExecuteDrawCalls(const RenderContext& renderContext, DrawCallsListType listType, GPUTextureView* input = nullptr)
        {
