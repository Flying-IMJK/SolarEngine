...
namespace SE
{
    ...
    class SE_API_RUNTIME Mesh : public MeshBase
    {
    protected:
...
#endif
        mutable List<byte> _cachedVertexBuffer[3];
        mutable List<byte> _cachedIndexBuffer;
        String m_Name;
    ...
    public:
        ...
        /// </summary>
        FORCE_INLINE bool HasLightmapUVs() const
        {
    ...
    public:
        ...
        bool Intersects(const Ray& ray, const Matrix& world, float& distance, Float3& normal) const;
    ...
    public:
        ...
        void Draw(const RenderContext& renderContext, MaterialBase* material, const Matrix& world, EnumFlags<StaticMask> flags = StaticMask::None,
            bool receiveDecals = true, EnumFlags<DrawPass> drawModes = DrawPass::Default, float perInstanceRandom = 0.0f, int16 sortOrder = 0) const;
    ...
    public:
        ...
        Threading::Task* DownloadDataGPUAsync(MeshBufferType type, BytesContainer& result) const override;
        bool DownloadDataCPU(MeshBufferType type, BytesContainer& result, int32& count) const override;

    private:
        // Internal bindings
        /*ScriptingObject* GetParentModel();
    #if !COMPILE_WITHOUT_CSHARP
        bool UpdateMeshUInt(int32 vertexCount, int32 triangleCount, const MArray* verticesObj, const MArray* trianglesObj, const MArray* normalsObj, const MArray* tangentsObj, const MArray* uvObj, const MArray* colorsObj);
        bool UpdateMeshUShort(int32 vertexCount, int32 triangleCount, const MArray* verticesObj, const MArray* trianglesObj, const MArray* normalsObj, const MArray* tangentsObj, const MArray* uvObj, const MArray* colorsObj);
        bool UpdateTrianglesUInt(int32 triangleCount, const MArray* trianglesObj);
        bool UpdateTrianglesUShort(int32 triangleCount, const MArray* trianglesObj);
        MArray* DownloadBuffer(bool forceGpu, MTypeObject* resultType, int32 typeI);
    #endif*/
    };
} // SE
