...
#include "Runtime/Utilities/Model/BlendShape.h"
...
namespace SE
{
    ...
    public:
        ...
        /// </summary>
        List<Int4> BlendIndices;

        /// <summary>
        /// Skinned mesh index buffer (max 4 per bone)
        /// </summary>
        List<Float4> BlendWeights;
        ...
        /// </summary>
        Float3 OriginTranslation = Float3::Zero;
    ...
    public:
        ...
        void InitFromModelVertices(ModelVertex* vertices, uint32 verticesCount);


        /// <summary>
        /// Init from model vertices array
        /// </summary>
        /// <param name="vb0">List of data for vertex buffer 0</param>
        /// <param name="vb1">List of data for vertex buffer 1</param>
        /// <param name="verticesCount">Amount of vertices</param>
        void InitFromModelVertices(VB0ElementType* vb0, VB1ElementType* vb1, uint32 verticesCount);
        ...
        /// <param name="vb0">List of data for vertex buffer 0</param>
        /// <param name="vb1">List of data for vertex buffer 1</param>
        /// <param name="vb2">List of data for vertex buffer 2</param>
        /// <param name="verticesCount">Amount of vertices</param>
        void InitFromModelVertices(VB0ElementType* vb0, VB1ElementType* vb1, VB2ElementType* vb2, uint32 verticesCount);
    ...
    public:
        ...
        void FindPositions(const Float3& position, float epsilon, List<int32>& result);
    ...
    /// </summary>
    struct SE_API_RUNTIME TextureEntry
    {
        enum class TypeHint
        {
            ColorRGB,
    ...
    /// </summary>
    struct SE_API_RUNTIME MaterialSlotEntry
    {
        /// <summary>
        /// The slot name.
        /// </summary>
    ...
    /// </summary>
    struct SE_API_RUNTIME ModelDataNode
    {
        /// <summary>
    ...
    /// </summary>
    struct SE_API_RUNTIME ModelLodData
    {
        /// <summary>
    ...
    /// </summary>
    class SE_API_RUNTIME ModelData
    {
    public:
        /// <summary>
        ...
        /// The material slots.
        /// </summary>
        List<MaterialSlotEntry> Materials;

        /// <summary>
        /// List with all Level Of Details that contain meshes. The first element is the top most LOD0 followed by the LOD1, LOD2, etc.
        /// </summary>
        List<ModelLodData> LODs;
    ...
    public:
        ...
        {
            return false;// Skeleton.Bones.HasItems();
        }
