...
namespace SE
{
	...
	/// </summary>
	class SE_API_RUNTIME StreamingTexture : public Object, public StreamableResource
	{
	...
	protected:
		...
		List<Threading::Task*, FixedAllocation<16>> _streamingTasks;

	public:
		StreamingTexture();
		StreamingTexture(TextureBase* owner);
		StreamingTexture(TextureBase* owner, String name);
	...
	public:
		...
		/// Gets the owner.
		/// </summary>
		FORCE_INLINE TextureBase* GetOwner() const
		{
			return _owner;
		}
