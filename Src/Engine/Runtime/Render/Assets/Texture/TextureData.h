...
namespace SE
{
	...
	/// </summary>
	class SE_API_RUNTIME TextureMipData
	{
	public:
		uint32 RowPitch;
		uint32 DepthPitch;
		...
		bool GetPixels(List<Color32>& pixels, int32 width, int32 height, PixelFormat format) const;
		bool GetPixels(List<Color>& pixels, int32 width, int32 height, PixelFormat format) const;
	...
	/// </summary>
	class SE_API_RUNTIME TextureData
	{
	public:
		/// <summary>
		/// Single entry of the texture array. Contains collection of mip maps.
		/// </summary>
		struct SE_API_RUNTIME ArrayEntry
		{
			/// <summary>
			/// The mip maps collection.
			/// </summary>
			List<TextureMipData, FixedAllocation<GPU_MAX_TEXTURE_MIP_LEVELS>> Mips;
		};
	...
	public:
		...
		/// </summary>
		List<ArrayEntry, InlinedAllocation<6>> Items;
