...
namespace SE
{
    ...
    //{
    //    m_menus.emplace_back( Menu( "Engine/World", [this] ( EntityWorldUpdateContext const& context ) { DrawMenu( context ); } ) );
    //}
    ...
    //        TPair<String, ResID> maps[] =
    //        {
    //            TPair<String, ResID>( "BR Minimal", ResID( "data://maps/BR_Minimal.map" ) ),
    //            TPair<String, ResID>( "BR Full", ResID( "data://maps/BR_Full.map" ) ),
    //            TPair<String, ResID>( "Anim Minimal", ResID( "data://maps/AnimTest_Minimal.map" ) ),
    //            TPair<String, ResID>( "Anim Full", ResID( "data://maps/AnimTest_Full.map" ) ),
    //        };
    ...
    //{
    //    ENGINE_ASSERT( m_isWorldBrowserOpen );
