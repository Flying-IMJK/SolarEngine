...
namespace SGE::Drawing
{
    ...
    class SE_API_RUNTIME DrawContext
    {
    ...
    public:
        ...
        inline void DrawBox(BoundingBox const &box, Float4 const &color, DepthTest depthTestState = DepthTest::Disable, Seconds TTL = -1)
        {
        ...
        inline void DrawWireBox(BoundingBox const &box, Float4 const &color, float lineThickness = s_defaultLineThickness, DepthTest depthTestState = DepthTest::Disable, Seconds TTL = -1)
        {
        ...
        inline void DrawCircle(VectorSIMD const &worldPosition, Axis upAxis, float radius, Float4 const &color, float lineThickness = s_defaultLineThickness, DepthTest depthTestState = DepthTest::Disable, Seconds TTL = -1)
        {
        ...
        {
            VectorSIMD const xAxis = worldTransform.GetAxisX().GetNormalized3() * axisLength;
            VectorSIMD const yAxis = worldTransform.GetAxisY().GetNormalized3() * axisLength;
            VectorSIMD const zAxis = worldTransform.GetAxisZ().GetNormalized3() * axisLength;

            DrawLine(worldTransform.GetTranslation(), worldTransform.GetTranslation() + xAxis, Colors::Red.ToFloat4(), axisThickness, depthTestState, TTL);
            DrawLine(worldTransform.GetTranslation(), worldTransform.GetTranslation() + yAxis, Colors::LimeGreen.ToFloat4(), axisThickness, depthTestState, TTL);
            DrawLine(worldTransform.GetTranslation(), worldTransform.GetTranslation() + zAxis, Colors::Blue.ToFloat4(), axisThickness, depthTestState, TTL);
        }
        ...
        {
            VectorSIMD const endPoint = VectorSIMD::MultiplyAdd(VectorSIMD(direction).GetNormalized3(), VectorSIMD(arrowLength), VectorSIMD(startPoint));
        ...
        {
            Quaternion const orientation = Quaternion::FromRotationBetweenNormalizedVectors(VectorSIMD::WorldForward, VectorSIMD(direction).GetNormalized3());
    ...
    private:
        inline void InternalDrawPoint(ThreadCommandBuffer &cmdList, Float3 const &position, Float4 const &color, float thickness, DepthTest depthTestState = DepthTest::Disable, Seconds TTL = -1)
        {
            cmdList.AddCommand(PointCommand(position, color, thickness, TTL), depthTestState);
        }

        inline void InternalDrawLine(ThreadCommandBuffer &cmdList, Float3 const &startPosition, Float3 const &endPosition, Float4 const &color, float lineThickness, DepthTest depthTestState = DepthTest::Disable, Seconds TTL = -1)
        {
            cmdList.AddCommand(LineCommand(startPosition, endPosition, color, lineThickness, TTL), depthTestState);
        }

        inline void InternalDrawLine(ThreadCommandBuffer &cmdList, Float3 const &startPosition, Float3 const &endPosition, Float4 const &startColor, Float4 const &endColor, float lineThickness, DepthTest depthTestState = DepthTest::Disable, Seconds TTL = -1)
        {
            cmdList.AddCommand(LineCommand(startPosition, endPosition, startColor, endColor, lineThickness, TTL), depthTestState);
        }

        inline void InternalDrawLine(ThreadCommandBuffer &cmdList, Float3 const &startPosition, Float3 const &endPosition, Float4 const &color, float startLineThickness, float endLineThickness, DepthTest depthTestState = DepthTest::Disable, Seconds TTL = -1)
        {
            cmdList.AddCommand(LineCommand(startPosition, endPosition, color, startLineThickness, endLineThickness, TTL), depthTestState);
        }

        inline void InternalDrawLine(ThreadCommandBuffer &cmdList, Float3 const &startPosition, Float3 const &endPosition, Float4 const &startColor, Float4 const &endColor, float startLineThickness, float endLineThickness, DepthTest depthTestState = DepthTest::Disable, Seconds TTL = -1)
        {
        ...
        inline void InternalDrawTriangle(ThreadCommandBuffer &cmdList, Float3 const &v0, Float3 const &v1, Float3 const &v2, Float4 const &color, DepthTest depthTestState = DepthTest::Disable, Seconds TTL = -1)
        {
            cmdList.AddCommand(TriangleCommand(v0, v1, v2, color, TTL), depthTestState);
        }

        inline void InternalDrawTriangle(ThreadCommandBuffer &cmdList, Float3 const &v0, Float3 const &v1, Float3 const &v2, Float4 const &color0, Float4 const &color1, Float4 const &color2, DepthTest depthTestState = DepthTest::Disable, Seconds TTL = -1)
        {
            cmdList.AddCommand(TriangleCommand(v0, v1, v2, color0, color1, color2, TTL), depthTestState);
        }

        inline void InternalDrawText2D(ThreadCommandBuffer &cmdList, Float2 const &position, char const *pText, Float4 const &color, FontSize size, TextAlignment alignment, DepthTest depthTestState, Seconds TTL = -1)
        {
            cmdList.AddCommand(TextCommand(position, pText, color, size, alignment, false, TTL), depthTestState);
        }

        inline void InternalDrawText3D(ThreadCommandBuffer &cmdList, Float3 const &position, char const *pText, Float4 const &color, FontSize size, TextAlignment alignment, DepthTest depthTestState, Seconds TTL = -1)
        {
            cmdList.AddCommand(TextCommand(position, pText, color, size, alignment, false, TTL), depthTestState);
        }

        inline void InternalDrawTextBox2D(ThreadCommandBuffer &cmdList, Float2 const &position, char const *pText, Float4 const &color, FontSize size, TextAlignment alignment, DepthTest depthTestState, Seconds TTL = -1)
        {
            cmdList.AddCommand(TextCommand(position, pText, color, size, alignment, true, TTL), depthTestState);
        }

        inline void InternalDrawTextBox3D(ThreadCommandBuffer &cmdList, Float3 const &position, char const *pText, Float4 const &color, FontSize size, TextAlignment alignment, DepthTest depthTestState, Seconds TTL = -1)
        {
            cmdList.AddCommand(TextCommand(position, pText, color, size, alignment, true, TTL), depthTestState);
        }
