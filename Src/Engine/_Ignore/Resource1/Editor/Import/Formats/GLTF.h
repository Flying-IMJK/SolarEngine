...
#include "Editor/ThirdParty/cgltf/cgltf.h"
...
namespace SGE::Editor::Import::gltf
{
    //-------------------------------------------------------------------------
    ...
    SE_API_EDITOR Scope<ImportedAnimation> ReadAnimation( FileSystem::Path const& animationFilePath, ImportedSkeleton const& ImportedSkeleton, String const& animationName = String() );
    SE_API_EDITOR Scope<ImportedMesh> ReadStaticMesh( FileSystem::Path const& sourceFilePath, Vector<String> const& meshesToInclude );
    SE_API_EDITOR Scope<ImportedMesh> ReadSkeletalMesh( FileSystem::Path const& sourceFilePath, Vector<String> const& meshesToInclude, int32_t maxBoneInfluences );
}